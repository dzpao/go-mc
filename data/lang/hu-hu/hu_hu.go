...
var Map = map[string]string{
	...
	"chat.previewInput": "[%s] az előnézethez",
	"chat.queue": "[+%s függőben lévő sor]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "Ezt az üzenetet a szerver módosította.",
	"chat.tag.modified.original": "Eredeti szöveg: %s",
	"chat.tag.not_secure": "Ez az üzenet nem biztonságos, ezért előfordulhat, hogy a szerver módosította",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Ne figyelmeztessen újra ezen a szerveren",
	"chatPreview.warning.content": "A chat-előnézet funkció lehetővé teszi, hogy a szerver lássa az általad írt üzeneteket, mielőtt a többi játékosnak küldenéd őket. Ezáltal a szerver előnézetet küldhet neked az üzeneteidről formázással és más módosításokkal együtt, ahogyan mások fogják látni.\n\nA chat-előnézet viselkedése a Chatbeállítások menüben módosítható. A jelenlegi beállítás: [%s]",
	"chatPreview.warning.title": "Ez a szerver chat-előnézetet használ",
	"chatPreview.warning.toast": "Ez a szerver a chat-előnézet funkciót használja, így már elküldés előtt is látja az üzeneteidet. Ezt a „Chat beállításai” menüben kapcsolhatod ki.",
	"chatPreview.warning.toast.title": "A chat előnézete be van kapcsolva",
	...
	"commands.locate.biome.invalid": "Nem létezik %s típusú biom",
	...
	"commands.locate.poi.invalid": "Nem létezik \"%s\" típusú tereptárgy",
	...
	"death.attack.sonic_boom.item": "%[1]s játékost elpusztította egy hanggal feltöltött sikoly, miközben megpróbált elmenekülni %[2]s elől, aki %[3]s-al hadonászott",
	...
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Valaki arról beszél vagy azzal fenyeget, hogy a való életben sérülést okoz saját magának, vagy kioltja a saját életét.",
	...
	"gui.cancel": "Mégse",
	"gui.chatReport.comments": "Megjegyzés-szövegmező",
	...
	"gui.chatSelection.fold": "%s nem idetartozó üzenet elrejtve",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%[1]s üzenete %[3]s-kor: %[2]s",
	...
	"multiplayer.disconnect.invalid_public_key": "Nem sikerült értelmezni a fiók nyilvános kulcsát.",
	...
	"multiplayer.disconnect.missing_public_key": "A fiókodnak hiányzik a nyilvános kulcsa.\nEz a szerver előírja a biztonságos fiókok használatát.",
	...
	"multiplayer.disconnect.out_of_order_chat": "A sorrendbe nem illeszkedő chat-adatcsomag érkezett. Talán megváltozott a rendszeridőd?",
	...
	"options.chatPreview": "Chat előnézete",
	"options.chatPreview.confirm": "Küldéskor",
	"options.chatPreview.live": "Gépelés közben",
	"options.chatPreview.tooltip.confirm": "Ha egy szerver chat-előnézetet használ: Az üzeneteid előnézete csak akkor jön létre, amikor megpróbálsz elküldeni egy üzenetet, amelynek még nincs vagy nem érkezett meg az előnézete. Az üzenet elküldése megerősítést igényel a részedről.",
	"options.chatPreview.tooltip.live": "Ha egy szerver chat-előnézetet használ: Ahogy a szerver módosítja az üzeneteidet, folyamatosan visszaküldi, hogy láthasd előnézetként gépelés közben.",
	"options.chatPreview.tooltip.off": "A chatüzeneteiden végzett bármilyen módosítás nem jelenik meg előnézetként és a kliens nem biztonságosként fogja kezelni.",
