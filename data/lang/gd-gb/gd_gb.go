...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Chan eil biome ri seòrsa \"%s\"",
	"commands.locate.biome.not_found": "Cha b ' urrainn dhuinn an lorg a biome of type \"%s\" taobh a-staigh reusanta air astar",
	"commands.locate.biome.success": "Tha an %s as fhaisge aig %s (%s blocaichean bhuat)",
	"commands.locate.poi.success": "Tha an %s as fhaisge aig %s (%s blocaichean bhuat)",
	...
	"item.minecraft.music_disc_5": "Clàr ciùil",
	...
	"selectWorld.backupQuestion.snapshot": "A bheil thu cinnteach gu bheil thu airson an saoghal seo a luchdadh?",
	...
	"selectWorld.import_worldgen_settings.deprecated.title": "Rabhadh! Tha na roghainnean seo a' cleachdadh fheartan nach molar tuilleadh",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Parrot knives",
