...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Es gibt kein Biom des Typs „%s“",
	...
	"commands.locate.poi.success": "%s ist am nächsten bei %s (%s Blöcke entfernt)",
	...
	"flat_world_preset.minecraft.tunnelers_dream": "Traum des Tunnelbauers",
