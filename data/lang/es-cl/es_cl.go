...
var Map = map[string]string{
	...
	"chat.previewInput": "Pulsa [%s] para vista previa",
	"chat.queue": "[+%s líneas pendientes]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Este mensaje fue filtrado por el server.",
	"chat.tag.modified": "Este mensaje fue modificado por el server.",
	"chat.tag.modified.original": "Texto original: %s",
	"chat.tag.not_secure": "Este mensaje no es seguro, lo que significa que podría haber sido modificado por el server",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "No advertir de nuevo en este server",
	"chatPreview.warning.content": "La previsualización del chat permite al server ver tus mensajes antes de enviarlos a otros jugadores. Esto hace posible que el server te envíe una vista previa de cómo se verá tu mensaje luego de que se le apliquen modificaciones o diseños personalizados del server.\n\nPuedes configurar el comportamiento de la previsualización del chat en los Ajustes del Chat. Configuración actual: [%s]",
	"chatPreview.warning.title": "Este server usa la previsualización del chat",
	"chatPreview.warning.toast": "Este server usa la previsualización del chat y puede ver tus mensajes antes de que los envíes a otros jugadores. Puedes desactivar esta opción en los Ajustes del Chat.",
	"chatPreview.warning.toast.title": "Previsualización del chat activada",
	...
	"commands.locate.biome.invalid": "No hay ningún bioma de tipo \"%s\"",
	...
	"commands.locate.poi.invalid": "No hay ningún punto de interés con el tipo \"%s\"",
	"commands.locate.poi.not_found": "No se pudo encontrar un punto de interés de tipo \"\" a una distancia razonable%s",
	...
	"death.attack.sonic_boom": "%[1]s fue obliterado/a por una onda super-sónica",
	"death.attack.sonic_boom.item": "%[1]s fue obliterado/a por una onda super-sónica tratando de escapar de %[2]s empuñando %[3]s",
	"death.attack.sonic_boom.player": "%[1]s fue obliterado/a por una onda super-sónica tratando de escapar de %[2]s",
	...
	"death.attack.witherSkull.item": "%[1]s fue disparado/a por una calavera de %[2]s usando %[3]s",
	...
	"disconnect.loginFailedInfo.userBanned": "Estas baneado de jugar online",
	...
	"gui.abuseReport.error.title": "Problema al enviar tu reporte",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Drogas o alcohol",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Alguien está incentivando a otros a actuar en actos ilegales relacionados a drogas o consumir alcohol siendo menor de edad.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Sexualización o abuso infantil",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Alguien está hablando o promoviendo comportamiento indecentes que involucran a menores.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Alguien está dañando la reputación de otra persona, falsificando la identidad de alguien o compartiendo información falsa con el objetivo de aprovecharse o engañar a otros.",
	"gui.abuseReport.reason.description": "Descripción:",
	"gui.abuseReport.reason.false_reporting": "Acusación fraudulenta",
	...
	"gui.abuseReport.reason.hate_speech.description": "Alguien está atacándo a ti o a otro jugador basándose en características de identidad, religión, etnia o sexualidad.",
	"gui.abuseReport.reason.imminent_harm": "Peligro inminente - amenaza de daño a otros",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Alguien está pidiendo, compartiendo o de otra forma impulsando al tráfico de imágenes privadas y íntimas.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Peligro inminente: Autolesión o suicidio",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Alguien está hablando o amenazando a autolesionarse en la vida real.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorismo o extremismo violento",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Alguien está hablando, promoviendo o amenazando cometer actos de violencia o terroristas por temas políticos, religiosos, ideológicos u otras razones.",
	"gui.abuseReport.reason.title": "Seleccionar categoria de reporte",
	"gui.abuseReport.send.error_message": "Se ha producido un error al enviar tu rdenuncia: \n\"%s\"",
	...
	"gui.abuseReport.send.json_error": "carga de datos mal estructurada encontrada enquanto enviavas tu denuncia",
	"gui.abuseReport.send.service_unavailable": "No se ha podido comunicarse con el servicio de Denuncias de Abuso. Revisa tu conexión a internet e inténtalo de nuevo.",
	...
	"gui.banned.description.permanent": "Tu cuenta esta baneada permanentemente, lo que significa que no podrás jugar en línea ni unirte a Realms.",
	...
	"gui.banned.description.temporary": "%s Hasta allá, no podrás jugar en línea o unirte a Realms.",
	...
	"gui.cancel": "Cancelar",
	"gui.chatReport.comments": "Caja de edición de comentarios",
	"gui.chatReport.describe": "Ayúdanos a tomar la mejor decisión dándonos más detalles.",
	...
	"gui.chatReport.select_chat": "Selecciona mensajes del chat para reportar",
	"gui.chatReport.select_reason": "Seleccionar categoría de reporte",
	"gui.chatReport.selected_chat": "%s Mensaje(s) del chat, seleccionados para reportar",
	"gui.chatReport.send": "Enviar reporte",
	"gui.chatReport.send.comments_too_long": "Por favor, resume el reporte",
	"gui.chatReport.send.no_reason": "Selecciona una categoría para reportar",
	"gui.chatReport.send.no_reported_messages": "Elige al menos un mensaje del chat para poder reportar",
	"gui.chatReport.send.too_many_messages": "Intentando incluir demasiados mensajes en el reporte",
	"gui.chatReport.title": "Denunciar jugador",
	"gui.chatSelection.context": "Los mensajes seleccionados serán incluidos para contextualizar la situación",
	"gui.chatSelection.fold": "%s mensajes no relacionados ocultos",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s dijo: %s en %s",
	"gui.chatSelection.selected": "%s/%s mensaje(s) seleccionados",
	"gui.chatSelection.title": "Elija mensajes del chat a reportar",
	"gui.days": "%s día(s)",
	"gui.done": "Aceptar",
	"gui.down": "Abajo",
	...
	"item.minecraft.recovery_compass": "Brújula espectral",
	...
	"multiplayer.disconnect.chat_validation_failed": "Error al validar su mensaje ",
	...
	"multiplayer.disconnect.invalid_public_key": "No se pudo leer la clave pública del perfil.",
	...
	"multiplayer.disconnect.missing_public_key": "Tu perfil no cuenta con una clave pública.\nEste server solo admite perfiles seguros.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Demasiados mensajes de chat sin revision",
	"multiplayer.disconnect.unexpected_query_response": "Se enviaron datos desconocidos por parte del cliente",
	"multiplayer.disconnect.unsigned_chat": "Se ha recibido un paquete del chat que se necessita o con una signatura inválida.",
	...
	"multiplayer.unsecureserver.toast": "Los mensajes enviados en este server pueden ser modificados y podrían no reflejar el mensaje original",
	"multiplayer.unsecureserver.toast.title": "Los mensajes del chat no pudieron ser verificados",
	...
	"options.chatPreview": "Previsualización del chat",
	"options.chatPreview.confirm": "Al enviar",
	"options.chatPreview.live": "Al escribir",
	"options.chatPreview.tooltip.confirm": "Si el server usa la previsualización del chat, una vista previa solo aparecerá cuando intentes enviar un mensaje que no tiene o está esperando por una prevista.\nEnviar el mensaje requerirá confirmación.",
	"options.chatPreview.tooltip.live": "Si el server usa la previsualización del chat: cualquier modificación que se haga a tus mensajes por un servidor será enviada para obtener una vista previa a medida que escribes el mensaje.",
	...
	"options.onlyShowSecureChat": "Solo mostrar chat seguro",
	...
	"subtitles.block.sculk.charge": "Sculk recarga",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Loro bufa",
	...
	"title.multiplayer.disabled.banned.temporary": "Tu cuenta está suspendida temporalmente del multijugador online",
