...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Dat gifft keen Biom vun ’n Typ \"%s\"",
	"commands.locate.biome.not_found": "Dat kunn in metenerner Afstand keen Biom vun den Typ \"%s\" funnen wurrn",
	"commands.locate.biome.success": "%s amt to’n nächsten bi %s (%s Blök wiet weg)",
	"commands.locate.poi.success": "%s amt to’n nächsten bi %s (%s Blök wiet weg)",
	...
	"commands.place.structure.invalid": "Dat gifft keen Bauwiärke vun ’n Typ \"%s\"",
	...
	"item.minecraft.music_disc_5": "Schalplaat",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Papagoi sichtet",
