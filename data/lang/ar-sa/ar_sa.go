...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "تسلل قرب حساس السكولك، أو الواردن لتجنب كشفهم عنك",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "اقتل كائنا قرب محفز السكولك",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "انه ينتشر",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "احم قرويا من صعقة غير مرغوب فيها دون بَدْء حريق",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "حامي الحركة",
	"advancements.adventure.ol_betsy.description": "اطلق قوس المستعرض",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "اجعل مسكنا يضع كعكة على كتلة النوتة",
	...
	"advancements.husbandry.make_a_sign_glow.description": "اجعل نص الافتة يشع",
	...
	"block.minecraft.mangrove_wall_sign": "لا فتة مانغروف جدارية",
	...
	"block.minecraft.ochre_froglight": "مغرة الضفدع البرتقالية",
	...
	"block.minecraft.pearlescent_froglight": "مغرة الضفدع الأرجوانية",
	...
	"block.minecraft.verdant_froglight": "مغرة الضفدع الخضراء",
	...
	"chat.previewInput": "اضغط [%s] للمعاينة",
	"chat.queue": "[+%s خطوط قيد الانتظار]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "تم تعديل هذه الرسالة من قبل الخادم.",
	"chat.tag.modified.original": "نص الأصلي: %s",
	"chat.tag.not_secure": "هذه الرسالة ليست أمنة، مما يعني انه من الممكن تم التعديل عليها من قبل الخادم",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "لا تُعلِم مرة أُخرى لهذا الخادم",
	"chatPreview.warning.content": "تسمح معاينة الدردشة الخادم برؤية رسائلك قبل إرسالها إلى لاعبين آخرين. يسمح هذا الخادم بإرسال لك معاينة لرسائل الدردشة الخاصة بك مع تطبيق التعديلات والأنماط المخصصة.\n\nيمكن تغيير إعداد معاينة الدردشة في إعدادات الدردشة. الإعداد الحالي هو: [%s]",
	"chatPreview.warning.title": "هذا السيرفر يستخدم معاينة المحادثة",
	"chatPreview.warning.toast.title": "تم تفعيل معاينة المحادثة",
	...
	"commands.locate.biome.invalid": "لا يوجد مكان بنوع \"%s\"",
	...
	"commands.locate.poi.invalid": "لا يوجد منطقة حيوية بالنوع \"%s\"",
	"commands.locate.poi.not_found": "لم نقدر على ايجاد منطقة من نوع \"%s\" في مكان قريب",
	"commands.locate.poi.success": "ال%s الأقرب يقع في %s (يبعد %s كتل)",
	...
	"disconnect.loginFailedInfo.userBanned": "تم حظرك من اللعب على الشبكة",
	...
	"entity.minecraft.firework_rocket": "صاروخ الألعاب النارية",
	...
	"gamerule.doWardenSpawning": "سبون حارس الظلام",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "شخص يتكلم عن أو بطريقة أخرى ينشر اخلاق غير لائقة تشمل الأطفال.",
	...
	"gui.abuseReport.reason.hate_speech": "خطاب الكراهيَة",
	...
	"gui.abuseReport.send.error_message": "حدث خطأ ما في أثناء إرسال إبلاغيك:\n'%s'",
	"gui.abuseReport.send.generic_error": "وجهت خطا غير متوقع اثناء رسل بلاغي.",
	"gui.abuseReport.send.http_error": "حدوث خطا HTTP عير متوقع اثناء إرسال بلاغك.",
	"gui.abuseReport.send.json_error": "وجهه حمولة مشوهة في أثناء إرسال بلاغك.",
	...
	"gui.banned.description.temporary": "%s حتى ذلك الحين، لا يمكنك اللعب الجماعي عبر الإنترنت أو الانضمام إلى Realms.",
	...
	"gui.banned.title.temporary": "تم إغلاق الحساب مؤقتًا",
	"gui.cancel": "إلغاء",
	"gui.chatReport.comments": "تعليقات تعديل المربع",
	...
	"gui.chatReport.more_comments": "الرجاء توضيح ما حصل:",
	...
	"gui.chatReport.send.comments_too_long": "الرجاء تقصير التعليق",
	...
	"gui.chatReport.send.too_many_messages": "محاولة تضمين عدد كبير جدًا من الرسائل في البلاغ",
	...
	"gui.chatSelection.fold": "%s رسائل غير مرتبطة مخفية",
	...
	"item.minecraft.disc_fragment_5": "جزء قرص",
	...
	"item.minecraft.music_disc_5": "أسطوانة أغاني",
	...
	"multiplayer.disconnect.invalid_public_key": "عدم قدرة تحليل المفتاح العام للملف الشخصي.",
	...
	"multiplayer.disconnect.missing_public_key": "المفتاح العلني للملف الشخصي مفقود.\nيتطلب هذا السير فر ملفات شخصية آمنة.",
	...
	"options.chatPreview": "معاينة الدردشة",
	"options.chatPreview.confirm": "عند الإرسال",
	"options.chatPreview.live": "خلال الكتابة",
	"options.chatPreview.tooltip.confirm": "إذا كان الخادم يستخدم معاينات الدردشة: يتم إنشاء معاينة الدردشة فقط عند محاولة إرسال رسالة لا تحتوي على معاينة أو في انتظار المعاينة.\nإرسال الرسالة يتطلب التأكيد.",
	"options.chatPreview.tooltip.live": "إذا كان الخادم يستخدم معاينات الدردشة: سيتم إرسال أي تعديلات يتم تطبيقها على رسائلك بواسطة الخادم للمعاينة أثناء كتابة رسالة الدردشة.",
	"options.chatPreview.tooltip.off": "لن يتم معاينة أي رسائل التي تم تعديلها بواسطة تعديلات الخادم وسيتم التعامل معها على أنها غير آمنة.",
	...
	"options.darknessEffectScale.tooltip": "يتحكم في مدى وميض تأثير الظلمة عندما يعطيك إياه حارس الأعماق أو صارخ السكولك.",
	...
	"subtitles.entity.allay.ambient_with_item": "المسكن يبحث",
	"subtitles.entity.allay.ambient_without_item": "المسكن مشتاق",
	"subtitles.entity.allay.death": "المسكن يموت",
	"subtitles.entity.allay.hurt": "المساعد الصغير يتأذى",
	"subtitles.entity.allay.item_given": "المسكن يبتهج",
	...
	"subtitles.entity.piglin.jealous": "خنزير يشخر بغضب",
	...
	"subtitles.entity.warden.heartbeat": "دقات قلب حارس الأعماق",
	...
	"subtitles.entity.warden.sniff": "حارس الظلام يتشمم",
	...
	"subtitles.entity.zombie.destroy_egg": "الزومبي دهس بيضة السلحفاة",
