...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "Пракрадзіцеся побач са скалкавым сэнсарам, скалкавым віскуном ці вартаўніком, каб вас не выявілі",
	...
	"advancements.husbandry.froglights.description": "Майце ў сваім рыштунку, усё магчымыя тыпы жабінага святла",
	...
	"advancements.nether.obtain_blaze_rod.description": "Пазбаўце полыменя ягонага стрыжню",
	...
	"chat.previewInput": "Націсніце [%s] для папярэдняга прагляду",
	"chat.queue": "[+%s радкоў у чарзе]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Гэта паведамленне было адфільтравана серверам.",
	"chat.tag.modified": "Гэта паведамленне было мадыфікавана серверам.",
	"chat.tag.modified.original": "Арыгінальны тэкст: %s",
	"chat.tag.not_secure": "Гэта паведамленне не з'яўляецца бяспечным, гэта азначае, што яно магло быць зменена серверам",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Больш не паведамляць для гэтага сервера",
	"chatPreview.warning.content": "Папярэдні прагляд чату дазваляе серверу праглядаць паведамленні, перш як адправіць іх іншым гульцам. Дзякуючы гэтаму сервер зможа прадэманстраваць вам паведамленне з ужытымі да яго стылямі і зменамі.\n\nПаводзіны перадпрагляду можна можна наладзіць у наладах чату. Бягучае значэнне: [%s]",
	"chatPreview.warning.title": "Гэты сервер выкарыстоўвае папярэдні прагляд чату",
	"chatPreview.warning.toast": "Гэты сервер выкарыстоўвае папярэдні прагляд чату і можа бачыць вашы паведамленні да таго, як яны будуць адпраўлены іншым гульцам. Вы можаце адключыць гэта ў наладах чату.",
	"chatPreview.warning.toast.title": "Папярэдні прагляд чату ўключаны",
	...
	"commands.locate.biome.invalid": "Не існуе біёму «%s»",
	"commands.locate.biome.not_found": "Не атрымалася знайсці біём «%s» на даступнай адлегласці",
	"commands.locate.biome.success": "Найбліжэйшая структура %s размешчана на каардынатах %s (адлегласць – %s блокаў)",
	"commands.locate.poi.invalid": "Не існуе аб'екта тыпу «%s»",
	...
	"death.attack.anvil": "Гулец %[1]s быў раздаўлены кавадлай",
	...
	"entity.minecraft.chest_boat": "Човен з куфарам",
	...
	"gamerule.forgiveDeadPlayers.description": "Абураныя нейтральныя істоты перастаюць злавацца, калі мэтанакіраваны гулец памірае побач.",
	...
	"gamerule.mobGriefing": "Дазвол істотам ламаць блокі",
	...
	"gamerule.universalAnger.description": "Абураныя нейтральныя істоты атакуюць любога бліжэйшага гульца, а не толькі гульца, які іх абурае. Працуе лепш за ўсё, калі каманда \"forgiveDeadPlayers\" адключана.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Хтосьці псуе рэпутацыю іншай асобы, выдае сябе за каго-небудзь іншага, або распаўсюджвае ілжывую інфармацыю, спрабуючы падмануць або ўвесці ў зман іншых.",
	"gui.abuseReport.reason.description": "Апісанне:",
	"gui.abuseReport.reason.false_reporting": "Ілжывыя справаздачы",
	"gui.abuseReport.reason.harassment_or_bullying": "Дамаганні або здзекі",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Хтосьці прыніжае, нападае або пераследуе вас ці кагосьці іншага. Гэта таксама прымяняецца, калі нехта спрабуе неаднаразова звязацца з вамі ці з кімсьці іншым без дазволу, або публікуе асабістую інфармацыю, якая належыць вам ці камусьці іншаму («дэананімізацыя»).",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Хтосьці абмяркоўвае, падзяляецца ці іншым чынам выкарыстоўвае прыватныя альбо інтымныя выявы.",
	...
	"gui.banned.description.permanent": "Ваш уліковы запіс заблакаваны назаўжды, гэта азначае, што вы больш не зможаце далучыцца да сумеснай гульні ці сэрвісу Realms.",
	"gui.banned.description.reason": "Нядаўна мы атрымалі паведамленне пра некарэктныя паводзіны злучаныя з вашым уліковым запісам. Нашы мадэратары разгледзелі яго і вызначылі як: %s, што супярэчыць усталяваным нормам супольнасці Minecraft.",
	...
	"gui.banned.description.unknownreason": "Нядаўна мы атрымалі паведамленне пра некарэктныя паводзіны злучаныя з вашым уліковым запісам. Нашы мадэратары разгледзелі яго і вызначылі, што прадэманстраваныя паводзіны, супярэчаць усталяваным нормам супольнасці Minecraft.",
	...
	"gui.chatReport.comments": "Поле рэдагавання каментароў",
	"gui.chatReport.describe": "Падаванне дэталяў дапаможа нам прыняць слушнае рашэнне.",
	...
	"gui.chatReport.discard.discard": "Выйсці і адхіліць скаргу",
	"gui.chatReport.discard.return": "Рэдагаваць далей",
	"gui.chatReport.discard.title": "Адхіліць скаргу і каментарыі?",
	...
	"gui.chatReport.selected_chat": "%s паведамленне(-яў) у чаце абрана для скаргі",
	...
	"gui.chatReport.send.too_many_messages": "Спроба ўключыць занадта шмат паведамленняў у справаздачу",
	...
	"gui.chatSelection.fold": "схавана %s незвязаных паведамленняў",
	...
	"gui.socialInteractions.hidden_in_chat": "Паведамленні чату ад %s будуць схаваны",
	...
	"gui.socialInteractions.shown_in_chat": "Паведамленні чату ад %s будуць паказаны",
	...
	"item.minecraft.acacia_chest_boat": "Човен з акацыі з куфарам",
	...
	"item.minecraft.birch_chest_boat": "Бярозавы човен з куфарам",
	...
	"item.minecraft.dark_oak_chest_boat": "Човен з цёмнага дубу з куфарам",
	...
	"item.minecraft.jungle_chest_boat": "Човен з трапічнай драўніны з куфарам",
	...
	"item.minecraft.mangrove_chest_boat": "Човен з мангравай драўніны з куфарам",
	...
	"item.minecraft.oak_chest_boat": "Дубовы човен з куфарам",
	...
	"multiplayer.disconnect.invalid_public_key": "Не атрымалася прааналізаваць адкрыты ключ профілю.",
	"multiplayer.disconnect.invalid_public_key_signature": "Няслушны подпіс для адкрытага ключа профілю.\nПаспрабуйце перазапусціць гульню.",
	...
	"multiplayer.disconnect.missing_public_key": "Адсутнічае адкрыты ключ профілю.\nГэты сервер патрабуе бяспечныя профілі.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Атрыманы некарэктны пакет чату. Ваш сістэмны час змяніўся?",
	...
	"options.chatPreview": "Прадпрагляд чату",
	"options.chatPreview.confirm": "Пры адпраўцы",
	"options.chatPreview.live": "Падчас уводу",
	"options.chatPreview.tooltip.confirm": "Калі сервер выкарыстоўвае папярэдні прагляд: перадпрагляд будзе генеравацца толькі пры спробе адправіць паведамленне, якое патрабуе папярэдняга прагляду.\nАдпраўленне паведамлення трэба будзе пацвердзіць дадатковае.",
	"options.chatPreview.tooltip.live": "Калі сервер выкарыстоўвае папярэдні прагляд: любыя змены ў паведамленне будуць адлюстроўвацца адразу, каб паказваць як яны будуць выглядаць наўпрост падчас рэдагавання.",
	"options.chatPreview.tooltip.off": "Любыя мадыфікацыі, унесеныя серверам у вашы паведамленні ў чаце, не будуць праглядацца і будуць разглядацца як небяспечныя.",
	...
	"subtitles.entity.goat.horn_break": "Казіны рог адламываецца",
