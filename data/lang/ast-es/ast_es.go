...
var Map = map[string]string{
	...
	"chat.tag.modified.original": "Testu orixinal: %s",
	"chat.type.admin": "[%s: %s]",
	...
	"commands.locate.biome.invalid": "Nun hai nengún bioma col tipu «%s»",
	"commands.locate.biome.not_found": "Nun pudo atopase'l bioma del tipu «%s» dientro d'una distancia razonable",
	"commands.locate.biome.success": "La estructura %s más cercana ta en %s (a %s bloques de distancia)",
	"commands.locate.poi.success": "La estructura %s más cercana ta en %s (a %s bloques de distancia)",
	...
	"gui.socialInteractions.status_blocked_offline": "Bloquiao - Fuera de linfa",
	...
	"selectWorld.backupQuestion.snapshot": "¿De xuru que quies cargar esti mundu?",
