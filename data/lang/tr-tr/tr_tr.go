...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "Sizi fark etmesini önlemek için bir Sculk Sensörünün veya Warden'ın yakınlarında eğilin",
	...
	"advancements.adventure.fall_from_world_height.description": "Dünyanın tepesinden (yapı sınırı) dünyanın dibine serbest düşüş ve hayatta kal",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Sculk Katalizörünün yanında bir canlıyı öldür",
	...
	"advancements.adventure.play_jukebox_in_meadows.description": "Çayırları bir Müzik Kutusundan gelen müzik ile canlandır",
	...
	"advancements.adventure.shoot_arrow.description": "Ok ile bir şeyi vur",
	"advancements.adventure.shoot_arrow.title": "Nişan Al",
	"advancements.adventure.sleep_in_bed.description": "Yeniden doğma noktanı değiştirmek için bir Yatakta yat",
	...
	"advancements.adventure.trade_at_world_height.description": "Maksimum inşa yüksekliği sınırında bir Köylü ile takas yap",
	"advancements.adventure.trade_at_world_height.title": "Yıldız Tüccarı",
	"advancements.adventure.two_birds_one_arrow.description": "Delici bir okla iki Hayalet öldür",
	...
	"advancements.end.dragon_breath.description": "Ejderhanın Nefesini bir Cam Şişede topla",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Bir Sakin'in bir Nota Bloğuna pasta bırakmasını sağlayın",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Doğum Günü Şarkısı",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Bir Sakinin size eşyalar teslim etmesini sağlayın",
	...
	"advancements.husbandry.complete_catalogue.description": "Bütün Kedi çeşitlerini evcilleştir!",
	...
	"advancements.husbandry.froglights.description": "Tüm Kurbağa Işıklarını envanterinde bulundur",
	"advancements.husbandry.froglights.title": "Güçlerimiz Birleşince!",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Bir Tabeladaki yazıyı parlat",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Arıları öfkelendirmeden Arı Kovanından bir Şişe kullanarak Bal toplamak için bir Kamp Ateşi kullan",
	...
	"advancements.husbandry.tactical_fishing.description": "Bir Balık yakala... Olta olmadan!",
	"advancements.husbandry.tactical_fishing.title": "Taktik Balıkçılık",
	"advancements.husbandry.tadpole_in_a_bucket.description": "Bir Kovayla İribaş yakalayın",
	...
	"advancements.nether.brew_potion.description": "Bir İksir yap",
	...
	"advancements.nether.create_beacon.description": "Bir Fener oluştur ve yerleştir",
	...
	"advancements.nether.loot_bastion.description": "Bir Kale Kalıntısında sandık yağmala",
	...
	"advancements.nether.use_lodestone.description": "Bir Mıknatıs Manyetit üzerinde Pusula kullan",
	...
	"advancements.story.lava_bucket.description": "Bir Kovayı lav ile doldur",
	...
	"biome.minecraft.deep_dark": "Zifirî Derinlikler",
	...
	"biome.minecraft.snowy_plains": "Karlı Düzlükler",
	...
	"biome.minecraft.stony_shore": "Taşlı Sahil",
	...
	"biome.minecraft.windswept_savanna": "Rüzgarlı Savan",
	"biome.minecraft.wooded_badlands": "Ağaçlık Kırgıbayır",
	...
	"block.minecraft.mangrove_planks": "Mangrov Tahta",
	"block.minecraft.mangrove_pressure_plate": "Mangrov Basınç Plakası",
	"block.minecraft.mangrove_propagule": "Mangrov Propagülü",
	...
	"block.minecraft.mangrove_wall_sign": "Duvarda Mangrov Tabela",
	...
	"block.minecraft.mud_brick_slab": "Kerpiç Tuğla Basamak",
	"block.minecraft.mud_brick_stairs": "Kerpiç Tuğla Merdiven",
	"block.minecraft.mud_brick_wall": "Kerpiç Tuğla Duvar",
	"block.minecraft.mud_bricks": "Kerpiç Tuğla",
	...
	"block.minecraft.potted_mangrove_propagule": "Saksıda Mangrov Propagülü",
	...
	"block.minecraft.reinforced_deepslate": "Güçlendirilmiş Derin Kayrak Taşı",
	...
	"chat.disabled.profile": "Hesap ayarlarından dolayı sohbete izin verilemiyor. Daha fazla bilgi almak için tekrar '%s' tuşuna basın",
	"chat.disabled.profile.moreInfo": "Hesap ayarlarından dolayı sohbete izin verilmiyor. İleti gönderilemiyor ve görüntülenmiyor.",
	"chat.editBox": "sohbet",
	"chat.filtered_full": "Bu sunucu mesajınızı diğer oyunculardan gizledi.",
	...
	"chat.previewInput": "Önizlemeyi açmak için [%s] tuşuna basın",
	"chat.queue": "[+%s bekleyen satır]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Bu mesaj sunucu tarafından filtrelendi.",
	"chat.tag.modified": "Bu mesaj sunucu tarafından düzenlendi.",
	"chat.tag.modified.original": "Orijinal metin: %s",
	"chat.tag.not_secure": "Bu mesaj güvenli değil, yani sunucu tarafından değişmiş olabilir",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Bu sunucu için bir daha bilgilendirme",
	"chatPreview.warning.content": "Sohbet Önizleme, sunucunun mesajlarınızı diğer oyunculara gönderilmeden önce görmesini sağlar. Bu, bir sunucunun size özel değişiklikler ve stil uygulanmış olarak sohbet mesajlarınızın bir önizlemesini gönderilmesini sağlar.\n\nSohbet Önizleme davranışı, Sohbet Ayarlarınızda değiştirilebilir. Geçerli ayar: [%s]",
	"chatPreview.warning.title": "Bu sunucu sohbet önizleme kullanıyor",
	"chatPreview.warning.toast": "Bu sunucu Sohbet Önizleme kullanıyor ve mesajlarınızı yazarken, yani siz göndermeden öncede görebilir. Bu özelliği Sohbet Ayarlarından kapatabilirsiniz.",
	"chatPreview.warning.toast.title": "Sohbet Önizleme etkin",
	...
	"commands.locate.biome.invalid": "\"%s\" türünde biyom yok",
	"commands.locate.biome.not_found": "Desteklenen uzaklık içinde \"%s\" Biyomundan bulunamadı",
	"commands.locate.biome.success": "En yakın %s; %s'de (%s blok mesafede)",
	"commands.locate.poi.invalid": "\"%s\" türünde ilgi noktası yok",
	"commands.locate.poi.not_found": "Uygun mesafe dahilinde \"%s\" türünde ilgi noktası bulunamadı",
	"commands.locate.poi.success": "En yakın %s; %s'de (%s blok mesafede)",
	...
	"commands.locate.structure.success": "En yakın %s; %s'de (%s blok mesafede)",
	...
	"commands.place.feature.failed": "Özellik koyulamadı",
	...
	"commands.place.structure.success": "%s yapısı oluşturuldu %s, %s, %s",
	"commands.place.template.failed": "Şablon yerleştirilemedi",
	"commands.place.template.invalid": "\"%s\" Id'ye sahip şablon bulunamadı",
	...
	"commands.spreadplayers.failed.invalid.height": "Geçersiz maxHeight %s; dünya minimumu %s'den bir yüksek değer olmalı",
	...
	"compliance.playtime.greaterThan24Hours": "24 saatten fazla oynuyorsun",
	"compliance.playtime.hours": "%s saat(tir) boyunca oynuyorsun",
	...
	"death.attack.onFire.item": "%[3]s, %[2]s ile savaşırken %[1]s cayır cayır yandı",
	...
	"death.attack.sonic_boom.item": "%[1]s, %[2]s tarafından %[3]s ile kaçmaya çalışırken sonik yüklü bir çığlık tarafından yok edildi",
	"death.attack.sonic_boom.player": "%[1]s , %[2]s 'den kaçmaya çalışırken yüksek sesli bir çığlık tarafından yok edildi",
	...
	"death.attack.sting.item": "%[1]s, %[2]s tarafından %[3]s kullanılarak öldürüldü",
	...
	"death.attack.witherSkull.item": "%[1]s, %[2]s tarafından %[3]s kullanılarak kafatasından vuruldu",
	...
	"disconnect.loginFailedInfo.userBanned": "Çok oyunculu oyunlardan uzaklaştırıldın",
	...
	"enchantment.minecraft.swift_sneak": "Süratli Gizlilik",
	...
	"flat_world_preset.minecraft.classic_flat": "Klasik Düz",
	"flat_world_preset.minecraft.desert": "Çöl",
	"flat_world_preset.minecraft.overworld": "Dünya",
	"flat_world_preset.minecraft.redstone_ready": "Kızıl Taşa Hazır",
	...
	"gamerule.doWardenSpawning": "Muhafızlar Doğsun",
	...
	"generator.minecraft.large_biomes": "Geniş Biyomlar",
	...
	"gui.abuseReport.error.title": "Raporunuz gönderilirken bir sorun yaşandı",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Uyuşturucular veya alkol",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Bir kişi yasa dışı madde kullanımını veya erişkin olma ve yaşının altında alkollü içki tüketmeyi destekliyor.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Çocuk Tacizi Ve Cinsel baskı",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Birisi çocukların dahil olacağı uygunsuz davranışlar hakkında konuşuyor veya teşvik ediyor.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Karalama, taklit, ve yanlış bilgi",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Birisi, başka birinin itibarını zedeliyor, olmadığı biri gibi davranıyor veya başkalarını üzmek veya yanlış yönlendirmek amacıyla yanlış bilgiler paylaşıyor.",
	"gui.abuseReport.reason.description": "Açıklama:",
	"gui.abuseReport.reason.false_reporting": "Yanlış Raporlama",
	"gui.abuseReport.reason.harassment_or_bullying": "Taciz veya zorbalık",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Birisi sizi veya bir başkasını utandırıyor, saldırıyor veya zorbalık yapıyor. Bu, birisinin sizinle veya bir başkasıyla izinsiz olarak tekrar tekrar iletişim kurmaya çalışması (veya sizin veya bir başkası hakkında izniniz olmadan özel kişisel bilgileri yayınlamasını içerir).",
	"gui.abuseReport.reason.hate_speech": "Nefret söylemi",
	"gui.abuseReport.reason.hate_speech.description": "Birisi din, ırk veya cinsiyet gibi karakteristik özelliklerine dayanarak size veya başka bir oyuncuya saldırıyor.",
	"gui.abuseReport.reason.imminent_harm": "Gerçekleşmek üzere olan zarar verme eylemi - Başkalarına zarar verme tehtidi",
	"gui.abuseReport.reason.imminent_harm.description": "Birisi gerçek hayatta sizi veya başkasını zarar vermekle tehdit ediyor.",
	"gui.abuseReport.reason.narration": "%s: %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Kişinin Rızası Dışında Kişisel Görüntüler",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Gerçekleşmek üzere olan zarar verme eylemi - Kendine zarar verme veya intihar",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Birisi gerçek hayatta kendine zarar vermekle tehdit ediyor, veya kendilerine zarar vermek hakkında konuşuyor.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terörizm ve şiddetli aşırılık",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Birisi politik, dini, ideolojik, ve diğer sebeplerden dolayı terörizm olayları veya şiddette aşırılık hakkında konuşuyor, teşvik ediyor, veya yapmaya tehdit ediyor.",
	"gui.abuseReport.reason.title": "Rapor Kategorisi Seçin",
	"gui.abuseReport.send.error_message": "Raporunuz gönderilirken hatayla karşılaştı:\n'%s'",
	"gui.abuseReport.send.generic_error": "Raporunuz gönderilirken beklenmeyen bir hata ile karşılaşıldı.",
	"gui.abuseReport.send.http_error": "Raporunuz gönderilirken bilinmeyen bir HTTP hatası yaşandı.",
	...
	"gui.abuseReport.sending.title": "Raporunuz gönderiliyor...",
	"gui.abuseReport.sent.title": "Rapor gönderildi",
	"gui.acknowledge": "Kabul et",
	"gui.advancements": "Gelişimler",
	"gui.all": "Tümü",
	"gui.back": "Geri",
	"gui.banned.description": "%s\n\n%s\n\nBurada daha fazlasını öğrenin: %s",
	"gui.banned.description.permanent": "Hesabınız kalıcı olarak yasaklandı. yani çok oyunculu oyunlarda oynayamıcak ve Realms'e katılamayacaksınız.",
	"gui.banned.description.reason": "Kısa bir süre önce hesabınızın kötü davranışıyla ilgili bir rapor aldık, yetkili ekiplerimiz durumu inceledi ve Minecraft Topluluk Standartlarına aykırı olan %s olarak tespit etti.",
	"gui.banned.description.reason_id": "Kod: %s",
	"gui.banned.description.reason_id_message": "Kod: %s - %s",
	"gui.banned.description.temporary": "%s Zamanına kadar çok oyunculu sunucularda oynayamazsınız ve Realms'e katılamazsınız.",
	"gui.banned.description.temporary.duration": "Hesabınız geçici olarak yasaklandı \u200b\u200bve %s içinde yeniden etkinleştirilecek.",
	"gui.banned.description.unknownreason": "Kısa süre önce hesabınızın kötü davranışıyla ilgili bir rapor aldık moderatörümüz şimdi durumuzu inceledi ve Minecraft Topluluk Standartlarına aykırı olan durum olarak tespit etti.",
	"gui.banned.title.permanent": "Hesabınız kalıcı olarak yasaklandı",
	"gui.banned.title.temporary": "Hesap geçici olarak yasaklandı",
	"gui.cancel": "İptal",
	"gui.chatReport.comments": "Yorum düzenleme kutusu",
	"gui.chatReport.describe": "Detay vermeniz daha tutarlı karar vermemize yardım edecektir.",
	"gui.chatReport.discard.content": "Eğer çıkarsanız, bu raporu ve mesajlarınızı kaybedeceksiniz.\nÇıkmak istediğinize emin misiniz?",
	"gui.chatReport.discard.discard": "Çık ve Raporu Sil",
	"gui.chatReport.discard.return": "Düzenlemeye Devam Et",
	"gui.chatReport.discard.title": "Rapor ve yorumları sil?",
	"gui.chatReport.more_comments": "Lütfen neler yaşandığını anlatın:",
	"gui.chatReport.observed_what": "Bunu bildirme sebebiniz nedir?",
	"gui.chatReport.read_info": "Raporlama Hakkında Bilgi Sahibi Olun",
	"gui.chatReport.report_sent_msg": "Raporunuzu başarıyla aldık. Teşekkürler!\n\nEkibimiz en kısa zamanda raporunuz inceleyecek.",
	"gui.chatReport.select_chat": "Bildirmek için Sohbet Mesajı Seçiniz",
	"gui.chatReport.select_reason": "Rapor Kategorisi Seçin",
	"gui.chatReport.selected_chat": "%s Sohbet Mesaj(ları)'ı Bildirmek İçin Seçildi",
	"gui.chatReport.send": "Raporu Gönder",
	"gui.chatReport.send.comments_too_long": "Lütfen yorumu kısaltın",
	"gui.chatReport.send.no_reason": "Lütfen rapor kategorisi seçin",
	"gui.chatReport.send.no_reported_messages": "Bildirmek için en az bir sohbet mesajı seçin",
	"gui.chatReport.send.too_many_messages": "Rapora çok fazla mesaj eklemeye çalışmak",
	"gui.chatReport.title": "Oyuncuyu Raporla",
	"gui.chatSelection.context": "Bu seçimi çevreleyen mesajlar ek bağlam sağlamak için dahil edilecektir",
	"gui.chatSelection.fold": "%s alakasız mesajlar gizlendi",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s: %s (ye/e/a/na/) %s dedi",
	"gui.chatSelection.selected": "%s/%s mesaj(ları) seçilmiştir",
	"gui.chatSelection.title": "Bildirmek için Sohbet Mesajları Seçin",
	"gui.days": "%s gün",
	"gui.done": "Tamam",
	"gui.down": "Aşağı",
	...
	"gui.socialInteractions.narration.hide": "%s'den mesajları gizle",
	"gui.socialInteractions.narration.report": "Oyuncuyu Bildir: %s",
	"gui.socialInteractions.narration.show": "%s'ın mesajlarını göster",
	...
	"gui.socialInteractions.tooltip.hide": "Mesajları Gizle",
	"gui.socialInteractions.tooltip.report": "Oyuncuyu Raporla",
	"gui.socialInteractions.tooltip.report.disabled": "Bildirme servisine erişilemiyor",
	"gui.socialInteractions.tooltip.report.no_messages": "%s kullanıcısından rapor edilebilecek mesaj yok",
	"gui.socialInteractions.tooltip.report.not_reportable": "Bu kullanıcı rapor edilemez çünkü mesajları sunucu tarafından doğrulanmıyor",
	"gui.socialInteractions.tooltip.show": "Mesajları Göster",
	...
	"item.minecraft.allay_spawn_egg": "Sakin Çağırma Yumurtası",
	...
	"item.minecraft.echo_shard": "Akis Parçacığı",
	...
	"multiplayer.disconnect.chat_validation_failed": "Sohbet mesajı doğrulama başarısız",
	...
	"multiplayer.disconnect.invalid_public_key": "Profil açık anahtarı ayrıştırılamadı.",
	"multiplayer.disconnect.invalid_public_key_signature": "Profil ortak anahtarı için geçersiz imza.\nOyununuzu yeniden başlatmayı deneyin.",
	...
	"multiplayer.disconnect.missing_public_key": "Profil açık anahtarı eksik.\nBu sunucu güvenli profil gerektiriyor.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Çok fazla onaylanmamış sohbet mesajı",
	"multiplayer.disconnect.unexpected_query_response": "İstemciden beklenmeyen özel veri alındı",
	"multiplayer.disconnect.unsigned_chat": "Eksik veya geçersiz kelime içerikli bir sohbet paketi alındı.",
	...
	"multiplayer.unsecureserver.toast": "Bu sunucuda gönderilen mesajlar değiştirilebilir ve orijinal mesajı yansıtmayabilir",
	"multiplayer.unsecureserver.toast.title": "Sohbet mesajları doğrulanamıyor",
	...
	"options.allowServerListing": "Sunucu Listelemelerine İzin Ver",
	"options.allowServerListing.tooltip": "Sunucular çevrimiçi oyuncuları genel durumlarının bir parçası olarak listeleyebilir.\nBu seçenek kapalıyken adınız bu tür listelerde gözükmeyecektir.",
	...
	"options.chatPreview": "Sohbet Önizlemesi",
	"options.chatPreview.confirm": "When Sending",
	"options.chatPreview.live": "Yazarken",
	"options.chatPreview.tooltip.confirm": "Bir sunucu Sohbet Önizlemelerini kullanıyorsa: Bir Sohbet Önizlemesi, yalnızca önizlemesi olmayan veya önizleme bekleyen bir mesaj gönderilmeye çalışıldığında oluşturulur.\nMesajın gönderilmesi onay gerektirir.",
	"options.chatPreview.tooltip.live": "Bir sunucu Sohbet Önizlemelerini kullanıyorsa: Bir sunucu tarafından sohbet mesajlarınıza uygulanan tüm farklılaştırmalar, sohbet mesajı yazılırken önizleme için dinamik olarak gönderilir.",
	"options.chatPreview.tooltip.off": "Bir sunucu tarafından sohbet mesajlarınıza uygulanan herhangi bir değişiklik Önİzlenemeyecek ve güvensiz olarak değerlendirilecektir.",
	...
	"options.onlyShowSecureChat": "Sadece Güvenli Sohbeti Göster",
	"options.onlyShowSecureChat.tooltip": "Diğer oyunculardan gelen mesajları sadece o oyuncu tarafından gönderildiği doğrulanmış ve değiştirilmemiş ise görüntüle.",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Bir öbek içindeki bazı eylemler öbeği hemen yeniden derleyecektir. Bu, blokların yerleştirilmesini ve yok edilmesini içerir.",
	"options.prioritizeChunkUpdates.nearby": "Tam Kısıtlama",
	"options.prioritizeChunkUpdates.nearby.tooltip": "Yakındaki parçalar her zaman derhal derlenir. Bu, bloklar yerleştirildiğinde veya yok edildiğinde oyun performansını etkileyebilir.",
	"options.prioritizeChunkUpdates.none": "Bağlantılı",
	"options.prioritizeChunkUpdates.none.tooltip": "Yakındaki parçalar paralel iş parçacıklarında derlenir. Bu neticede bloklar yok edildiğinde, görsel deliklere sebep olabilir.",
	...
	"subtitles.block.frogspawn.hatch": "İribaş yumurtaları çatladı",
	...
	"subtitles.block.sculk_shrieker.shriek": "Sculk Çığırtkanı çığırıyor",
	...
	"subtitles.entity.allay.ambient_with_item": "Sakin arıyor",
	"subtitles.entity.allay.ambient_without_item": "Sakin özlüyor",
	"subtitles.entity.allay.death": "Sakin öldü",
	"subtitles.entity.allay.hurt": "Sakin incindi",
	"subtitles.entity.allay.item_given": "Sakin kıkırdıyor",
	"subtitles.entity.allay.item_taken": "Sakin sakinleşiyor",
	"subtitles.entity.allay.item_thrown": "Sakin attı",
	...
	"subtitles.entity.frog.eat": "Kurbağa yedi",
	...
	"subtitles.entity.parrot.imitate.elder_guardian": "Papağan Gardiyanı taklit ediyor",
	...
	"subtitles.entity.parrot.imitate.warden": "Papağan Muhafız'ı taklit ediyor",
	...
	"subtitles.entity.tadpole.death": "İribaş öldü",
	"subtitles.entity.tadpole.flop": "İribaş düştü",
	...
	"subtitles.entity.warden.agitated": "Muhafız sinirlice inliyor",
	...
	"subtitles.entity.warden.nearby_closest": "Muhafız yakınlaşıyor",
	"subtitles.entity.warden.roar": "Muhafız kükredi",
	...
	"title.32bit.deprecation.realms": "Minecraft yakında bu cihazda Realms oynamanızı veya kullanmanızı engelleyecek 64 bitlik bir sisteme ihtiyaç duyacaktır. Herhangi bir Realms aboneliğini manuel olarak iptal etmeniz gerekecektir",
	...
	"title.multiplayer.disabled": "Çoklu oyuncu devre dışı bırakıldı. Lütfen Microsoft hesabı ayarlarınızı kontrol edin.",
	"title.multiplayer.disabled.banned.permanent": "Hesabınız çevrim içi oyundan kalıcı olarak kaldırıldı",
	"title.multiplayer.disabled.banned.temporary": "Hesabınız çevrim içi oyundan geçici olarak kaldırıldı",
