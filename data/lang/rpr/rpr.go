...
var Map = map[string]string{
	...
	"advancements.end.dragon_breath.description": "Соберите духъ змѣя въ бутылочку",
	...
	"block.minecraft.ochre_froglight": "Охристый жабосвѣтъ",
	...
	"block.minecraft.pearlescent_froglight": "Перламутровый жабосвѣтъ",
	...
	"block.minecraft.sculk_catalyst": "Скалкъ-катализаторъ",
	"block.minecraft.sculk_sensor": "Скалкъ-датчикъ",
	"block.minecraft.sculk_shrieker": "Кричащій скалкъ",
	...
	"chat.copy.click": "Нажмите, чтобы записать на перфоленту",
	...
	"chat.disabled.profile": "Бесѣда отключена въ настройкахъ документовъ. Прожмите %s ещё разъ, чтобъ разузнать подробности",
	"chat.disabled.profile.moreInfo": "Бесѣда отключена въ настройкахъ документовъ. Невозможно отправить или просмотрѣть письмо.",
	"chat.editBox": "бесѣда",
	...
	"chat.link.confirmTrusted": "Изволите открыть или записать ссылку на перфоленту?",
	"chat.link.open": "Открыть",
	"chat.link.warning": "Не переходите по ссылкамъ отъ людей, которымъ не довѣряете!",
	"chat.previewInput": "Нажмите [%s] для анонса",
	"chat.queue": "[+%s строкъ въ очереди]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Сообщение отфильтровано сервером.",
	"chat.tag.modified": "Сіе письмо было видоизмѣнено салономъ.",
	"chat.tag.modified.original": "Оригинальный текстъ: %s",
	"chat.tag.not_secure": "Письмо не подписано. Сіе значитъ, что оно могло быть измѣнено салономъ",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Не показывать снова для сего салона",
	"chatPreview.warning.content": "Анонсъ бесѣды разрѣшаетъ салону просматривать письма, прежде чѣмъ отправить ихъ другимъ игрокамъ. Благодаря сему салонъ сможетъ показать вамъ письма съ примѣнёнными стилями и правки.\n\nПоведеніе анонса можно настроить въ настройкахъ бесѣды. Текущее значеніе: [%s]",
	"chatPreview.warning.title": "Сей салонъ дѣлаетъ анонсъ бесѣды",
	"chatPreview.warning.toast": "Сервер использует предпросмотр чата и может видеть ваши сообщения по мере их ввода, даже до того, как они будут отправлены. Это можно отключить в настройках чата.",
	"chatPreview.warning.toast.title": "Анонсъ бесѣды включёнъ",
	...
	"command.exception": "Не вышло распознать команду: %s",
	...
	"commands.advancement.grant.one.to.one.failure": "Не вышло выдать достиженіе «%s» игроку %s, потому что оное при нёмъ имѣется",
	...
	"commands.advancement.revoke.many.to.many.failure": "Не вышло отозвать %s достиженій у %s игроковъ, потому что они еще не получили ихъ",
	...
	"commands.locate.biome.invalid": "Не существуетъ біома «%s»",
	"commands.locate.biome.not_found": "Не вышло найти біомъ «%s» поблизости",
	"commands.locate.biome.success": "Ближайшее строеніе типа %s находится по координатамъ %s (въ %s блокахъ отсюда)",
	"commands.locate.poi.invalid": "Не существуетъ точки интереса «%s»",
	"commands.locate.poi.not_found": "Не вышло найти точку интереса «%s» поблизости",
	"commands.locate.poi.success": "Ближайшее строеніе типа %s находится по координатамъ %s (въ %s блокахъ отсюда)",
	...
	"commands.place.feature.success": "Объектъ «%s» размѣщёнъ въ точку %s, %s, %s",
	"commands.place.jigsaw.failed": "Не вышло создать пазлъ",
	"commands.place.jigsaw.invalid": "Не существуетъ множества образцовъ вида «%s»",
	"commands.place.jigsaw.success": "Пазлъ созданъ въ точкѣ %s, %s, %s",
	"commands.place.structure.failed": "Не вышло размѣстить строеніе",
	"commands.place.structure.invalid": "Не существуетъ строенія «%s»",
	...
	"commands.place.template.invalid": "Не существуетъ множества образцовъ вида «%s»",
	...
	"connect.failed": "Не вышло войти въ салонъ",
	...
	"dataPack.validation.failed": "Не вышло провѣрить наборъ свѣдѣній!",
	...
	"death.attack.onFire.item": "%[1]s был сожжёнъ, пока боролся съ %[2]s, съ помощью %[3]s",
	...
	"death.attack.sonic_boom": "%[1]s был поражёнъ звуковой волной",
	"death.attack.sonic_boom.item": "%[1]s былъ уничтоженъ звуковымъ зарядомъ, спасаясь отъ %[2]s cъ %[3]s",
	"death.attack.sonic_boom.player": "%[1]s былъ поражёнъ звуковой волной, спасаясь отъ %[2]s",
	...
	"debug.copy_location.message": "Координаты записаны на перфоленту",
	...
	"debug.inspect.client.block": "На перфоленту записаны кліентскія свѣдѣнія блока",
	"debug.inspect.client.entity": "На перфоленту записаны кліентскія свѣдѣнія сущности",
	"debug.inspect.help": "F3 + I = Записать на перфоленту данные сущности или блока",
	"debug.inspect.server.block": "На перфоленту записаны салонныя свѣдѣнія блока",
	"debug.inspect.server.entity": "На перфоленту записаны салонныя свѣдѣнія сущности",
	...
	"disconnect.exceeded_packet_rate": "Вы исключены за превышеніе частоты передачи свѣдѣній",
	...
	"disconnect.loginFailedInfo.userBanned": "Вамъ болѣ недоступна игра в компанiи",
	...
	"generator.minecraft.amplified.info": "Примѣчаніе: Просто для потѣхи! Нуженъ хорошій счётный аппаратъ.",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Растлѣніе дѣтей или нанесеніе имъ увѣчій",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Клевета, выдача себя за другое лицо или ложныя свѣдѣнія",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Нанесеніе вреда чьей-либо репутаціи, выдача себя за другое лицо или распространеніе ложных свѣдѣній, дабы обмануть или запутать кого-либо.",
	...
	"gui.abuseReport.reason.harassment_or_bullying.description": "Оскорбленія, нападки или запугиваніе, въ т. ч. случаи, когда нѣкто многократно пытается связаться съ вами или кѣмъ-то ещё безъ вашего согласія, либо публикуетъ без согласія личныя свѣдѣнія о васъ или комъ-то ещё.",
	"gui.abuseReport.reason.hate_speech": "Языкъ вражды",
	"gui.abuseReport.reason.hate_speech.description": "Оскорбленія по отношенію къ вамъ или инымъ игрокамъ, связанныя съ отношеніемъ къ религии, расѣ или половой принадлежности.",
	"gui.abuseReport.reason.imminent_harm": "Непосредственная опасность — угрозы причиненія вреда",
	"gui.abuseReport.reason.imminent_harm.description": "Угрозы причинить физическій вредъ кому-либо",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Непосредственная опасность — членовредительство или самоубійство",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Угрозы причинить себѣ физическій вредъ или разсказы о причиненіи себѣ физическаго вреда.",
	...
	"gui.abuseReport.send.error_message": "При отправкѣ жалобы вышелъ курьёзъ:\n«%s»",
	"gui.abuseReport.send.generic_error": "Произошёлъ неизвѣстный курьёзъ при отправкѣ жалобы.",
	"gui.abuseReport.send.http_error": "При отправкѣ жалобы произошёлъ неожиданный курьёзъ H.T.T.P.",
	"gui.abuseReport.send.json_error": "При отправкѣ жалобы произошёлъ курьёзъ.",
	"gui.abuseReport.send.service_unavailable": "Не вышло связаться со службой писемъ о нарушеніяхъ. Провѣрьте подключеніе къ сѣти и повторите попытку.",
	...
	"gui.banned.description.permanent": "Доступ к вашей учётной записи запрещёнъ навсегда, вы не сможете играть въ компаніи или Realms.",
	"gui.banned.description.reason": "Давѣча была получена жалоба на непріемлемое поведеніе съ использованіемъ вашей учётной записи. Наши модераторы разсмотрѣли ситуацию и опредѣлили её какъ %s, что идётъ вразрѣзъ со Стандартами сообщества Minecraft.",
	...
	"gui.banned.description.unknownreason": "Давѣча была получена жалоба на непріемлемое поведеніе съ использованіемъ вашей учётной записи. Наши модераторы разсмотрѣли ситуацию и опредѣлили её какъ идущую вразрѣзъ со Стандартами сообщества Minecraft.",
	...
	"gui.chatReport.send.no_reported_messages": "Пожалуйста, выберите хотя бы одно письмо въ \u200bбесѣдѣ\u200b, чтобы подать жалобу",
	"gui.chatReport.send.too_many_messages": "Слишком много писемъ для жалобы",
	"gui.chatReport.title": "Подать жалобу",
	"gui.chatSelection.context": "Письма, окружающія выбранныя, будутъ включены для обрисовки контекста",
	"gui.chatSelection.fold": "Скрыто %s несвязанныхъ писемъ",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s сказалъ: %s въ %s",
	...
	"gui.socialInteractions.narration.hide": "Скрывать письма отъ %s",
	"gui.socialInteractions.narration.report": "Подать жалобу на %s",
	"gui.socialInteractions.narration.show": "Показывать письма отъ %s",
	"gui.socialInteractions.report": "Жалоба",
	"gui.socialInteractions.search_empty": "Не вышло отыскать игрока съ симъ именемъ",
	...
	"gui.socialInteractions.tooltip.report": "Подать жалобу",
	...
	"multiplayer.disconnect.chat_validation_failed": "Ошибка завѣренія письма в бесѣдѣ",
	...
	"multiplayer.disconnect.invalid_public_key": "Не вышло опредѣлить открытый ключъ профиля.",
	"multiplayer.disconnect.invalid_public_key_signature": "Невѣрная подпись открытаго ключа профиля.\nИзвольте перезапустить игру.",
	...
	"multiplayer.disconnect.missing_public_key": "Открытый ключъ профиля отсутствуетъ. Для сего салона требуются защищённые профили.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Нарушенъ порядокъ свѣдѣній бесѣды. Измѣнилось время аппарата?",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Слишком много незавѣренныхъ писемъ",
	"multiplayer.disconnect.unexpected_query_response": "Неизвѣстныя свѣдѣнія о пользователѣ",
	"multiplayer.disconnect.unsigned_chat": "Получены свѣдѣнія бесѣды съ отсутствующей или невѣрной цифровой подписью.",
	...
	"multiplayer.message_not_delivered": "Не вышло доставить письмо, провѣрьте журналъ салона: %s",
	...
	"multiplayer.status.cannot_connect": "Не вышло войти въ салонъ",
	...
	"multiplayer.unsecureserver.toast": "Письма, отсылаемыя въ бесѣду сего салона, могутъ быть измѣнены и не отражать подлинное письмо",
	"multiplayer.unsecureserver.toast.title": "Письма въ бесѣдѣ не могутъ быть провѣрены",
	...
	"options.chatPreview": "Анонсъ бесѣды",
	"options.chatPreview.confirm": "При отправкѣ",
	"options.chatPreview.live": "При вводѣ",
	"options.chatPreview.tooltip.confirm": "Если салонъ используетъ анонсъ бесѣды: анонсъ будетъ создаваться только при попыткѣ отправить письма, которое требуетъ анонса.\nОтправку письма надлежитъ завѣрить дополнительно.",
	"options.chatPreview.tooltip.live": "Если салонъ используетъ анонсъ бесѣды: любыя правки въ письмѣ будутъ тотчасъ же передаваться, чтобы показывать как онѣ будутъ выглядѣть прямо во время исправленія.",
	"options.chatPreview.tooltip.off": "Любыя правки вашего письма со стороны салона не будутъ анонсированы и будутъ разсматриваться какъ небезопасныя.",
	...
	"options.darknessEffectScale": "Пульсированіе тьмы",
	"options.darknessEffectScale.tooltip": "Отвѣчаетъ за то, сколь мощной будетъ пульсація эффекта тьмы, получаемаго отъ хранителя или кричащаго скалка.",
	...
	"options.directionalAudio": "Объёмный звукъ",
	"options.directionalAudio.off.tooltip": "Классическое стерео",
	"options.directionalAudio.on.tooltip": "Используетъ технологію направленнаго звука для улучшенной имитаціи объёмнаго звучнія. Требуетъ оборудованіе съ поддержкой двуушнаго воспроизводенія (H.R.T.F.), и лучше всего звучитъ въ наушникахъ.",
	...
	"options.onlyShowSecureChat.tooltip": "Отображать лишь тѣ письма, чьи отправители могутъ быть провѣрены, а содержанiе не было измѣнено.",
	...
	"outOfMemory.message": "Недостаточно памяти для Minecraft.\n\nВозможно, сіе произошло изъ-за курьёза игры или виртуальная машина Java не распологала достаточнымъ объёмомъ памяти.\n\nДабы предотвратить поврежденіе міра, текущая игра была завершена. Произведена попытка освободить память, дабы вернуться въ главное меню и продолжить играть. Но, похоже, сіе ни къ чему не привело.\n\nИзвольте перезапустить игру, коли увидите сіе сообщеніе снова.",
	...
	"resourcePack.load_fail": "Не вышло снова загрузить наборы вещей",
	...
	"selectWorld.delete_failure": "Не вышло стереть міръ",
	...
	"selectWorld.edit.backupFailed": "Не вышло сдѣлать резервную копію",
	...
	"subtitles.entity.allay.item_given": "Угодник хихикаетъ",
	...
	"subtitles.entity.parrot.imitate.elder_guardian": "Попугай стонетъ словно сторожъ",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Попугай фыркаетъ какъ пиглинъ",
	...
	"subtitles.entity.warden.agitated": "Хранитель злобно стонетъ",
	...
	"subtitles.entity.warden.nearby_closest": "Хранитель совсѣмъ близко",
	"subtitles.entity.warden.roar": "Хранитель рычитъ",
	"subtitles.entity.warden.sniff": "Хранитель принюхивается",
	"subtitles.entity.warden.sonic_boom": "Хранитель создаётъ ударную волну",
	...
	"title.32bit.deprecation": "Обнаружена 32-разрядная система: сіе можетъ привести къ невозможности игры въ будущемъ, такъ какъ потребуется 64-разрядная система!",
