...
var Map = map[string]string{
	...
	"block.minecraft.mangrove_pressure_plate": "Namorzinŏwŏ klikwoga",
	...
	"chat.disabled.profile": "Ustawienia konta nie zezwalają na używanie czatu. Naciśnij ponownie „%s”, aby zobaczyć szczegóły",
	...
	"chat.previewInput": "Naciśnij [%s], aby zobaczyć podgląd",
	"chat.queue": "[rzōndki wystrzigajōnce: %s]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Ta wiadomość została przefiltrowana przez serwer.",
	"chat.tag.modified": "Ta wiadomość została zmodyfikowana przez serwer.",
	"chat.tag.modified.original": "Oryginalna treść: %s",
	"chat.tag.not_secure": "Ta wiadomość nie jest zabezpieczona, co oznacza, że mogła zostać zmieniona przez serwer",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Nie powiadamiaj ponownie w przypadku tego serwera",
	"chatPreview.warning.content": "Podgląd czatu pozwala serwerowi zobaczyć twoje wiadomości, zanim zostaną wysłane do innych graczy. Dzięki temu serwer może wysyłać podgląd wiadomości czatu z niestandardowymi modyfikacjami i zastosowanymi stylami.\n\nZachowanie podglądu czatu można zmienić w ustawieniach czatu. Bieżące ustawienie to: [%s]",
	"chatPreview.warning.title": "Ten serwer korzysta z funkcji podglądu czatu",
	"chatPreview.warning.toast": "Ten serwer korzysta z funkcji podglądu czatu i może widzieć twoje wiadomości jeszcze przed ich wysłaniem innym graczom. Możesz wyłączyć tę funkcję w ustawieniach czatu.",
	"chatPreview.warning.toast.title": "Podgląd czatu jest włączony",
	...
	"commands.locate.biome.invalid": "Ńy ma biōmu typu \"%s\"",
	...
	"commands.locate.poi.invalid": "Brak miejsca typu „%s”",
	...
	"commands.place.structure.invalid": "Ńy ma struktury typu „%s”",
	...
	"entity.minecraft.item_frame": "Roma na klamot",
	...
	"gui.abuseReport.error.title": "Problem podczas wysyłania zgłoszenia",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Narkotyki lub alkohol",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Ktoś zachęca innych do udziału w nielegalnych działaniach związanych z narkotykami lub zachęca do picia alkoholu przez nieletnich.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Ktoś szarga reputację innej osoby, podszywa się pod kogoś lub rozpowszechnia fałszywe informacje, chcąc oszukać lub wprowadzić innych w błąd.",
	"gui.abuseReport.reason.description": "Opis:",
	"gui.abuseReport.reason.false_reporting": "Fałszywe zgłaszanie",
	"gui.abuseReport.reason.harassment_or_bullying": "Napastowanie i nękanie",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Ktoś poniża, atakuje albo nęka Ciebie lub kogo innego. Dotyczy to również sytuacji, w których ktoś mimo braku zgody wielokrotnie próbuje się z kimś skontaktować albo ujawnia należące kogoś osobiste informacje wbrew jego woli.",
	"gui.abuseReport.reason.hate_speech": "Mowa nienawiści",
	"gui.abuseReport.reason.hate_speech.description": "Ktoś atakuje cię lub innego użytkownika ze względu na cechy charakterystyczne, takie jak wyznanie, rasa czy orientacja seksualna.",
	"gui.abuseReport.reason.imminent_harm": "Bezpośrednia szkoda — groźba wyrządzenia szkody",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Intymne zdjęcia wbrew woli drugiej osoby",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Ktoś mówi o intymnych i prywatnych zdjęciach, udostępnia lub w inny sposób je propaguje.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Bezpośrednia szkoda — samookaleczenie lub samobójstwo",
	...
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terroryzm lub ostry ekstremizm",
	...
	"gui.acknowledge": "Przyjmij",
	"gui.advancements": "Postympy",
	"gui.all": "Wszycko",
	"gui.back": "Nazŏd",
	"gui.banned.description": "%s\n\n%s\n\nDowiedz się szczegółów z następującego adresu: %s",
	"gui.banned.description.permanent": "Twoje konto zostało permanentnie zablokowane, co oznacza, że nie możesz grać w trybie wieloosobowym ani łączyć się z usługą Realms.",
	"gui.banned.description.reason": "Ostatnio powiadomiono nas o niewłaściwym zachowaniu na Twoim koncie. Nasi moderatorzy sprawdzili Twoje działania i rozpoznali %s. Stanowi to naruszenie Wytycznych Społeczności Minecraft.",
	...
	"gui.banned.description.unknownreason": "Ostatnio powiadomiono nas o niewłaściwym zachowaniu na twoim koncie. Nasi moderatorzy sprawdzili twoje działania i stwierdzili, iż naruszają one Wytyczne Społeczności Minecraft.",
	...
	"gui.cancel": "Pociep",
	"gui.chatReport.comments": "Pole edycji komentarza",
	"gui.chatReport.describe": "Udzielenie szczegółowych informacji pomoże nam podjąć trafną decyzję.",
	"gui.chatReport.discard.content": "Jeżeli opuścisz tę stronę, zgłoszenie zostanie utracone.\nCzy na pewno chcesz kontynuować?",
	"gui.chatReport.discard.discard": "Wyjdź i odrzuć zgłoszenie",
	"gui.chatReport.discard.return": "Kontynuuj edytowanie",
	"gui.chatReport.discard.title": "Odrzucić zgłoszenie?",
	...
	"gui.chatReport.selected_chat": "Wybrano %s wiadomości do zgłoszenia",
	...
	"gui.chatReport.send.no_reported_messages": "Proszę o wybór co najmniej jednej wiadomości do zgłoszenia",
	...
	"gui.chatSelection.fold": "Ukryto %s niepowiązanych wiadomości",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "Gracz %s napisał „%s” o %s",
	"gui.chatSelection.selected": "Liczba wybranych wiadomości: %s/%s",
	"gui.chatSelection.title": "Wybierz wiadomości, które zamierzasz zgłosić",
	"gui.days": "%s dni",
	"gui.done": "Fertich",
	"gui.down": "Dōł",
	...
	"gui.socialInteractions.tooltip.hide": "Ukrywaj wiadomości",
	...
	"gui.socialInteractions.tooltip.show": "Pokaż wiadomości",
	...
	"item.minecraft.acacia_chest_boat": "Agacowy korab ze kastlōm",
	...
	"item.minecraft.dark_oak_chest_boat": "Ćmawodymbowy korab ze kastlōm",
	...
	"item.minecraft.jungle_chest_boat": "Dżunglowy korab ze kastlōm",
	...
	"item.minecraft.oak_chest_boat": "Dymbowy korab ze kastlōm",
	...
	"item.minecraft.spruce_chest_boat": "Smrekowy korab ze kastlōm",
	...
	"multiplayer.disconnect.chat_validation_failed": "Błąd weryfikacji wiadomości na czacie",
	...
	"multiplayer.disconnect.invalid_public_key": "Nie udało się sparsować klucza publicznego profilu.",
	...
	"multiplayer.disconnect.missing_public_key": "Chyba klucza publicznego profilu.\nTyn serwer wymŏgŏ zicher profilōw.",
	...
	"multiplayer.unsecureserver.toast": "Wiadomości wysyłane na tym serwerze mogą być modyfikowane i mogą nie odzwierciedlać ich oryginalnej treści",
	"multiplayer.unsecureserver.toast.title": "Nie można potwierdzić wierzytelności wiadomości na czacie",
	...
	"options.chatPreview": "Podgląd czatu",
	"options.chatPreview.confirm": "Podczas wysyłania",
	"options.chatPreview.live": "Podczas pisania",
	"options.chatPreview.tooltip.confirm": "Jeśli serwer używa podglądu czatu: Podgląd czatu jest generowany tylko podczas próby wysłania wiadomości, która nie ma podglądu lub czeka na podgląd.\nWysłanie wiadomości wymaga potwierdzenia.",
	"options.chatPreview.tooltip.live": "Jeśli serwer korzysta z podglądu czatu: wszelkie modyfikacje wprowadzone do wiadomości czatu przez serwer będą dynamicznie wysyłane do podglądu podczas pisania wiadomości czatu.",
	"options.chatPreview.tooltip.off": "Wszelkie modyfikacje wprowadzone do wiadomości czatu przez serwer nie będą wyświetlane w podglądzie i będą traktowane jako niezabezpieczone.",
	...
	"options.onlyShowSecureChat.tooltip": "Pokazuj jedynie te wiadomości, których wierzytelność można potwiedzić, i które nie zostały zmienione.",
	...
	"selectWorld.backupQuestion.snapshot": "Chcesz zaladōwać tyń śwjot?",
	...
	"subtitles.entity.goat.horn_break": "Cigowy rōg sie słomoł",
	...
	"subtitles.entity.warden.agitated": "Wachmajster stynkŏ gniywnie",
	...
	"title.multiplayer.disabled.banned.permanent": "Twoje konto zostało trwale zawieszone w grze online",
	"title.multiplayer.disabled.banned.temporary": "Twoje konto jest tymczasowo zawieszone w grze online",
