...
var Map = map[string]string{
	...
	"advancements.husbandry.make_a_sign_glow.description": "Освети го текстот на знак",
	...
	"commands.locate.biome.invalid": "Нема биом со тип \"%s\"",
	...
	"gui.back": "Назад",
	"gui.cancel": "Откажи",
	"gui.chatReport.comments": "Место за поправање на коментарите",
