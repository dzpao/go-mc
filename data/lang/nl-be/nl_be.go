...
var Map = map[string]string{
	...
	"chat.tag.not_secure": "Dit bericht is niet beveiligd, dat betekent dat de server deze misschien heeft aangepast",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.content": "Met chatvoorvertoning kan de server uw berichten zien voordat ze worden verzonden naar anderen. Zo kan de server u een voorvertoning laten zien van uw chatberichten met toegepaste wijzigingen en opmaak.\n\nHet gedrag van chatvoorvertoning kan worden aangepast in uw chatinstellingen. De huidige instelling is: [%s]",
	...
	"commands.locate.biome.invalid": "Er is geen klimaatsoort van het type \"%s\"",
	"commands.locate.biome.not_found": "Vinden van klimaatsoort \"%s\" binnen een redelijke afstand mislukt",
	"commands.locate.biome.success": "Dichtste %s bevindt zich op %s (%s blokken afstand)",
	...
	"commands.locate.poi.success": "Dichtste %s bevindt zich op %s (%s blokken afstand)",
	...
	"commands.place.structure.invalid": "Structuur met type '%s' bestaat niet",
	...
	"options.chatPreview.tooltip.confirm": "Indien een server chatvoorvertoningen gebruikt: de voorvertoning wordt pas gegenereerd wanneer u een bericht verzendt waar nog geen voorvertoning voor klaar staat.\nHet verzenden van berichten vereist een bevestiging.",
	"options.chatPreview.tooltip.live": "Indien een server chatvoorvertoningen gebruikt: er wordt dynamisch een voorvertoning gegenereerd terwijl het bericht wordt getypt als de server wijzigingen op uw chatberichten toepast.",
	"options.chatPreview.tooltip.off": "Eventuele wijzigingen die de server op uw chatberichten toepast, worden niet meegenomen in de voorvertoning en worden als onveilig beschouwd.",
