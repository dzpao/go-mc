...
var Map = map[string]string{
	...
	"chatPreview.warning.check": "דו זאלסט נישט אָנזאָגן ווידער פֿאַר דעם סערווער",
	"chatPreview.warning.title": "דער סערווער ניצט טשאַט פּריוויו",
	"chatPreview.warning.toast.title": "שמועסן פּריוויו איז ענייבאַלד",
	...
	"commands.locate.biome.invalid": "עס איז קיין ביאום מיט טיפּ \"%s\"",
	"commands.locate.biome.not_found": "קען נישט געפֿינען א ביאאם פון טיפּ \"%s\" אין א גלייַך ווייַטקייט",
	"commands.locate.biome.success": "די נענסטע געבייד פונעם טיפ %s איז ביי %s (%s בלאקן אוועק)",
	"commands.locate.poi.success": "די נענסטע געבייד פונעם טיפ %s איז ביי %s (%s בלאקן אוועק)",
	...
	"item.minecraft.music_disc_5": "שאלפלאטע",
	...
	"multiplayer.disconnect.invalid_public_key": "ניט געקענט צו פּאַרסירן פּראָפיל עפנטלעך שליסל.",
	...
	"multiplayer.disconnect.missing_public_key": "פעלנדיק פּראָפיל עפנטלעך שליסל.\nדער סערווער ריקווייערז זיכער פּראָופיילז.",
	...
	"options.chatPreview": "שמועסן פאָרויסיקע ווייַזונג",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "פּאפּוגייַ סנארץ",
