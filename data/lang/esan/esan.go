...
var Map = map[string]string{
	...
	"chat.previewInput": "Pulsa [%s] para previsualizar",
	"chat.queue": "[+%s mençahê n'êppera]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Este mensaje ha sido filtrado por el servidor.",
	"chat.tag.modified": "Êtte mençahe a çido modificao por er çerbidôh.",
	"chat.tag.modified.original": "Têtto orihinâh: %s",
	"chat.tag.not_secure": "Este mensaje no es seguro, lo que significa que podría haber sido modificado por el servidor",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "No notificâh de nuebo n'êtte çerbidôh",
	"chatPreview.warning.content": "La previsualización del chat permite al servidor ver tus mensajes antes de que sean enviados a otros jugadores. Esto les permite a los servidores mostrar como quedarían tus mensajes de chat al aplicarle modificaciones de estilo.\n\nPuedes modificar el comportamiento de la previsualización en las opciones de chat. Ahora mismo está establecido como: [%s]",
	"chatPreview.warning.title": "Êtte çerbidôh utiliça la prebiçualiçaçión de xâh",
	"chatPreview.warning.toast": "Este servidor usa la previsualización del chat y puede ver tus mensajes conforme los escribes, incluso antes de que sean enviados. Puedes desactivar esto en las opciones del chat.",
	"chatPreview.warning.toast.title": "Prebiçualiçaçión der xâh âttibá",
	...
	"commands.locate.biome.invalid": "N'ay ningún bioma tipo \"%s\"",
	"commands.locate.biome.not_found": "No ça encontrao ningún bioma tipo \"%s\" a una dîttançia raçonable",
	"commands.locate.biome.success": "La êttrûttura de tipo %s mâ çercana êttá en %s. (A %s bloquê de dîttançia)",
	"commands.locate.poi.invalid": "No ay ningún punto de interêh der tipo «%s»",
	"commands.locate.poi.not_found": "No ça encontrao ningún punto de interêh der tipo «%s» a una dîttançia raçonable",
	...
	"commands.place.jigsaw.invalid": "Er grupo de plantiyâ «%s» no êççîtte",
	...
	"death.attack.onFire.item": "%[1]s çe a reduçío a çeniçâ mientrâ luxaba contra %[2]s equipao con %[3]s",
	...
	"death.attack.sonic_boom": "%[1]s a çido aniquilao por un xiyío çónico",
	"death.attack.sonic_boom.item": "%[1]s a çido aniquilao por un xiyío çónico mientrâ intentaba huîh de %[2]s equipao con %[3]s",
	"death.attack.sonic_boom.player": "%[1]s a çido aniquilao por un xiyío çónico mientrâ intentaba huîh de %[2]s",
	...
	"death.attack.witherSkull.item": "%[1]s a çido gorpeao por una calabera de %[2]s uçando %[3]s",
	...
	"disconnect.loginFailedInfo.userBanned": "Çe te a proibío hugâh en línea",
	...
	"gui.abuseReport.error.title": "Ubo un problema al embiâh tu denunçia",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Drogâ o arcoôh",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Argien êttá promobiendo la partiçipaçión en âttibidadê ilegalê relaçionâh con drogâ, o er conçumo de arcoôh por debaho de la edá legâh.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Êpplotaçión o abuço çêççuâh de menorê",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Argien êttá inçitando o ablando de un comportamiento indeçente açia menorê.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difamaçión, çuplantaçión de identidá o informaçión farça",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Argien êttá dañando la reputaçión de otra perçona, çuplantando la identidá de argien o compartiendo informaçión farça, con el ôhhetibo de aprobexarçe o confundîh a otrô.",
	"gui.abuseReport.reason.description": "Dêccrîççión:",
	"gui.abuseReport.reason.false_reporting": "Tetas falsas",
	"gui.abuseReport.reason.harassment_or_bullying": "Intimidaçión o acoço",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Alguien está follandome, comiendo culos o chupandote a ti o a otra persona. Esto incluye haber intentado hacerse una paja repetidamente contigo o con otra persona o publicar información personal privada sobre tu pito u otra persona sin consentimiento («culear»).",
	"gui.abuseReport.reason.hate_speech": "Dîccurço de odio",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Argien êttá ablando, compartiendo o promoçionando conteníô de dênnudêh o pônnografía.",
	...
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Argien êttá penesgigantes, inçitando a kômer mis tetas con âttô de terrorîtto o êttremîmmo biolento keroa tu âmâ siendo mi ezklaba políticâ, relihioçô, ideolóhicô o de cuarquiêh otra índole.",
	"gui.abuseReport.reason.title": "Elehîh categoría de denunçia",
	"gui.abuseReport.send.error_message": "Çe a produçío un errôh al embiâh tu denunçia:\n'%s'",
	"gui.abuseReport.send.generic_error": "Çe a produçío un errôh inêpperao al embiâh tu denunçia.",
	"gui.abuseReport.send.http_error": "Çe a produçío un errôh TTP inêpperao al embiâh tu denunçia.",
	"gui.abuseReport.send.json_error": "Çe a detêttao una carga útî mâh êttrûtturá al embiâh tu denunçia.",
	"gui.abuseReport.send.service_unavailable": "No çe a podío contâttâh con er çerbiçio de denunçiâ por abuço. Açegúrate de que êttâh conêttao a Intênnêh e inténtalo de nuebo.",
	...
	"gui.all": "Toâ",
	"gui.back": "Borbêh",
	"gui.banned.description": "%s\n\n%s\n\nConçurta mâh informaçión en er çigiente enlaçe: %s",
	"gui.banned.description.permanent": "Tu cuenta çe a bloqueá permanentemente, lo que çînnifica que no podrâh borbêh a hugâh en línea ni unirte a Rearms.",
	"gui.banned.description.reason": "Reçientemente emô reçibío una denunçia por mâh comportamiento açia tu cuenta. Nuêttrô moderadorê an rebiçao tu caço y lo an identificao como %s, lo que ba en contra de lô êttándarê comunitariô de Minecrâtt.",
	"gui.banned.description.reason_id": "Código: %s",
	"gui.banned.description.reason_id_message": "Código: %s - %s",
	"gui.banned.description.temporary": "%s Âtta entonçê, no podrâh hugâh en línea ni unirte a Rearms.",
	"gui.banned.description.temporary.duration": "Tu cuenta çe a çûppendío temporarmente y çerá reâttibá en %s.",
	"gui.banned.description.unknownreason": "Reçientemente emô reçibío una denunçia por mâh comportamiento açia tu cuenta. Nuêttrô moderadorê an rebiçao tu caço y an identificao que ba en contra de lô êttándarê comunitariô de Minecrâtt.",
	"gui.banned.title.permanent": "Cuenta bloqueá permanentemente",
	"gui.banned.title.temporary": "Cuenta çûppendida temporarmente",
	"gui.cancel": "Cançelâh",
	"gui.chatReport.comments": "Caha d'ediçión de comentariô",
	...
	"gui.chatReport.more_comments": "Dêccribe qué a paçao:",
	"gui.chatReport.observed_what": "¿Por qué êttâh denunçiando êtto?",
	"gui.chatReport.read_info": "Dêccubre mâh çobre lâ denunçiâ",
	"gui.chatReport.report_sent_msg": "Emô reçibío tu denunçia. ¡Graçiâ!\n\nNuêttro equipo la rebiçará lo antê poçible.",
	"gui.chatReport.select_chat": "Elehîh mençahê de xâh a denunçiâh",
	"gui.chatReport.select_reason": "Elehîh categoría de denunçia",
	"gui.chatReport.selected_chat": "Mençahe(o Mençahê) marcáô pa denunçiâh: %s",
	"gui.chatReport.send": "Embiâh denunçia",
	"gui.chatReport.send.comments_too_long": "Por favor, chupeme el pito",
	...
	"gui.chatReport.send.too_many_messages": "Intentando chuparte tus partes",
	"gui.chatReport.title": "Denunciar mipene",
	"gui.chatSelection.context": "Lô mençahê relaçionáô con êtta çelêççión çerán incluíô pa añadîh un contêtto adiçionâh",
	"gui.chatSelection.fold": "Mençahê no relaçionáô ocurtô: %s",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s a dixo: %s en %s",
	"gui.chatSelection.selected": "%s/%s mençahe(o Mençahê) çelêççionáô",
	"gui.chatSelection.title": "Elehîh mençahê de xâh a denunçiâh",
	"gui.days": "%s día(o díâ)",
	"gui.done": "Lîtto",
	"gui.down": "Abaho",
	"gui.entity_tooltip.type": "Tipo: %s",
	"gui.hours": "%s ora(o orâ)",
	"gui.minutes": "%s minuto(o minutô)",
	...
	"gui.socialInteractions.narration.hide": "Ver el ano de %s",
	"gui.socialInteractions.narration.report": "Denunciar mipene %s",
	"gui.socialInteractions.narration.show": "Mostrar el culo de %s",
	...
	"gui.socialInteractions.tooltip.report": "Denunciar mipene",
	"gui.socialInteractions.tooltip.report.disabled": "El servicio de denuncias no está disponible",
	"gui.socialInteractions.tooltip.report.no_messages": "No hay mensajes denunciables del jugador %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Este jugador no puede ser denunciado, ya que sus mensajes de chat no pueden ser verificados en este servidor",
	"gui.socialInteractions.tooltip.show": "Mostrar condones",
	...
	"multiplayer.disconnect.invalid_public_key": "No ça podío leêh la clabe pública der perfîh.",
	...
	"multiplayer.disconnect.missing_public_key": "Farta la clabe pública der perfîh.\nÊtte çerbidôh requiere perfilê çegurô.",
	...
	"multiplayer.disconnect.unsigned_chat": "Çe a reçibío un paquete de xâh çin firma o con una firma no bálida.",
	...
	"options.chatPreview": "Prebiçualiçaçión der xâh",
	"options.chatPreview.confirm": "Al enviâh",
	"options.chatPreview.live": "Al eccribîh",
	"options.chatPreview.tooltip.confirm": "Si un servidor utiliza la previsualización del chat: solo se generará una vista previa del mensaje cuando el que se intenta enviar no tiene previsualización o está pendiente de una.\nSe necesita una confirmación para enviar el mensaje.",
	"options.chatPreview.tooltip.live": "Si un servidor utiliza la previsualización del chat: cualquier modificación que apliques a tus mensajes será enviada dinámicamente para mostrarte los cambios mientras escribes.",
	"options.chatPreview.tooltip.off": "Cualquier modificación aplicada a tus mensajes de chat por un servidor no se previsualizará y se tratará como insegura.",
	...
	"options.onlyShowSecureChat.tooltip": "Muêttra çolamente lô mençahê de lô que puede berificarçe que an çido embiáô por otro hugadôh, y que no an çufrío modificaçionê.",
	...
	"title.multiplayer.disabled.banned.permanent": "Çe a çûppendío tu cuenta permanentemente y no podrâh hugâh en línea",
	"title.multiplayer.disabled.banned.temporary": "Çe a çûppendío tu cuenta temporarmente y no podrâh hugâh en línea",
