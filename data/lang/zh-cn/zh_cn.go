...
var Map = map[string]string{
	...
	"advancements.husbandry.safely_harvest_honey.description": "利用营火在不惊动蜜蜂的情况下从蜂箱收集蜂蜜",
	...
	"advancements.husbandry.tadpole_in_a_bucket.description": "用桶捕获一只蝌蚪",
	...
	"chat.editBox": "聊天",
	"chat.filtered_full": "服务器向部分玩家隐藏了你的消息。",
	...
	"chat.previewInput": "按[%s]预览",
	"chat.queue": "[+%s行待发送]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "此消息已被服务器过滤。",
	"chat.tag.modified": "此消息已被服务器更改。",
	"chat.tag.modified.original": "原始文本：%s",
	"chat.tag.not_secure": "此消息不安全，即可能被服务器修改过",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "不要在此服务器上再次通知",
	"chatPreview.warning.content": "聊天预览可以让服务器在你的消息被发送给其他玩家之前查看这些消息。该功能可以让服务器向客户端发送应用过样式和被服务器修改后的聊天消息的预览。\n\n聊天预览功能的行为可以在聊天设置中更改。当前设置为：[%s]",
	"chatPreview.warning.title": "此服务器使用了聊天预览",
	"chatPreview.warning.toast": "此服务器使用了聊天预览，能查看你未发送的消息。聊天设置中可关闭此功能。",
	...
	"commands.item.target.no_changed.known_item": "没有在%[2]s槽位接受了物品%[1]s的目标",
	"commands.item.target.no_changes": "没有在%s槽位接受了物品的目标",
	"commands.item.target.no_such_slot": "目标没有%s槽位",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "诽谤、冒充他人或散布虚假信息",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "有人以利用或误导他人为目的，损害他人名誉、冒充他人或散布虚假信息。",
	...
	"gui.abuseReport.reason.imminent_harm": "即将发生的伤害行为 — 威胁伤害他人",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "即将发生的伤害行为 — 自残或自杀",
	...
	"gui.banned.description.permanent": "你的账户已被永久封禁，无法进行多人游戏或加入Realms。",
	...
	"gui.banned.description.temporary": "%s期限结束前，你无法进行多人游戏或加入Realms。",
	...
	"gui.chatReport.discard.title": "放弃举报和留言？",
	...
	"gui.chatReport.selected_chat": "已选择%s条要举报的聊天消息",
	...
	"gui.chatReport.title": "举报玩家",
	"gui.chatSelection.context": "所选消息前后的部分消息将会用于提供额外的辅助信息",
	"gui.chatSelection.fold": "已隐藏%s条无关消息",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "无法举报该玩家，其聊天消息无法被此服务器验证。",
	...
	"multiplayer.disconnect.invalid_public_key": "无法解析个人信息公钥。",
	...
	"multiplayer.disconnect.missing_public_key": "缺少个人信息公钥。\n这个服务器需要安全的个人信息。",
	...
	"options.chatPreview.tooltip.off": "服务器对你的聊天消息进行的所有修改将不会被预览，且会被标记为不安全。",
	"options.chunks": "%s个区块",
