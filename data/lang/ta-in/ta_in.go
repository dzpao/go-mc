...
var Map = map[string]string{
	...
	"chat.previewInput": "முன்னோட்டத்திற்கு [%s] ஐ அழுத்தவும்",
	"chat.queue": "[+%s நிலுவை வரிகள்]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "இந்த செய்தி சேவையகத்தால் மாற்றப்பட்டது.",
	"chat.tag.modified.original": "அசல் உரை: %s",
	"chat.tag.not_secure": "இந்தச் செய்தி பாதுகாப்பானது அல்ல, அதாவது இது சர்வரால் மாற்றப்பட்டிருக்கலாம்",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "இந்த சேவையகத்திற்கு மீண்டும் அறிவிக்க வேண்டாம்",
	"chatPreview.warning.content": "அரட்டை முன்னோட்டம் உங்கள் செய்திகளை மற்ற பிளேயர்களுக்கு அனுப்பும் முன் பார்க்க சர்வரை அனுமதிக்கிறது. தனிப்பயன் மாற்றங்கள் மற்றும் பயன்படுத்தப்பட்ட ஸ்டைலிங் மூலம் உங்கள் அரட்டை செய்திகளின் மாதிரிக்காட்சியை உங்களுக்கு அனுப்ப இது சேவையகத்தை அனுமதிக்கிறது.\n\nஉங்கள் அரட்டை அமைப்புகளில் அரட்டை முன்னோட்ட நடத்தையை மாற்றலாம். தற்போதைய அமைப்பு: [%s]",
	"chatPreview.warning.title": "இந்தச் சேவையகம் அரட்டை மாதிரிக்காட்சியைப் பயன்படுத்துகிறது",
	"chatPreview.warning.toast.title": "அரட்டை மாதிரிக்காட்சி இயக்கப்பட்டது",
	...
	"commands.locate.biome.invalid": "\"%s\" வகையுடன் எந்த பயோமும் இல்லை",
	"commands.locate.biome.not_found": "நியாயமான தூரத்திற்குள் \"%s\" வகையின் பயோமைக் கண்டுபிடிக்க முடியவில்லை",
	"commands.locate.biome.success": "அருகில் %s உள்ளது %s (%s தொகுதிகள் விலகி)",
	"commands.locate.poi.success": "அருகில் %s உள்ளது %s (%s தொகுதிகள் விலகி)",
	...
	"commands.place.structure.invalid": "\"%s\" வகைக் கட்டமைப்பு ஏதுமில்லை",
	...
	"gui.abuseReport.reason.title": "அறிக்கை வகையைத் தேர்ந்தெடுக்கவும்",
	...
	"gui.cancel": "ரத்து",
	"gui.chatReport.comments": "கருத்துகள் திருத்த பெட்டி",
	...
	"gui.chatSelection.fold": "%s தொடர்பில்லாத செய்திகள் மறைக்கப்பட்டுள்ளன",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s கூறினார்: %s இல் %s",
	"gui.chatSelection.selected": "%s/%s செய்தி(கள்) தேர்ந்தெடுக்கப்பட்டன",
	"gui.chatSelection.title": "புகாரளிக்க அரட்டை செய்திகளைத் தேர்ந்தெடுக்கவும்",
	"gui.days": "%s நாள்(கள்)",
	"gui.done": "முடிந்தது",
	"gui.down": "கீழ்",
	...
	"item.minecraft.music_disc_5": "இசை டிஸ்க்",
	...
	"multiplayer.disconnect.invalid_public_key": "Der சுயவிவரத்தின் பொது விசையைப் பாகுபடுத்த முடியாது.",
	...
	"multiplayer.disconnect.missing_public_key": "சுயவிவர பொது விசை இல்லை. இந்தச் சேவையகத்திற்கு பாதுகாப்பான சுயவிவரங்கள் தேவை.",
	...
	"options.chatPreview": "அரட்டை முன்னோட்டம்",
	"options.chatPreview.tooltip.confirm": "சேவையகம் அரட்டை மாதிரிக்காட்சிகளைப் பயன்படுத்தினால்: முன்னோட்டம் இல்லாத அல்லது முன்னோட்டத்திற்காகக் காத்திருக்கும் செய்தியை அனுப்ப முயற்சிக்கும்போது மட்டுமே அரட்டை மாதிரிக்காட்சி உருவாக்கப்படும்.\nசெய்தியை அனுப்ப உறுதிப்படுத்தல் தேவை.",
	"options.chatPreview.tooltip.live": "சேவையகம் அரட்டை மாதிரிக்காட்சிகளைப் பயன்படுத்தினால்: அரட்டைச் செய்தி தட்டச்சு செய்யப்படும்போது, சேவையகம்மூலம் உங்கள் அரட்டைச் செய்திகளுக்குப் பயன்படுத்தப்படும் மாற்றங்கள் மாறும் வகையில் அனுப்பப்படும்.",
	"options.chatPreview.tooltip.off": "சேவையகம் மூலம் உங்கள் அரட்டை செய்திகளுக்குப் பயன்படுத்தப்படும் எந்த மாற்றங்களும் முன்னோட்டமிடப்படாது மேலும் பாதுகாப்பற்றதாகக் கருதப்படும்.",
