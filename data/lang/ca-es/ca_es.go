...
var Map = map[string]string{
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fer que un Allay tiri un pastis a un bloc musical",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Aniversari feliç",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Fer que un Allay lliuri objectes",
	...
	"argument.enum.invalid": "El valor \"%s\", és invalid",
	...
	"chat.disabled.profile": "Xat deshabilitat des de la configuració del compte. Premeu «%s» un altre cop per a més informació",
	...
	"chat.previewInput": "Pressiona [%s] per previsualitzar",
	"chat.queue": "[+%s línies pendents]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "Aquest missatge ha estat modificat pel servidor.",
	"chat.tag.modified.original": "Text original: %s",
	"chat.tag.not_secure": "Aquest missatge no és segur, el que significa que pot haver-hi set modificat pel servidor",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "No torneu a notificar aquest servidor",
	"chatPreview.warning.content": "Previsualització del Xat permet que el servidor miri els teus missatges abans que siguin enviats a altres jugadors. Això permet que el servidor t'enviï una previsualització dels teus missatges del xat amb modificacions personalitzades i estil aplicats.\n\nEl comportament de Previsualització del Xat pot ser canviada als Ajustos del Xat. La opció actual hi es: [%s]",
	"chatPreview.warning.title": "Aquest servidor utilitza la vista prèvia del xat",
	"chatPreview.warning.toast.title": "La vista prèvia del xat està activada",
	...
	"commands.locate.biome.invalid": "No hi ha cap bioma de tipus \"%s\"",
	"commands.locate.biome.not_found": "No hi ha cap bioma de tipus \"%s\" a una distància raonable",
	"commands.locate.biome.success": "L'estructura de tipus %s més propera està a %s. (A %s blocs de distància)",
	"commands.locate.poi.invalid": "No hi ha cap punt d'interès amb el tipus\"%s\"",
	"commands.locate.poi.not_found": "No s'ha trobat un bioma de tipus %s a una distància raonable",
	"commands.locate.poi.success": "L'estructura de tipus %s més propera està a %s. (A %s blocs de distància)",
	...
	"commands.place.jigsaw.invalid": "El grup de plantilles\"%s\" no existeix",
	"commands.place.jigsaw.success": "Peça generada a %s, %s, %s",
	"commands.place.structure.failed": "Error en generar l'estructura",
	...
	"commands.place.template.invalid": "No hi ha cap plantilla amb la id \"%s\"",
	...
	"death.attack.sting.item": "%[1]s ha mort per una picada de %[2]s utilitzant %[3]s",
	...
	"death.attack.witherSkull.item": "%[1]s Ha rebut un tret per una calavera de %[2]s amb %[3]s",
	...
	"disconnect.loginFailedInfo.userBanned": "Estas banejat del multijugador",
	...
	"gui.abuseReport.error.title": "Problema en enviar el vostre informe",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Algú està parlant o promovent un comportament indecent que implica infants.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difamació, suplantació d'identitat o informació falsa",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Algú fa malbé la reputació d'una altra persona, suplantant la identitat d'algú o compartint informació falsa.",
	"gui.abuseReport.reason.description": "Descripció:",
	"gui.abuseReport.reason.false_reporting": "Informació falsa",
	"gui.abuseReport.reason.harassment_or_bullying": "Assetjament",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Algú t'està humiliant, atacant o assetjant a tu o a algú mes. Això inclou quan algú intenta contactar amb tu repetidament o algú mes sense consentiment o publica informació personal privada teva o d'algú mes sense consentiment (\"doxseig\").",
	"gui.abuseReport.reason.hate_speech": "Discurs d'odi",
	"gui.abuseReport.reason.hate_speech.description": "Algú us està atacant o a un altre jugador basant-se en característiques de la seva identitat, com la religió, la raça o la sexualitat.",
	"gui.abuseReport.reason.imminent_harm": "Dany imminent - Amenaça de ferir als altres",
	"gui.abuseReport.reason.imminent_harm.description": "Algú t'hi està amenaçant de fer-te mal a tu o una altra persona a la vida real.",
	"gui.abuseReport.reason.narration": "%s: %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Imatges íntimes no consentides",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Algú està demanant, compartint o incitant el trànsit d'imatges privades i íntimes.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Perill imminent: Autolesió o suïcidi",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Algú està amenaçant o parlant de fer-se mal a ell mateix a la vida real.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorisme o extremisme violent",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Algú hi està parlant sobre, promovent, o amenaçant de cometre actes de terrorisme o violència extrema de temes polítics, religiosos, ideològics, o altres motius.",
	"gui.abuseReport.reason.title": "Tria una categoria d'informe",
	"gui.abuseReport.send.error_message": "S'ha trobat un error en enviar el vostre informe:\n'%s'",
	"gui.abuseReport.send.generic_error": "S'ha produït un error inesperat en enviar el vostre report.",
	"gui.abuseReport.send.http_error": "S'ha produït un error HTTP inesperat en enviar la teva denúncia.",
	"gui.abuseReport.send.json_error": "S'ha detectat una càrrega útil mal estructurada en enviar la teva denúncia.",
	"gui.abuseReport.send.service_unavailable": "No hem pogut contactar amb el servei de denúncies per abús. Assegureu-vos que esteu connectats a Internet i torneu-ho a provar.",
	"gui.abuseReport.sending.title": "S'està enviant el teu informe...",
	"gui.abuseReport.sent.title": "Informe enviat",
	"gui.acknowledge": "Entesos",
	"gui.advancements": "Avenços",
	"gui.all": "Totes",
	"gui.back": "Torna",
	"gui.banned.description": "%s\n\n%s\n\nAprèn més al següent enllaç: %s",
	"gui.banned.description.permanent": "El teu compte s'ha banejat permanentment, això vol dir que no podràs jugar en línia o unir-te a Realms.",
	"gui.banned.description.reason": "Recentment hem rebut un informe de mal comportament del teu compte. Els nostres moderadors han revisat el vostre cas i l'han identificat com a %s, cosa que va en contra de la normativa de la comunitat de Minecraft.",
	...
	"gui.banned.description.unknownreason": "Recentment hem rebut un informe de mal comportament del vostre compte. Els nostres moderadors han revisat el vostre cas i han identificat que va en contra de les normes de la comunitat de Minecraft.",
	"gui.banned.title.permanent": "Compte permanentment suspès",
	"gui.banned.title.temporary": "Compte suspès temporalment",
	"gui.cancel": "Cancel·la",
	"gui.chatReport.comments": "Caixa d'edició de comentaris",
	"gui.chatReport.describe": "Compartir detalls ens ajudarà a prendre una decisió adequada.",
	"gui.chatReport.discard.content": "Si sortiu ara, s'esborrarà aquest informe i els vostres comentaris.\nEsteu segurs que voleu sortir?",
	"gui.chatReport.discard.discard": "Sortir i descartar l'informe",
	"gui.chatReport.discard.return": "Segueix Editant",
	"gui.chatReport.discard.title": "Descartar l'informe i els comentaris?",
	"gui.chatReport.more_comments": "Si us plau, descriviu què ha passat:",
	"gui.chatReport.observed_what": "Per què estàs denunciant això?",
	"gui.chatReport.read_info": "Descobreix més sobre els informes",
	...
	"gui.chatReport.select_chat": "Selecciona els missatges del xat per a informar",
	"gui.chatReport.select_reason": "Seleccioni una categoria d'informe",
	"gui.chatReport.selected_chat": "%s missatge(s) marcat(s) per a informar",
	"gui.chatReport.send": "Enviar Informe",
	"gui.chatReport.send.comments_too_long": "Si us plau, sigui més breu",
	"gui.chatReport.send.no_reason": "Si us plau, seleccioni una categoria per a informar",
	"gui.chatReport.send.no_reported_messages": "Si us plau, seleccioni almenys un missatge del xat per a informar-ho",
	"gui.chatReport.send.too_many_messages": "Intentar incloure massa missatges a l'informe",
	"gui.chatReport.title": "Informar d'un jugador",
	"gui.chatSelection.context": "Els missatges relacionats amb aquesta selecció s'inclouran per proporcionar context addicional",
	"gui.chatSelection.fold": "%s missatges sense relació amagats",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s ha dit: %s a les %s",
	"gui.chatSelection.selected": "Missatge(s) seleccionats: %s/%s",
	"gui.chatSelection.title": "Triar missatges de xat a reportar",
	"gui.days": "%s Dia(s)",
	"gui.done": "Fet",
	"gui.down": "Avall",
	...
	"gui.socialInteractions.narration.hide": "Amagar missatges de %s",
	"gui.socialInteractions.narration.report": "Informar de jugador %s",
	...
	"gui.socialInteractions.tooltip.hide": "Ocultar missatges",
	"gui.socialInteractions.tooltip.report": "Informar sobre el jugador",
	"gui.socialInteractions.tooltip.show": "Mostrar missatges",
	...
	"instrument.minecraft.call_goat_horn": "Trucar",
	...
	"menu.playerReporting": "Informar d'un jugador",
	...
	"multiplayer.disconnect.chat_validation_failed": "Verificació del missatge del xat fallida",
	...
	"multiplayer.disconnect.invalid_public_key": "No s'ha pogut llegir la clau pública del perfil.",
	"multiplayer.disconnect.invalid_public_key_signature": "Signatura per a la clau de perfil pública no vàlida. Si us plau, intenti reiniciar el joc.",
	...
	"multiplayer.disconnect.missing_public_key": "Clau pública del perfil absent.\nAquest servidor requereix perfils segurs.",
	...
	"multiplayer.disconnect.out_of_order_chat": "S'ha rebut un paquet de xat fora de comanda. Ha canviat l'hora del vostre sistema?",
	...
	"multiplayer.disconnect.unsigned_chat": "S'ha rebut un paquet de xat amb una signatura que falta o no és vàlida.",
	...
	"multiplayer.unsecureserver.toast": "Els missatges enviats en aquest servidor poden ser modificats i no reflectir el missatge original",
	...
	"options.chatPreview": "Vista prèvia del xat",
	"options.chatPreview.confirm": "Mentre Envies",
	"options.chatPreview.live": "Mentre Escrius",
	"options.chatPreview.tooltip.confirm": "Si un servidor utilitza Previsualitzacions dels Xats: Una previsualització del xat només es generarà quan intentis enviar un missatge que no tingui previsualització o hi està esperant una previsualització.\nEnviar el missatge requereix confirmació.",
	"options.chatPreview.tooltip.live": "Si un servidor utilitza Previsualitzacions dels Xats: Qualsevol modificació utilitzada al teu missatge del xat per un servidor hi serà dinàmicament enviada per previsualitzar mentre el missatge és escrit.",
	"options.chatPreview.tooltip.off": "Qualsevol modificació aplicada als teus missatges del xat per un servidor no seran previsualitzades i es tractarà com insegur.",
	...
	"options.fovEffectScale.tooltip": "Controlar la magnitud de la variació del camp de visió en aplicar-se aquests efectes del joc.",
	...
	"options.onlyShowSecureChat": "Mostrar només missatges segurs",
	"options.onlyShowSecureChat.tooltip": "Mostra només missatges d'altres jugadors que es pugui verificar que han estat enviats per aquest jugador i que no s'han modificat.",
	...
	"subtitles.block.sculk.spread": "Sculk es reprodueix",
	...
	"title.multiplayer.disabled.banned.permanent": "El teu compte esta suspes permanentment del multijugador",
	"title.multiplayer.disabled.banned.temporary": "El teu compte esta suspes temporalment del multijugador",
