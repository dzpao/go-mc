...
var Map = map[string]string{
	...
	"advMode.randomPlayer": "Очраклы уенчы күрсәтү очен, «@r» кулланыгыз",
	...
	"advancements.adventure.avoid_vibration.title": "УЛ ТУГЫЗ МЕҢНӘН АРТЫЫЫК!",
	...
	"advancements.adventure.fall_from_world_height.description": "Дөньяның иң югары ноктасыннан (биеклек чигеннән) иң түбән ноктасына исән калып сикерегез",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Скалк катализаторы янында мобны үтерде",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Ул һәркайда... УЛ ҺӘРҖИРДӘ!",
	...
	"advancements.adventure.trade_at_world_height.title": "Йолдызлы сәүдәгәр",
	...
	"advancements.husbandry.netherite_hoe.description": "Китмәнне яңартырга незерит кулланыгыз да тормыш юлыгызны яңадан карагыз",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Бал бал кортыларын ачуландырмыйча, учак ярдәмендә балны шешәгә җыеп алыгыз",
	...
	"advancements.husbandry.tadpole_in_a_bucket.title": "Баккит-баккит",
	...
	"block.minecraft.banner.base.cyan": "Тулысынча фирәзә тукыма",
	...
	"block.minecraft.mangrove_propagule": "Мангр сап",
	...
	"block.minecraft.potted_mangrove_propagule": "Утыртылган мангр сап",
	...
	"block.minecraft.sculk_shrieker": "Кычкыручан скалк",
	...
	"block.minecraft.stripped_mangrove_wood": "Шәрә мангр",
	...
	"chat.disabled.profile.moreInfo": "Чат аккаунт көйләве белән сүнек. Хатны җибәреп яки карап булмый.",
	"chat.editBox": "чат",
	...
	"chat.previewInput": "Карар өчен [%s] басыгыз",
	"chat.queue": "[+%s юл чиратта]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified.original": "Оригиналь текст: %s",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Бу сервер өчен бүтән күрсәтмәскә",
	"chatPreview.warning.title": "Бу серверда чат алдан карау бар",
	"chatPreview.warning.toast.title": "Чатның алдан карау кукушылган",
	...
	"commands.item.block.set.success": "Әйбер блок оячыкта %s, %s, %s, %s алыштырылды",
	"commands.item.entity.set.success.multiple": "Әйбер %s асыл оячыкта %s алыштырылды",
	"commands.item.entity.set.success.single": "Әйбер %s оячыкта, %s алыштырылды",
	...
	"commands.locate.biome.invalid": "«%s» дигән биом юк",
	...
	"commands.locate.poi.invalid": "«%s» дигән кызыксыну ноктасы юк",
	...
	"commands.place.feature.invalid": "«%s» объект юк",
	"commands.place.feature.success": "«%s», %s, %s, %s урынына урнатылды",
	...
	"commands.place.template.failed": "Үрнәк урнатылып булмады",
	"commands.place.template.invalid": "%s белән шаблон юк",
	"commands.place.template.success": "%[2]s, %[3]s, %[4]s ноктасында «%[1]s» үрнәге урнатылды",
	...
	"commands.setblock.success": "Блок %s, %s, %s ноктата үзгәртелде",
	...
	"death.attack.sonic_boom": "%[1]s тавыш кычкыруы белән чистарды",
	"death.attack.sonic_boom.item": "%[3]s кулланган %[2]s яныннан качып, %[1]s тавыш кычкыруы белән чистарды",
	"death.attack.sonic_boom.player": "%[2]s яныннан качып, %[1]s тавыш кычкыруы белән чистарды",
	...
	"debug.inspect.client.block": "Блокның клиент мәгълүматлары алмашу буферына күчереп алды",
	...
	"debug.inspect.server.block": "Блокның сервер мәгълүматлары алмашу буферына күчереп алды",
	...
	"flat_world_preset.minecraft.tunnelers_dream": "Җәннәткә кешеләр туннелеры",
	...
	"generator.minecraft.amplified.info": "Искәрмә: кызык өчен генә! Яхшы компьютер кирәк.",
	...
	"gui.abuseReport.send.json_error": "Шикаятьне җибәргәндә хата булды.",
	...
	"item.minecraft.allay_spawn_egg": "Тынычлаучы чакыру йомыркасы",
	...
	"multiplayer.disconnect.invalid_public_key": "Профильнең ачык ачкычын билгелеп булмады.",
	...
	"multiplayer.disconnect.missing_public_key": "Профильнең ачык ачкычы юк. Бу сервер куркынычсыз профильләр таләп итә.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Чат пакетларының чиратлылык бозылды. Системалы вакыт үзгәрдеме?",
	...
	"options.allowServerListing": "Исемлекләрдә күрсәтү",
	...
	"options.chatPreview": "Алдан карау",
	...
	"options.darknessEffectScale.tooltip": "Сакчыдан һәм кычкыручан скалкдан алына торган караңгылык тәэсире никадәр үзгәртә алуы өчен җавап бирә.",
	...
	"options.hideLightningFlashes": "Яшен чаткыларын сүндерү",
	...
	"options.simulationDistance": "Симуляция арасы",
	...
	"selectWorld.backupEraseCache": "Кэшны чистарту",
	...
	"selectWorld.edit.openFolder": "Дөнья папкасын ачу",
	...
	"subtitles.block.sculk_shrieker.shriek": "Кыркуачан скалк кычкыра",
	...
	"subtitles.entity.allay.ambient_with_item": "Тынычлаучы эзли",
	"subtitles.entity.allay.ambient_without_item": "Тынычлаучы тынычсызлана",
	"subtitles.entity.allay.death": "Тынычлаучы үлә",
	"subtitles.entity.allay.hurt": "Тынычлаучы яраланды",
	"subtitles.entity.allay.item_given": "Тынычлаучы көлә",
	"subtitles.entity.allay.item_taken": "Тынычлаучы тынычланды",
	"subtitles.entity.allay.item_thrown": "Тынычлаучы ташлый",
	...
	"subtitles.entity.frog.ambient": "Бака бакыла",
