...
var Map = map[string]string{
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "पाउडर बर्फ पर चलो... इसमें डूबे बिना",
	...
	"block.minecraft.lapis_block": "लापीस लाजुली का ब्लॉक",
	...
	"block.minecraft.potted_azalea_bush": "कमरों का अज़ेलिया",
	...
	"block.minecraft.powder_snow_cauldron": "चूर्ण बर्फ की कड़ाही",
	...
	"chat.disabled.launcher": "लॉन्चर विकल्प द्वारा अक्षम चैट। संदेश नहीं भेज सकता",
	"chat.disabled.options": "क्लाइंट के विकल्पों में चैट अक्षम कर दी गई है",
	"chat.disabled.profile": "खाता सेटिंग द्वारा चैट की अनुमति नहीं है। अधिक जानकारी के लिए फिर से '%s' दबाएँ",
	...
	"chat.previewInput": "पूर्व दर्शन करने के लिए [%s] दबाएँ",
	"chat.queue": "[+%s विचाराधीन पंक्तियाँ]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "यह संदेश सर्वर द्वारा संशोधित किया गया है.",
	"chat.tag.modified.original": "मूल लेख: %s",
	"chat.tag.not_secure": "यह संदेश सुरक्षित नहीं है, जिसका अर्थ है कि इसे सर्वर द्वारा संशोधित किया गया हो सकता है",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "इस सर्वर के लिए फिर से सूचित न करें|",
	"chatPreview.warning.content": "चैट पूर्वावलोकन सर्वर को अन्य खिलाड़ियों को भेजे जाने से पहले आपके संदेशों को देखने की अनुमति देता है। यह एक सर्वर को कस्टम संशोधनों और लागू स्टाइल के साथ आपको आपके चैट संदेशों का पूर्वावलोकन भेजने की अनुमति देता है।\nचैट पूर्वावलोकन व्\u200dयवहार के चैट सेटिंग्स मे बदल सकते है । वर्तमान सेटिंग्स है: [%s]",
	"chatPreview.warning.title": "यह सर्वर चैट पूर्वावलोकन का उपयोग करता है|",
	"chatPreview.warning.toast.title": "चैट पूर्वावलोकन सक्षम है ",
	...
	"commands.locate.biome.invalid": "\"%s\" प्रकार का जैवक्षेत्र नहीं है",
	"commands.locate.biome.not_found": "उचित दूरी के अंदर \"%s\" प्रकार का जैवक्षेत्र नहीं मिल पाया",
	"commands.locate.biome.success": "नजदीक वाले %s %s पर है (%s प्रखंडो दूरी)",
	"commands.locate.poi.invalid": "\"%s\" प्रकार का कोई रूचिकर स्थान नहीं है",
	"commands.locate.poi.not_found": "उचित दूरी के भीतर \"%s\" प्रकार का कोई रुचिकर स्थान नहीं मिला",
	"commands.locate.poi.success": "नजदीक वाले %s %s पर है (%s प्रखंडो दूरी)",
	...
	"commands.place.structure.invalid": "\"%s\" प्रकार की कोई संरचना नहीं है",
	...
	"createWorld.customize.custom.spread": "हाइट को फैलाना",
	...
	"disconnect.loginFailedInfo.serversUnavailable": "प्रमाणीकरण सर्वर वर्तमान में उपलब्ध नहीं हैं। कृपया पुन: प्रयास करें।",
	...
	"disconnect.unknownHost": "अपरिचित मेजबान",
	...
	"generator.minecraft.normal": "पूर्व-परिभाषित",
	...
	"gui.cancel": "रद्द",
	"gui.chatReport.comments": "टिप्पणी संपादन बॉक्स",
	...
	"gui.chatSelection.fold": "%s असंबंधित संदेश छुपाए गए",
	...
	"multiplayer.applyingPack": "संसाधन पैक लग रहा है",
	...
	"multiplayer.disconnect.invalid_packet": "सर्वर ने एक अमान्य पैकेट भेजा हैं",
	"multiplayer.disconnect.invalid_player_data": "अमान्य खिलाड़ी दत्त-सामग्री",
	"multiplayer.disconnect.invalid_player_movement": "अमान्य मूव प्लेयर पैकेट प्राप्त हुआ",
	"multiplayer.disconnect.invalid_public_key": "प्रोफ़ाइल सार्वजनिक कुंजी पार्स करने में असमर्थ। ",
	...
	"multiplayer.disconnect.missing_public_key": "प्रोफ़ाइल सार्वजनिक कुंजी गुम है.\nइस सर्वर को सुरक्षित प्रोफाइल की आवश्यकता है",
	...
	"multiplayer.requiredTexturePrompt.line2": "इस कस्टम संसाधन पैक को अस्वीकार करने से आप इस सर्वर से बेमेल किया जाएंगे।",
	...
	"multiplayer.texturePrompt.failure.line1": "सर्वर संसाधन पैक नही लग सका।",
	"multiplayer.texturePrompt.failure.line2": "कोई भी कार्यक्षमता जिसके लिए चरित्र संसाधनों की आवश्यकता होती है, वह अपेक्षा के अनुरूप काम नहीं कर सकती है",
	...
	"narration.recipe.usage.more": "अधिक विधियाँ दिखाने के लिए राइट क्लिक करें",
	...
	"options.chatPreview": "चैट पूर्वावलोकन ",
	"options.chatPreview.confirm": "भेजते समय",
	"options.chatPreview.live": "टाइप करते समय",
	"options.chatPreview.tooltip.confirm": "अगर सर्वर चैट पूर्व दर्शन का उपयोग करता है: एक चैट चैट पूर्व केवल तभी उत्पन्न होता है जब एक संदेश भेजने का प्रयास किया जाता है जिसमें चैट पूर्व नहीं होता है या चैट पूर्व की प्रतीक्षा कर रहा होता है।\nसंदेश भेजने के लिए पुष्टि की आवश्यकता है।",
	"options.chatPreview.tooltip.live": "अगर सर्वर चैट पूर्व दर्शन का उपयोग करता है: सर्वर द्वारा आपके चैट संदेशों पर लागू किया गया कोई भी संशोधन चैट संदेश टाइप होते ही पूर्व दर्शन के लिए गतिशील रूप से भेजा जाएगा।",
	"options.chatPreview.tooltip.off": "सर्वर द्वारा आपके चैट संदेशों पर लागू किए गए किसी भी संशोधन का पूर्व दर्शन नहीं किया जाएगा और इसे असुरक्षित माना जाएगा।",
	...
	"options.darkMojangStudiosBackgroundColor.tooltip": "मोजेंग स्टूडियोज लोडिंग स्क्रीन बैकग्राउंड कलर को ब्लैक में बदलता है",
