...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "스컬크 감지체나 워든 근처에서 웅크린 채 움직여 당신을 감지하지 못 하게 하세요",
	...
	"advancements.husbandry.make_a_sign_glow.description": "표지판의 글자를 빛나게 만드세요",
	...
	"attribute.unknown": "알 수 없는 특성입니다",
	...
	"chat.editBox": "대화",
	"chat.filtered_full": "서버가 일부 플레이어에게 내 메시지를 숨겼습니다.",
	...
	"chat.previewInput": "미리 보려면 [%s] 를 누르세요.",
	"chat.queue": "[+%s줄 대기 중]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "이 메시지는 서버에 의해 수정되었습니다.",
	"chat.tag.modified": "이 메시지는 서버에 의해 수정되었습니다.",
	"chat.tag.modified.original": "원본 텍스트: %s",
	"chat.tag.not_secure": "이 메시지는 안전하지 않으며, 서버에 의해 수정되었을 수 있는 가능성이 있는 메시지 입니다.",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "이 서버에서 다시 알리지 않기",
	"chatPreview.warning.content": "대화 미리보기를 사용하면 당신의 메시지가 다른 플레이어에게 전송되기 전에 서버에서 미리 확인할 수 있습니다. 이렇게 하면 사용자 지정 수정 사항 및 스타일이 적용된 메세지를 서버로부터 미리 확인할 수 있습니다.\n\n대화 미리보기 작동 여부는 대화 설정에서 변경 할 수 있습니다. 현재 설정은: [%s]",
	"chatPreview.warning.title": "이 서버는 대화 미리 보기를 사용합니다",
	"chatPreview.warning.toast": "이 서버는 대화 미리 보기를 사용하며 입력 중인 메시지를 보내기 전에도 서버가 실시간으로 확인할 수 있습니다. 이 기능은 대화 설정에서 끌 수 있습니다.",
	"chatPreview.warning.toast.title": "대화 미리 보기가 켜져 있습니다",
	...
	"commands.locate.biome.invalid": "\"%s\" 종류의 생물 군계가 없습니다",
	"commands.locate.biome.not_found": "적당한 거리 안에 있는 \"%s\" 종류의 생물 군계를 찾을 수 없습니다",
	"commands.locate.biome.success": "가장 가까운 %s은(는) %s에 있습니다 (블록 %s개만큼 떨어져 있음)",
	"commands.locate.poi.invalid": "\"%s\" 종류의 관심 지점이 없습니다",
	"commands.locate.poi.not_found": "적당한 거리 안에 있는 \"%s\" 종류의 관심 지점을 찾을 수 없습니다",
	"commands.locate.poi.success": "가장 가까운 %s은(는) %s에 있습니다 (블록 %s개만큼 떨어져 있음)",
	"commands.locate.structure.invalid": "\"%s\" 종류의 구조물이 없습니다",
	"commands.locate.structure.not_found": "근처에서 \"%s\" 종류의 구조물을 찾을 수 없습니다",
	"commands.locate.structure.success": "가장 가까운 %s은(는) %s에 있습니다 (블록 %s개만큼 떨어져 있음)",
	...
	"death.attack.witherSkull.item": "%[1]s이(가) %[2]s의 해골에게 %[3]s(으)로 저격당했습니다",
	...
	"disconnect.loginFailedInfo.userBanned": "당신은 온라인 플레이에서 차단되었습니다.",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "아동과 관련된 외설적 행동에 관해 말하거나 조장하고 있습니다.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "명예 훼손, 사칭 또는 허위 사실 유포",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "다른 사람들을 이용하거나 오도할 목적으로 타인의 평판을 깎아내리거나, 타인인 척하거나, 허위 사실을 유포하고 있습니다.",
	...
	"gui.abuseReport.reason.harassment_or_bullying.description": "누군가가 당신 혹은 여러 사람들에게 수치심을 주거나, 해악하거나, 또는 괴롭히고 있습니다. 이는 동의 없이 연락을 시도하거나, 당신 혹은 다른사람의 개인정보를 게시하는 행위를 포함합니다. (\"신상 털기\").",
	...
	"gui.abuseReport.reason.imminent_harm": "즉각적 위협 - 타인을 해치겠다는 위협",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "불법 촬영물 등 타인의 사적인 촬영물에 대해 대화, 유포 및 선동하고 있습니다.",
	"gui.abuseReport.reason.self_harm_or_suicide": "목전의 위협 - 자해 또는 자살",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "현실에서 자해할 것이라고 위협하거나, 자해에 관해 말하고 있습니다.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "테러 또는 폭력적 극단주의",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "정치, 종교, 이념 등의 이유로 테러리즘이나 폭력적 극단주의적 행위에 관해 대화, 조장 또는 위협하고 있습니다.",
	"gui.abuseReport.reason.title": "신고 범주 선택",
	"gui.abuseReport.send.error_message": "신고를 제출하는 중 오류가 발생했습니다: '%s'",
	...
	"gui.abuseReport.send.service_unavailable": "악용 신고 서비스에 접근 할 수 없습니다. 인터넷 연결을 확인한 후 다시 시도해 주세요.",
	...
	"gui.all": "모두",
	"gui.back": "뒤로",
	"gui.banned.description": "%s\n\n%s\n\n다음 링크에서 더 자세히 알아보기: %s",
	"gui.banned.description.permanent": "당신의 계정이 멀티플레이에서와 Realms에서 영구적으로 차단되었습니다.",
	"gui.banned.description.reason": "저희는 당신의 계정에서 발생한 악의적인 행위에 대한 신고를 접수받았습니다. 해당 신고는 검토후 %s인 것으로 확인되었으며, 이는 마인크래프트 커뮤니티 규정에 위반합니다.",
	"gui.banned.description.reason_id": "코드: %s",
	"gui.banned.description.reason_id_message": "코드: %s - %s",
	"gui.banned.description.temporary": "%s 동안 Realms 및 멀티플레이에 참여할 수 없습니다.",
	"gui.banned.description.temporary.duration": "계정이 일시 정지되어 %s 뒤에 다시 활성화됩니다.",
	"gui.banned.description.unknownreason": "최근 귀하의 계정에 의해 발생된 악의적인 행위에 관한 신고를 접수받았습니다. 해당 신고를 검토하였으며, Minecraft 커뮤니티 표준에 위반함을 확인했습니다.",
	"gui.banned.title.permanent": "계정 영구 차단",
	"gui.banned.title.temporary": "계정 일시 정지",
	"gui.cancel": "취소",
	"gui.chatReport.comments": "설명 편집 상자",
	"gui.chatReport.describe": "더 정확한 결정에 도움을 주기 위해 자세한 내용을 공유해 주세요.",
	"gui.chatReport.discard.content": "화면에서 나갈 경우, 작성 중인 신고와 설명이 저장되지 않습니다. 정말 나가시겠습니까?",
	"gui.chatReport.discard.discard": "신고 취소 및 나가기",
	"gui.chatReport.discard.return": "계속 수정",
	"gui.chatReport.discard.title": "신고 및 그 이유의 제출을 취소할까요?",
	...
	"gui.chatReport.select_reason": "신고 유형 선택",
	...
	"gui.chatReport.send.too_many_messages": "신고에 포함된 메시지가 너무 많습니다",
	"gui.chatReport.title": "플레이어 신고",
	"gui.chatSelection.context": "선택한 메시지의 전후 메시지 또한 구체적인 맥락을 제공하기 위해 포함됩니다.",
	"gui.chatSelection.fold": "관련되지 않은 메시지 %s개 숨겨짐",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s의 발언: %s (시각 %s)",
	"gui.chatSelection.selected": "%s/%s 메시지 선택",
	"gui.chatSelection.title": "신고할 채팅 메세지를 선택하세요.",
	"gui.days": "%s일",
	"gui.done": "완료",
	"gui.down": "아래로",
	...
	"gui.socialInteractions.narration.hide": "%s님의 메세지 숨기기",
	"gui.socialInteractions.narration.report": "플레이어 %s 신고",
	"gui.socialInteractions.narration.show": "%s님의 메시지 표시하기",
	"gui.socialInteractions.report": "신고",
	"gui.socialInteractions.search_empty": "그 이름의 플레이어를 찾지 못 했습니다",
	...
	"gui.socialInteractions.tooltip.hide": "메시지 가리기",
	"gui.socialInteractions.tooltip.report": "플레이어 신고하기",
	"gui.socialInteractions.tooltip.report.disabled": "신고 서비스를 이용할 수 없습니다",
	"gui.socialInteractions.tooltip.report.no_messages": "플레이어 %s에게는 신고할 메시지가 없습니다",
	"gui.socialInteractions.tooltip.report.not_reportable": "이 서버에서는 대화 메시지를 검증할 수 없으므로 이 플레이어를 신고할 수 없습니다",
	"gui.socialInteractions.tooltip.show": "메시지 표시",
	"gui.stats": "통계",
	...
	"multiplayer.disconnect.chat_validation_failed": "대화 메시지 유효성 검증을 실패했습니다",
	...
	"multiplayer.disconnect.invalid_public_key": "프로필 공개 키를 해석할 수 없습니다.",
	...
	"multiplayer.disconnect.missing_public_key": "프로필 공개 키가 없습니다.\n이 서버는 보안 프로필 사용을 요구합니다.",
	"multiplayer.disconnect.missing_tags": "서버로부터 받지 못 한 태그가 있습니다.\n서버 관리자에게 문의해 주세요.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "확인되지 않은 대화 메시지가 너무 많습니다",
	"multiplayer.disconnect.unexpected_query_response": "클라이언트로부터 예기치 않은 사용자 지정 데이터를 수신했습니다",
	"multiplayer.disconnect.unsigned_chat": "서명이 없거나 잘못된 수신된 채팅 패킷을 받았습니다.",
	...
	"multiplayer.texturePrompt.failure.line1": "서버 리소스 팩을 적용하지 못 했습니다",
	...
	"multiplayer.unsecureserver.toast": "이 서버에서 보낸 메시지는 수정되거나 원본 메시지를 반영하지 않을 가능성이 있습니다",
	"multiplayer.unsecureserver.toast.title": "대화 메세지가 검증될 수 없습니다.",
	...
	"options.chatPreview": "대화 미리 보기",
	"options.chatPreview.confirm": "전송 할때",
	"options.chatPreview.live": "입력하는 동안",
	"options.chatPreview.tooltip.confirm": "서버에서 대화 미리 보기를 사용하는 경우: 미리 보기가 없거나 미리 보기를 기다리는 메시지를 보내려고 할 때만 대화 미리보기가 생성됩니다.\n메시지를 보내려면 확인이 필요합니다.",
	"options.chatPreview.tooltip.live": "서버에서 대화 미리 보기를 사용하는 경우: 대화 메시지에 적용된 변경 사항은 대화 메시지가 입력될 때 서버에서 미리보기를 표시하기 위해 동적으로 전송합니다.",
	"options.chatPreview.tooltip.off": "서버에서 대화 메시지에 적용한 수정 사항은 미리 볼 수 없으며 안전하지 않은 것으로 처리됩니다.",
	...
	"options.directionalAudio.off.tooltip": "일반적 스테레오 소리",
	...
	"screenshot.failure": "스크린샷을 저장하지 못 했습니다: %s",
	...
	"subtitles.entity.frog.eat": "개구리가 먹이를 먹음",
	...
	"subtitles.entity.piglin_brute.angry": "피글린 야수가 화난 듯 욺",
	...
	"subtitles.entity.warden.attack_impact": "워든이 타격을 맞춤",
