...
var Map = map[string]string{
	...
	"advancements.husbandry.safely_harvest_honey.description": "Usa una fogata para recoger miel de una colmena usando un frasco sin enfadar a las abejas",
	...
	"commands.place.structure.invalid": "No hay una estructura con el tipo %s",
	...
	"multiplayer.disconnect.invalid_packet": "El servidor envió un paquete invalido",
	...
	"multiplayer.disconnect.invalid_public_key": "No ha sido posible analizar la clave pública del perfil.",
	...
	"options.chatPreview": "Previsualización de chat",
	...
	"options.chatPreview.tooltip.off": "Cualquier modificación aplicada a tus mensajes por un servidor no se previsualizará y se tratará como insegura.",
	...
	"options.directionalAudio.on.tooltip": "Usa audio direccional basado en HRTF para mejorar la simulación de sonido 3D. Se requiere hardware de audio compatible con HRTF, y se experimenta mejor con audífonos.",
