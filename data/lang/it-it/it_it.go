...
var Map = map[string]string{
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Uccidi un mob vicino a un catalizzatore di sculk",
	...
	"advancements.husbandry.kill_axolotl_target.description": "Alleati con un axolotl e vinci un combattimento",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Fai brillare il testo di un cartello",
	...
	"block.minecraft.reinforced_deepslate": "Ardesia profonda rinforzata",
	...
	"chat.disabled.profile": "Le impostazioni del tuo account non consentono l'utilizzo della chat. Premi di nuovo '%s' per maggiori informazioni",
	"chat.disabled.profile.moreInfo": "Chat disattivata nelle opzioni dell'account. Impossibile mandare o leggere i messaggi.",
	"chat.editBox": "chat",
	"chat.filtered_full": "Il server ha nascosto i tuoi messaggi per alcuni giocatori.",
	...
	"chat.previewInput": "Premi [%s] per visualizzare l'anteprima",
	"chat.queue": "[+%s messaggi in attesa]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Questo messaggio è stato filtrato dal server.",
	"chat.tag.modified": "Questo messaggio è stato modificato dal server.",
	"chat.tag.modified.original": "Testo originale: %s",
	"chat.tag.not_secure": "Questo messaggio non è sicuro, ciò significa che potrebbe essere stato modificato dal server",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Non avvisare più per questo server",
	"chatPreview.warning.content": "L'anteprima della chat permette al server di mostrare i tuoi messaggi prima di inviarli agli altri giocatori. In questo modo i server possono mostrarti un'anteprima dei tuoi messaggi in chat con modifiche e stili applicati.\n\nIl comportamento dell'anteprima può essere modificato nelle impostazioni della chat. L'impostazione attuale è: [%s]",
	"chatPreview.warning.title": "Questo server utilizza l'anteprima della chat",
	"chatPreview.warning.toast": "Questo server supporta l'anteprima della chat e può vedere i tuoi messaggi prima d'inviarli agli altri giocatori. Puoi disabilitare questa funzione nelle impostazioni della chat.",
	"chatPreview.warning.toast.title": "L'anteprima della chat è attivata",
	...
	"commands.kill.success.single": "%s è stato ucciso",
	"commands.list.nameAndId": "%s (%s)",
	"commands.list.players": "%s giocatori (su %s massimi) sono attualmente connessi: %s",
	"commands.locate.biome.invalid": "Non esiste un bioma di tipo \"%s\"",
	"commands.locate.biome.not_found": "Impossibile trovare il bioma di tipo \"%s\" entro una distanza ragionevole",
	"commands.locate.biome.success": "La struttura di tipo %s più vicina è in %s (%s blocchi di distanza)",
	"commands.locate.poi.invalid": "Non ci sono punti di interesse di tipo \"%s\"",
	"commands.locate.poi.not_found": "Non ho trovato un punto di interesse di tipo \"%s\" entro una distanza ragionevole",
	"commands.locate.poi.success": "La struttura di tipo %s più vicina è in %s (%s blocchi di distanza)",
	"commands.locate.structure.invalid": "Non esiste una struttura di tipo \"%s\"",
	"commands.locate.structure.not_found": "Impossibile trovare una struttura di tipo \"%s\" nei paraggi",
	...
	"commands.place.feature.success": "\"%s\" è stato piazzato in %s, %s, %s",
	...
	"commands.place.structure.success": "Struttura \"%s\" generata a %s, %s, %s",
	...
	"death.attack.anvil.player": "%[1]s è stato spiaccicato da un'incudine lottando con %[2]s",
	...
	"death.attack.badRespawnPoint.message": "%[1]s è stato ucciso da %[2]s",
	...
	"death.attack.dragonBreath.player": "%[1]s è stato arrostito nel soffio di drago da %[2]s",
	"death.attack.drown": "%[1]s è annegato",
	"death.attack.drown.player": "%[1]s è annegato fuggendo da %[2]s",
	"death.attack.dryout": "%[1]s è morto di disidratazione",
	"death.attack.dryout.player": "%[1]s è morto di disidratazione fuggendo da %[2]s",
	"death.attack.even_more_magic": "%[1]s è stato ucciso da ancora più magia",
	"death.attack.explosion": "%[1]s è saltato in aria",
	"death.attack.explosion.player": "%[1]s è stato fatto saltare in aria da %[2]s",
	"death.attack.explosion.player.item": "%[1]s è stato fatto saltare in aria da %[2]s armato di %[3]s",
	"death.attack.fall": "%[1]s si è sfracellato",
	"death.attack.fall.player": "%[1]s si è sfracellato fuggendo da %[2]s",
	"death.attack.fallingBlock": "%[1]s è stato spiaccicato da un blocco",
	"death.attack.fallingBlock.player": "%[1]s è stato spiaccicato da un blocco lottando con %[2]s",
	"death.attack.fallingStalactite": "%[1]s è stato infilzato da una stalattite",
	"death.attack.fallingStalactite.player": "%[1]s è stato infilzato da una stalattite mentre lottava con %[2]s",
	"death.attack.fireball": "%[1]s è stato preso a palle di fuoco da %[2]s",
	"death.attack.fireball.item": "%[1]s è stato preso a palle di fuoco da %[2]s usando %[3]s",
	"death.attack.fireworks": "%[1]s se n'è andato col botto",
	"death.attack.fireworks.item": "%[1]s se n'è andato col botto a causa di un razzo pirotecnico sparato con %[3]s da %[2]s",
	"death.attack.fireworks.player": "%[1]s se n'è andato col botto lottando con %[2]s",
	...
	"death.attack.freeze": "%[1]s è morto assiderato",
	"death.attack.freeze.player": "%[1]s è morto assiderato a causa di %[2]s",
	"death.attack.generic": "%[1]s è morto",
	"death.attack.generic.player": "%[1]s è morto a causa di %[2]s",
	...
	"death.attack.inWall.player": "%[1]s è soffocato in un muro lottando con %[2]s",
	...
	"death.attack.lightningBolt.player": "%[1]s è stato colpito da un fulmine lottando con %[2]s",
	"death.attack.magic": "%[1]s è stato ucciso dalla magia",
	"death.attack.magic.player": "%[1]s è stato ucciso dalla magia fuggendo da %[2]s",
	...
	"death.attack.mob.item": "%[1]s è stato ucciso da %[2]s usando %[3]s",
	"death.attack.onFire": "%[1]s è bruciato vivo",
	"death.attack.onFire.item": "%[1]s è stato ridotto in cenere lottando con %[2]s impugnando %[3]s",
	"death.attack.onFire.player": "%[1]s è stato ridotto in cenere lottando con %[2]s",
	...
	"death.attack.sonic_boom": "%[1]s è stato obliterato da un urlo caricato sonicamente",
	"death.attack.sonic_boom.item": "%[1]s è stato obliterato da un urlo caricato sonicamente fuggendo da %[2]s impugnando %[3]s",
	"death.attack.sonic_boom.player": "%[1]s è stato obliterato da un urlo caricato sonicamente fuggendo da %[2]s",
	"death.attack.stalagmite": "%[1]s è stato impalato su una stalagmite",
	"death.attack.stalagmite.player": "%[1]s è stato impalato su una stalagmite mentre combatteva contro %[2]s",
	"death.attack.starve": "%[1]s è morto di fame",
	"death.attack.starve.player": "%[1]s è morto di fame lottando con %[2]s",
	"death.attack.sting": "%[1]s è stato punto a morte",
	"death.attack.sting.item": "%[1]s è stato punto a morte da %[2]s usando %[3]s",
	"death.attack.sting.player": "%[1]s è stato punto a morte da %[2]s",
	"death.attack.sweetBerryBush": "%[1]s è morto punzecchiato in un cespuglio di bacche dolci",
	"death.attack.sweetBerryBush.player": "%[1]s è morto punzecchiato in un cespuglio di bacche dolci fuggendo da %[2]s",
	"death.attack.thorns": "%[1]s è stato ucciso cercando di ferire %[2]s",
	"death.attack.thorns.item": "%[1]s è stato ucciso da %[3]s cercando di ferire %[2]s",
	"death.attack.thrown": "%[1]s è stato bersagliato da %[2]s",
	"death.attack.thrown.item": "%[1]s è stato bersagliato da %[2]s usando %[3]s",
	"death.attack.trident": "%[1]s è stato impalato da %[2]s",
	"death.attack.trident.item": "%[1]s è stato impalato da %[2]s con %[3]s",
	"death.attack.wither": "%[1]s è avvizzito",
	"death.attack.wither.player": "%[1]s è avvizzito lottando con %[2]s",
	"death.attack.witherSkull": "%[1]s è stato colpito da un teschio di %[2]s",
	"death.attack.witherSkull.item": "%[1]s è stato ucciso con un teschio di %[2]s usando %[3]s",
	"death.fell.accident.generic": "%[1]s è precipitato",
	"death.fell.accident.ladder": "%[1]s è caduto da una scala",
	"death.fell.accident.other_climbable": "%[1]s è caduto mentre si arrampicava",
	"death.fell.accident.scaffolding": "%[1]s è caduto da un'impalcatura",
	"death.fell.accident.twisting_vines": "%[1]s è caduto da dei rampicanti attorcigliati",
	"death.fell.accident.vines": "%[1]s è caduto da dei rampicanti",
	"death.fell.accident.weeping_vines": "%[1]s è caduto da dei rampicanti piangenti",
	...
	"death.fell.finish.item": "%[1]s è precipitato ed è stato finito da %[2]s usando %[3]s",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Diffamazione, furto d'identità o informazioni false",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Qualcuno sta danneggiando la reputazione di qualcun altro, fingendo di essere qualcun altro, o condividendo informazioni false con lo scopo di abusare o ingannare gli altri.",
	...
	"gui.abuseReport.reason.imminent_harm": "Pericolo imminente - Minaccia di fare del male agli altri nella vita reale",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Pericolo imminente - Autolesionismo o suicidio",
	...
	"gui.abuseReport.reason.title": "Seleziona la categoria della segnalazione",
	...
	"gui.abuseReport.send.json_error": "C'è stato un carico utile non valido durante l'invio della tua segnalazione.",
	"gui.abuseReport.send.service_unavailable": "Impossibile accedere al servizio di segnalazione abusi. Controlla la tua connessione a Internet e riprova.",
	...
	"gui.banned.description.permanent": "Il tuo account è permanentemente bannato. Non puoi giocare online o connetterti a Realms.",
	...
	"gui.banned.description.temporary": "%s Nel frattempo, non potrai giocare online o unirti a Realms.",
	...
	"gui.cancel": "Annulla",
	"gui.chatReport.comments": "Casella di modifica dei commenti",
	...
	"gui.chatReport.send.comments_too_long": "Riduci la lunghezza del commento",
	...
	"gui.socialInteractions.status_hidden": "Nascosto",
	...
	"multiplayer.disconnect.invalid_public_key": "Impossibile analizzare la chiave pubblica del profilo.",
	...
	"multiplayer.disconnect.missing_public_key": "Chiave pubblica del profilo mancante.\nQuesto server richiede profili sicuri.",
	...
	"multiplayer.unsecureserver.toast": "Questo server potrebbe modificare i messaggi inviati, rendendoli diversi dal messaggio originale",
	"multiplayer.unsecureserver.toast.title": "I messaggi in chat non possono essere verificati",
	...
	"options.chatPreview": "Anteprima della chat",
	"options.chatPreview.confirm": "All'invio",
	"options.chatPreview.live": "Mentre digiti",
	"options.chatPreview.tooltip.confirm": "Se un server usa l'anteprima della chat: l'anteprima viene generata soltanto quando si prova a inviare un messaggio che sia in attesa di un'anteprima o senza anteprima.\nL'invio del messaggio richiede una conferma.",
	"options.chatPreview.tooltip.live": "Se un server usa l'anteprima della chat: qualunque modifica applicata da un server ai tuoi messaggi in chat verrà inviata dinamicamente per l'anteprima durante la digitazione del messaggio.",
	"options.chatPreview.tooltip.off": "Qualsiasi modifica applicata ai tuoi messaggi in chat dal server non verrà visualizzata in anteprima e sarà considerata non sicura.",
	...
	"options.directionalAudio.on.tooltip": "Utilizza l'audio direzionale basato su HRTF per migliorare la simulazione del suono 3D. Richiede hardware audio compatibile con HRTF ed è consigliabile usare le cuffie.",
	...
	"stat_type.minecraft.killed_by.none": "Non sei mai stato ucciso da %s",
	...
	"subtitles.entity.warden.angry": "Sorvegliante si infuria",
	...
	"tutorial.find_tree.description": "Colpiscilo per ottenere del legno",
