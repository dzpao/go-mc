...
var Map = map[string]string{
	...
	"advancements.husbandry.leash_all_frog_variants.title": "Når gjengen hopper inn i byen",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Bruk et bål til å samle honning på flaske fra en bikube uten å hisse opp biene",
	...
	"chat.disabled.profile": "Nettprat er sperret grunnet kontovalgene. Trykk på '%s' igjen for mer informasjon",
	...
	"chat.filtered_full": "Serveren har skjult meldingen din fra noen spillere.",
	...
	"chat.previewInput": "Trykk [%s] for å forhåndsvise",
	"chat.queue": "[+%s avventende linjer]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Denne meldingen har blitt filtrert av serveren.",
	"chat.tag.modified": "Denne meldingen har blitt endret på av serveren.",
	"chat.tag.modified.original": "Opprinnelig tekst: %s",
	"chat.tag.not_secure": "Denne meldingen er ikke sikker, som betyr at den kan ha blitt endret på av serveren",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Ikke varsl igjen om denne serveren",
	"chatPreview.warning.content": "Nettpratsforhåndsvisning tillater serveren å se meldingene dine før de sendes til andre spillere. Dette tillater en server å sende deg en forhåndsvisning av meldingene dine med tilpassede endringer og stil lagt til.\n\nOppførsel på nettpratsforhåndsvisning kan bli endret i dine nettprat-instillinger. Nåværende instilling er: [%s]",
	"chatPreview.warning.title": "Denne serveren bruker forhåndsvist nettprat",
	"chatPreview.warning.toast": "Denne serveren bruker forhåndsvist nettprat og kan se meldingene dine før de er sendt til andre spillere. Du kan skru dette av i Nettprat-instillinger.",
	"chatPreview.warning.toast.title": "Forhåndsvist nettprat er på",
	...
	"commands.locate.biome.invalid": "Markslaget \"%s\" finnes ikke",
	"commands.locate.biome.not_found": "Fant ikke markslaget \"%s\" i et rimelig omegn",
	"commands.locate.biome.success": "Nærmeste %s er ved %s (%s blokker unna)",
	"commands.locate.poi.invalid": "Det finnes intet interessepunkt av type \"%s\"",
	...
	"commands.place.structure.invalid": "Ingen struktur av type \"%s\" finnes",
	...
	"createWorld.customize.buffet.biome": "Vennligst velg et biom",
	...
	"datapackFailure.title": "Feil i valgte datapakker hindret verdenen fra å laste.\nDu kan enten prøve å laste inn med bare den vanlige datapakken (\"sikker-modus\") eller gå tilbake til hovedmenyen og fikse det manuelt.",
	...
	"death.attack.sonic_boom.player": "%[1]s ble tilintetgjort av et supersonisk skrik i flukt fra %[2]s",
	...
	"effect.minecraft.wither": "Visner",
	...
	"gamerule.doMobLoot.description": "Avgjør ytelse av bytte og erfaring fra skapninger",
	...
	"generator.minecraft.single_biome_surface": "Enkeltstående biom",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Noen påbyr andre å delta i ulovlige narkotikarelaterte handlinger eller påbyr mindreårige å drikke alkohol.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Æreskrenkelse, etterligning, eller falsk informasjon",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Noen sprer ødeleggende rykter om andre ved å late som at de er noen de ikke er, eller deler falsk informasjon med målet å utnytte eller misvise andre.",
	"gui.abuseReport.reason.description": "Beskrivelse:",
	"gui.abuseReport.reason.false_reporting": "Feilrapportering",
	"gui.abuseReport.reason.harassment_or_bullying": "Trakassering eller mobbing",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Noen skjender, angriper eller mobber deg eller noen andre. Dette inkluderer når noen prøver gjentatte ganger å kontakte deg eller noen andre uten samtykke, eller legger ut privat personlig informasjon om deg eller noen andre uten samtykke (\"doxing\").",
	"gui.abuseReport.reason.hate_speech": "Hatprat",
	"gui.abuseReport.reason.hate_speech.description": "Noen angriper deg verbalt eller en annen spiller basert på karakteristikker av identitet deres, som religion, rase eller seksualitet.",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Intime bilder uten samtykke",
	...
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Noen truer med å skade seg selv på ekte eller snakker om å skade seg selv på ekte.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorisme eller voldelig ekstremisme",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Noen snakker om, fremmer, eller truer med å begå handlinger av terrorisme eller voldelig ekstremisme for politiske, religiøse, ideologiske, eller andre grunner.",
	"gui.abuseReport.reason.title": "Velg rapportkategori",
	"gui.abuseReport.send.error_message": "En feil ble returnert under sendingen av rapporten din: '%s'",
	...
	"gui.abuseReport.send.json_error": "Traff på deformert avsendelse under sendingen av rapporten din.",
	"gui.abuseReport.send.service_unavailable": "Klarer ikke å nå misbruksrapporteringstjenesten. Vennligst forsikre deg at du er koblet til internettet og prøv igjen.",
	...
	"gui.banned.description.reason": "Vi fikk nylig en rapport om dårlig oppførsel fra din konto. Våre moderatorer har nå gått gjennom saken din og identifisert det som %s, som går imot Minecrafts fellesskapsstandarder.",
	"gui.banned.description.reason_id": "Kode: %s",
	"gui.banned.description.reason_id_message": "Kode: %s - %s",
	"gui.banned.description.temporary": "%s Før det kan du ikke spille på nett eller bli med på Realms.",
	"gui.banned.description.temporary.duration": "Din konto er midlertidig blokkert og vil bli reaktivert om %s.",
	"gui.banned.description.unknownreason": "Vi fikk nylig en rapport om dårlig oppførsel fra din konto. Våre moderatorer har nå gått igjennom saken din og har identifisert at den går imot Minecraft sine fellesskapsstandarder.",
	"gui.banned.title.permanent": "Konto permanent bannlyst",
	"gui.banned.title.temporary": "Konto midlertidig utestengt",
	"gui.cancel": "Avbryt",
	"gui.chatReport.comments": "Redigeringsfelt for kommentarer",
	"gui.chatReport.describe": "Å dele detaljer hjelper oss å ta en velgrunnet avgjørelse.",
	"gui.chatReport.discard.content": "Hvis du forlater denne rapporten vil du miste den og kommentarene dine.\nEr du sikker på at du vil forlate?",
	...
	"gui.chatSelection.context": "Meldinger omkring dette utvalget vil bli inkludert for å gi bedre kontekst",
	"gui.chatSelection.fold": "%s urelaterte meldinger skjulte",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s sa: %s kl. %s",
	"gui.chatSelection.selected": "%s/%s melding(er) valgt(e)",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Denne spilleren kan ikke bli rapportert fordi meldingene deres ikke kan verifiseres på denne serveren",
	...
	"multiplayer.disconnect.invalid_public_key": "Kunne ikke tolke profils offentlige nøkkel.",
	...
	"multiplayer.disconnect.missing_public_key": "Ingen offentlig nøkkel vedlagt profil.\nDenne serveren krever sikre profiler.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "For mange uhenviste nettpratsmeldinger",
	...
	"multiplayer.unsecureserver.toast": "Meldinger sendt på denne serveren kan bli endret på og kan muligens ikke reflektere den originale meldingen",
	...
	"options.chatPreview": "Forhåndsvist nettprat",
	"options.chatPreview.confirm": "Når du sender",
	"options.chatPreview.live": "Når du skriver",
	"options.chatPreview.tooltip.confirm": "Hvis en server bruker nettpratsforhåndsvisning: En nettpratsforhåndsvisning er bare generert når et forsøk er gjort på å sende en melding som ikke har en forhåndsvisning eller venter på en forhåndsvisning.\nÅ sende meldingen krever bekreftelse.",
	"options.chatPreview.tooltip.live": "Hvis en server bruker nettpratsforhåndsvisning: Alle endringer gjort på dine nettpratsmeldinger fra en server vil bli dynamisk sendt for forhåndsvisning mens meldingen bilr skrevet.",
	"options.chatPreview.tooltip.off": "Alle endringer gjort på dine meldinger av en server vil ikke bli forhåndsvist og vil bli sett på som usikker.",
	...
	"options.onlyShowSecureChat.tooltip": "Bare vis beskjeder fra andre spillere som kan bli verifisert til å ha vært sent fra den spilleren og som ikke har blitt modifisert.",
	...
	"options.vsync": "VSync",
	"outOfMemory.message": "Minecraft har gått tom for minne.\n\nDet kan være på grunn av en feil i spillet eller at Java Virtual Machine ikke er tildelt nok minne.\n\nFor å forhindre korrupsjon har det gjeldende spillet avsluttet. Vi har prøvd å frigjøre nok minne til å la deg gå tilbake til hovedmenyen og tilbake til å kunne spille, men det kan hende at det ikke har fungert.\n\nPrøv å starte spillet på nytt hvis du ser denne meldingen igjen.",
	...
	"stat.minecraft.animals_bred": "Dyr avlede",
	...
	"stat.minecraft.clean_armor": "Rustningsdeler vaskede",
	"stat.minecraft.clean_banner": "Bannere vaskede",
	"stat.minecraft.clean_shulker_box": "Shulkerbokser vaskede",
	...
	"stat.minecraft.eat_cake_slice": "Kakestykker spiste",
	"stat.minecraft.enchant_item": "Utstyr fortryllet",
	"stat.minecraft.fall_one_cm": "Avstand falt",
	"stat.minecraft.fill_cauldron": "Kjeler fylte",
	"stat.minecraft.fish_caught": "Fisk fangede",
	...
	"stat.minecraft.mob_kills": "Skapninger drepte",
	"stat.minecraft.open_barrel": "Tønner åpnede",
	"stat.minecraft.open_chest": "Kister åpnede",
	"stat.minecraft.open_enderchest": "Enderkister åpnede",
	"stat.minecraft.open_shulker_box": "Shulkerbokser åpnede",
	"stat.minecraft.pig_one_cm": "Avstand ridd på gris",
	"stat.minecraft.play_noteblock": "Noteblokker spilte",
	"stat.minecraft.play_record": "Musikkplater spilte",
	"stat.minecraft.play_time": "Tid spilt",
	"stat.minecraft.player_kills": "Spillere drepte",
	"stat.minecraft.pot_flower": "Planter pottede",
	"stat.minecraft.raid_trigger": "Herjinger utløste",
	"stat.minecraft.raid_win": "Herjinger vunne",
	...
	"stat.minecraft.target_hit": "Blinker trufne",
	...
	"stat.minecraft.treasure_fished": "Skatter fiskede opp",
	"stat.minecraft.trigger_trapped_chest": "Utløserkister utløste",
	"stat.minecraft.tune_noteblock": "Noteblokker stemte",
	"stat.minecraft.use_cauldron": "Vann tatt fra kjeler",
	...
	"subtitles.entity.painting.place": "Maleri opphenges",
