...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Es gibt koan Biom des Typs „%s“",
	"commands.locate.biome.not_found": "Es konnte in ongemessena Entfernung koan Biom des Typs „%s“ g'fundn wern",
	"commands.locate.biome.success": "%s is om näxtn bei %s (%s Blöcke entfernt)",
	...
	"commands.locate.poi.success": "%s is om näxtn bei %s (%s Blöcke entfernt)",
	...
	"commands.place.structure.invalid": "Die struktur \"%s\" gibt's ned oda hoast andäs",
