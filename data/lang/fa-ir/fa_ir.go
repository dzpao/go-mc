...
var Map = map[string]string{
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "اين که گسترده ميشه",
	...
	"advancements.end.dragon_breath.description": "نفس اژدها را توی يک بطری شيشه\u200cای بگیر",
	...
	"advancements.husbandry.axolotl_in_a_bucket.description": "يک اکسولوتل را داخل سطل بگیرید",
	...
	"block.minecraft.cut_copper_slab": "نيمه مس بریده",
	...
	"block.minecraft.exposed_cut_copper_slab": "نيمه مس بریده درمعرض هوا قرارگرفته شده",
	...
	"block.minecraft.oxidized_cut_copper_slab": "نيمه مس بریده اکسید شده",
	...
	"block.minecraft.waxed_cut_copper_slab": "نيمه مس بریده واکس شده",
	...
	"block.minecraft.waxed_exposed_cut_copper_slab": "نيمه مس بریده درمعرض هوا قرارگرفته واکس شده",
	...
	"block.minecraft.waxed_oxidized_cut_copper_slab": "نيمه مس بریده واکس کشیده اکسید شده",
	...
	"block.minecraft.waxed_weathered_cut_copper_slab": "نيمه مس بریده هوازده واکس شده",
	...
	"block.minecraft.weathered_cut_copper_slab": "نيمه مس بریده هوازده",
	...
	"chat.previewInput": "دکمه [%s] را برای پيش\u200cنمايش فشار دهید",
	"chat.queue": "[+%s خط در صف]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "اين پيام توسط سرور دستکاری شده.",
	"chat.tag.modified.original": "متن اصلی: %s",
	"chat.tag.not_secure": "اين پيام قابل اعتماد نيست، يعنی اينکه احتمالاً توسط سرور دستکاری شده",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "دوباره برای اين سرور يادآوری نکن",
	"chatPreview.warning.content": "پيش\u200cنمايش چت به سرور اين امکان را می دهد که پيام های شما را قبل از اينکه به بقيه بازيکنان فرستاده شود، مشاهده کند. اين به سرور اجازه می دهد تا ظاهر نمايشی تغييريافته و اعمال شده روی پيام شما را به شما پيش\u200cنمايش دهد.\n\nرفتار پيش\u200cنمايش چت را می توان در تنظيمات چت خود تغيير داد. وضعيت تنظيم فعلی ويژگی: [%s]",
	"chatPreview.warning.title": "اين سرور از پيش\u200cنمايش چت استفاده می کند",
	"chatPreview.warning.toast.title": "پيش\u200cنمايش چت فعال است",
	...
	"commands.locate.biome.invalid": "هیچ زیست بوم با نوع \"%s\" وجود دارد",
	"commands.locate.biome.not_found": "نمی\u200cتوان یک بیوم از نوع \"%s\" در فاصله\u200cای معقول از اینجا پیدا کرد",
	"commands.locate.biome.success": "نزدیک ترین %s در %s قرار دارد (%s بلوک دورتر از اینجا)",
	"commands.locate.poi.invalid": "هیچ نقطه عطفی برای نوع \"%s\" وجود ندارد",
	...
	"commands.place.structure.invalid": "هیچ سازه\u200cای با نوع \"%s\" وجود ندارد",
	...
	"death.attack.freeze.player": "%[1]s توسط %[2]s يخ زد تا مرد",
	...
	"entity.minecraft.end_crystal": "کريستال پایان",
	...
	"gamerule.doTraderSpawning": "احضار کردن معامله\u200cگر های سرگردان",
	...
	"gui.banned.description.unknownreason": "ما اخيرا يک گزارش درباره رفتار نامناسب توسط حساب شما دريافت کرده\u200cايم. ناظران ما مورد مربوط به شما را بررسی نموده و آن را شناسايی نمودند که بر خلاف استاندارد های انجمن ماینکرافت می باشد.",
	"gui.banned.title.permanent": "حساب به طور دائم مسدود شده",
	"gui.banned.title.temporary": "حساب موقتاً مسدود شده",
	"gui.cancel": "لغو",
	"gui.chatReport.comments": "محل ويرايش توضيحات",
	...
	"gui.chatSelection.fold": "%s پيام نامربوط پنهان شدند",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s گفت: %s در %s",
	"gui.chatSelection.selected": "%s/%s پيام انتخاب شده",
	"gui.chatSelection.title": "انتخاب يک پيام از چت برای گزارش",
	"gui.days": "%s روز",
	"gui.done": "انجام",
	"gui.down": "پايين",
	...
	"itemGroup.decorations": "بلوک هایتزئيني",
	...
	"multiplayer.disconnect.authservers_down": "سرور\u200cهای تائيد اعتبار درحال حاضر غيرفعال هستند. لطفاً بعداً دوباره تلاش کنید، واقعاً در اينباره متأسفيم!",
	...
	"multiplayer.disconnect.invalid_public_key": "کليد عمومی پروفایل قادر تجزيه و تحليل نيست.",
	...
	"multiplayer.disconnect.missing_public_key": "کليد عمومی پروفايل یافت نشد.\nاين سرور نيازمند به پروفايل ايمن است.",
	...
	"options.allowServerListing.tooltip": "سرور ها ممکن است ليست افراد آنلاین را به عنوان قسمتی از وضعيت عمومی خود نشان دهند.\nبا خاموش کردن اين گزينه، نام شما در اين نوع ليست ها نمايش داده نخواهد شد.",
	...
	"options.chatPreview": "پيش\u200cنمايش چت",
	"options.chatPreview.confirm": "در هنگام ارسال",
	"options.chatPreview.live": "در حين نوشتن",
	"options.chatPreview.tooltip.confirm": "اگر يک سرور از ويژگی پيش\u200cنمايش چت پشتيبانی کند: پيش\u200cنمايش چت فقط وقتی توليد خواهد شد که شما سعی کنيد پيامی را بفرستيد که پيش\u200cنمايشی برای آن ارائه نشده و منتظر دريافت يک پيش\u200cنمايش مانده.\nارسال نهايی پيام به تائيد شما نيازمند خواهد بود.",
	"options.chatPreview.tooltip.live": "اگر يک سرور از ويژگی پيش\u200cنمايش چت پشتيبانی کند: هرنوع تغيير اعمال شده روی پيام های چت شما توسط سرور به صورت پویا برای ارائه پيش\u200cنمايش همزمان با تايپ کردن شما، ارسال خواهد شد.",
	"options.chatPreview.tooltip.off": "هر تغييری که روی پيام های چت شما توسط يک سرور اعمال شود، پيش\u200cنمايش داده نخواهند شد و به عنوان يک پيام نامطمئن تلقی خواهد شد.",
	...
	"structure_block.mode.save": "دخيره",
	...
	"subtitles.entity.boat.paddle_water": "قايقرانی کردن",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "خروپف طوطی",
	...
	"subtitles.item.bundle.insert": "آيتم وارد کیسه می شود",
	"subtitles.item.bundle.remove_one": "آيتم از کیسه خارج می شود",
	...
	"title.multiplayer.disabled": "حالت چندنفره غيرفعال شده. لطفا تنظيمات حساب مايکروسافت خود را چک کنيد.",
