...
var Map = map[string]string{
	...
	"options.gamma.default": "Originala",
	...
	"selectWorld.backupWarning.snapshot": "Ica mondo ludesis plu recente en versiono %s; vu uzas versiono %s. Voluntez facar sekura kopiuro kaze ke vu experiencas korupti di vua mondo!",
