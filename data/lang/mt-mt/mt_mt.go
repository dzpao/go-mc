...
var Map = map[string]string{
	...
	"block.minecraft.mangrove_slab": "Blata tal-Mangrovja",
	"block.minecraft.mangrove_stairs": "Taraġ tal-Mangrovja",
	"block.minecraft.mangrove_trapdoor": "Bieb tan-Nasba tal-Mangrovja",
	...
	"block.minecraft.mud_brick_slab": "Blata tal-Briks tat-Tajba",
	...
	"commands.locate.biome.invalid": "M'hemm l-ebda bijoma bit-tip \"%s\"",
	"commands.locate.biome.not_found": "Ma setax isib bijoma tat-tii\"%s\"f'distanza raġonevoli",
	"commands.locate.biome.success": "L-eqreb %s huwa fi %s (%s-il blokk)",
	"commands.locate.poi.success": "L-eqreb %s huwa fi %s (%s-il blokk)",
	...
	"commands.place.structure.invalid": "M'hemmx struttura bit-tip %s",
	...
	"gui.chatReport.comments": "Kaxxa tal-editjar tal-kummenti",
	...
	"gui.chatReport.selected_chat": "%s Messaġġ(i) taċ-Chat Magħżula(i) biex tirrapporta",
	...
	"item.minecraft.music_disc_5": "Diska tal-Mużika",
	...
	"item.minecraft.music_disc_otherside": "Disk tal-Mużika",
	...
	"selectWorld.backupQuestion.snapshot": "Żgur tixtieq tiftaħ din id-dinja?",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Pappagall joħroġ",
