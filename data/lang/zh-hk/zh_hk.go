...
var Map = map[string]string{
	...
	"chat.editBox": "聊天欄",
	"chat.filtered_full": "此伺服器已對部分玩家隱藏你嘅訊息。",
	...
	"chat.tag.filtered": "此訊息已被伺服器過濾。",
	"chat.tag.modified": "此訊息已被伺服器修改。",
	"chat.tag.modified.original": "原始文本：%s",
	"chat.tag.not_secure": "此訊息唔安全，即可能被伺服器修改過",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "唔再喺依個伺服器上再次通知",
	"chatPreview.warning.content": "聊天預覽可以令伺服器喺你嘅訊息被傳送至其他玩家之前查看此訊息。此功能可以令伺服器向客户端傳送應用過樣式以及被伺服器修改過嘅聊天訊息嘅預覽。\n\n聊天預覽功能嘅行為可以於聊天設定中更改。目前設定為：[%s]",
	"chatPreview.warning.title": "此伺服器使用聊天預覽",
	"chatPreview.warning.toast": "此伺服器使用聊天預覽，可以預覽你未傳送嘅訊息。 你可以于聊天設置中關閉此功能。",
	...
	"gui.chatReport.describe": "提供詳細資料有助我哋做出更明智嘅判斷。",
	"gui.chatReport.discard.content": "如果你離開，依個舉報及留言將會丟失。\n你真係要離開？",
	...
	"gui.socialInteractions.tooltip.report.no_messages": "玩家 %s 沒有可以舉報嘅訊息",
	"gui.socialInteractions.tooltip.report.not_reportable": "無法舉報此玩家，因為此伺服器無法驗證該玩家嘅聊天訊息",
	...
	"options.chatPreview.tooltip.confirm": "如果伺服器使用聊天預覽：聊天預覽只會於嘗試傳送並且未預覽或正在等待預覽嘅訊息時生成。\n傳送訊息需要確認。",
	"options.chatPreview.tooltip.live": "若伺服器使用聊天預覽，於聊天訊息輸入同時，伺服器對聊天訊息所做任何變更都會被動態回傳，以便預覽。",
	"options.chatPreview.tooltip.off": "伺服器對聊天訊息所進行嘅所有更改將唔會被預覽，而且會被視為唔安全嘅訊息。",
	...
	"selectWorld.backupQuestion.snapshot": "你確定想載入此世界？",
	...
	"selectWorld.backupWarning.snapshot": "此世界最後遊玩版本為 %s，你當前版本為 %s。請先備份以避免世界損壞！",
