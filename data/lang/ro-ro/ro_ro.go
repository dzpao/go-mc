...
var Map = map[string]string{
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Mergi pe zăpadă afânată...fără să te scufunzi în ea",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Pune un spirit auxiliar să lase un tort la un bloc muzical",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Cântecul zilei de naștere",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Primește obiecte aduse de un spirit auxiliar",
	...
	"advancements.husbandry.leash_all_frog_variants.title": "Când echipa ajunge în oraș",
	...
	"block.minecraft.mangrove_fence_gate": "Poartă de mangrovă",
	...
	"block.minecraft.stripped_mangrove_log": "Buștean decojit de Mangrovă",
	"block.minecraft.stripped_mangrove_wood": "Lemn de mangrovă decojită",
	...
	"block.minecraft.weathered_cut_copper_slab": "Lespede de cupru tăiată oxidată",
	...
	"chat.disabled.profile": "Chat-ul nu este permis din setările contului. Apasă din nou '%s' pentru mai multe informații",
	"chat.disabled.profile.moreInfo": "Chat-ul nu este permis din setările contului. Nu s-a putut trimite sau vizualiza mesajele.",
	"chat.editBox": "chat",
	...
	"chat.previewInput": "Apăsați [%s] pentru a previzualiza",
	"chat.queue": "[+%s rânduri în așteptare]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Acest mesaj a fost filtrat de către server.",
	"chat.tag.modified": "Acest mesaj a fost modificat de către server.",
	"chat.tag.modified.original": "Text original: %s",
	"chat.tag.not_secure": "Acest mesaj nu este sigur, ceea ce înseamnă că ar fi putut fi modificat de server",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Nu mai notifica din nou pentru acest server",
	"chatPreview.warning.content": "Previzualizarea Mesajelor Convorbirilor permite server-ului să îți vadă mesajele înainte de a fi trimise altor jucători. Asta permite unui server să trimită o previzualizare a mesajelor convorbirilor tale cu modificări personalizate și stilizare aplicată.\nComportamentul Previzualizării Mesajelor Convorbirilor poate fi schimbat în Setările Covorbirilor tale. Setarea curentă este: [%s]",
	"chatPreview.warning.title": "Acest server utilizează Previzualizare chat-ului",
	"chatPreview.warning.toast": "Acest server utilizează Funcția de Previzualizare a Chatului și îți poate vedea mesajele înainte de a le trimite altor jucători. Poți opri această funcție din Setările Chat.",
	"chatPreview.warning.toast.title": "Previzualizarea chat-ului este activată",
	...
	"commands.locate.biome.invalid": "Nu există niciun biom de tip \"%s\"",
	...
	"commands.locate.poi.invalid": "Nu există niciun punct de interes cu tipul \"%s\"",
	...
	"commands.place.template.invalid": "Nu este niciun șablon cu identitatea \"%s\"",
	...
	"death.attack.sonic_boom": "%[1]s a fost obliterat de către un țipăt încărcat sonor",
	...
	"entity.minecraft.axolotl": "Salamandră",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Defăimare, impersonare sau informații false",
	...
	"gui.abuseReport.reason.imminent_harm": "Rău iminent - Amenințarea de a face rău altora",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Rău iminent - Autoagresiune sau sinucidere",
	...
	"gui.all": "Toate",
	"gui.back": "Înapoi",
	"gui.banned.description": "%s %s Află mai multe pe acest link: %s",
	"gui.banned.description.permanent": "Contul tău este banat permanent, ceea ce înseamnă că nu mai poți juca online sau să intri în Realms.",
	...
	"gui.banned.title.permanent": "Cont banat permanent",
	"gui.banned.title.temporary": "Cont suspendat temporar",
	"gui.cancel": "Renunță",
	"gui.chatReport.comments": "Căsuța de editare a comentariilor",
	...
	"gui.chatReport.report_sent_msg": "Am primit cu succes raportul tău. Mulțumim!\n\nEchipa noastră în va revizui în cel mai scurt timp posibil.",
	...
	"gui.chatReport.send.too_many_messages": "Prea multe mesaje incluse în raportare",
	"gui.chatReport.title": "Raportați jucătorul",
	"gui.chatSelection.context": "Mesajele din jurul acestei selecții vor fi incluse pentru a oferi un context adițional",
	"gui.chatSelection.fold": "%s mesaje ascunse nerelevante",
	...
	"multiplayer.disconnect.chat_validation_failed": "Nu s-a putut valida mesajul convorbirii",
	...
	"multiplayer.disconnect.invalid_public_key": "Nu se poate analiza cheia publică de profil.",
	...
	"multiplayer.disconnect.missing_public_key": "Lipsește cheia publică de profil.\nAcest server necesită profiluri securizate.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Prea multe mesaje ale convorbirii care sunt necitite",
	...
	"multiplayer.unsecureserver.toast": "Mesajele trimise pe acest server pot fi modificat și s-ar putea să nu reflecte mesajul original",
	...
	"options.chatPreview": "Previzualizare chat-ului",
	"options.chatPreview.confirm": "În Timp Ce Se Trimite",
	"options.chatPreview.live": "În Timp Ce Se Tastează",
	"options.chatPreview.tooltip.confirm": "Dacă un server folosește Previzualizarea Mesajelor Convorbirilor: O previzualizare a convorbirii este generată doar când încerci să trimiți un mesaj care nu are o previzualizare sau așteaptă o previzualizare.\nTrimițând un mesaj necesită confirmare.",
	"options.chatPreview.tooltip.live": "Dacă un server folosește Previzualizări a Mesajelor Convorbirilor: Orice modificări aplicate mesajelor tale de un server vor fi trimise dinamic pentru previzualizare în timp ce mesajul convorbirilor este scris.",
	"options.chatPreview.tooltip.off": "Orice modificări aplicate mesajelor convorbirilor tale de un server nu vor fi previzualizate și vor fi tratate ca nesigure.",
	...
	"options.darknessEffectScale.tooltip": "Controlează cât de mult pulsează efectul Întunecos atunci când un Gardian sau un Sculk țipător ți-l oferă.",
	...
	"options.directionalAudio": "Audio direcționat",
	...
	"selectWorld.loading_list": "Se încarcă lista de lumii",
	...
	"subtitles.entity.allay.item_taken": "Alaiul ajută",
	"subtitles.entity.allay.item_thrown": "Alai Aruncă",
	...
	"subtitles.entity.axolotl.attack": "Salamandră atacă",
	"subtitles.entity.axolotl.death": "Salamandră moare",
	"subtitles.entity.axolotl.hurt": "Salamandră rănește",
	"subtitles.entity.axolotl.idle_air": "Salamandră ciripește",
	"subtitles.entity.axolotl.idle_water": "Salamandră ciripește",
	"subtitles.entity.axolotl.splash": "Salamandră stropește",
	"subtitles.entity.axolotl.swim": "Salamandra înoată",
	...
	"subtitles.entity.warden.step": "Gardianul calcă",
	...
	"subtitles.item.bucket.fill_axolotl": "Salamandră prinsă",
	...
	"subtitles.item.goat_horn.play": "Cornul de capră se aude",
