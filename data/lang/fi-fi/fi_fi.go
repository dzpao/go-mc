...
var Map = map[string]string{
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Tapa olento sculk-katalysaattorin lähellä",
	...
	"block.minecraft.sculk_catalyst": "Sculk-katalysaattori",
	...
	"chat.previewInput": "Paina [%s] esikatsellaksesi",
	"chat.queue": "[+%s riviä jonossa]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Palvelin on suodattanut tämän viestin.",
	"chat.tag.modified": "Palvelin on muokannut tätä viestiä.",
	"chat.tag.modified.original": "Alkuperäinen teksti: %s",
	"chat.tag.not_secure": "Tämä viesti ei ole suojattu, mikä tarkoittaa sitä, että palvelin saattaa olla muokannut sitä",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Älä huomauta enää tämän palvelimen kohdalla",
	"chatPreview.warning.content": "Keskustelun esikatselulla palvelin näkee viestisi ennen kuin ne lähetetään muille pelaajille. Palvelin voi myös näyttää sinulle esikatselun viesteistäsi, kun niihin on tehty mukautuksia ja teksityylin muotoiluja.\n\nKeskustelun esikatselun tilaa voi muuttaa keskusteluasetuksista. Nykyinen asetuksesi on: [%s]",
	"chatPreview.warning.title": "Tämä palvelin käyttää keskustelun esikatselua",
	"chatPreview.warning.toast": "Tämä palvelin käyttää keskustelun esikatselua ja voi nähdä viestisi ennen kuin niitä on lähetetty. Voit asettaa sen pois käytöstä keskusteluasetuksista.",
	"chatPreview.warning.toast.title": "Keskustelun esikatselu on käytössä",
	...
	"commands.locate.biome.invalid": "Täällä ei ole biomia \"%s\"",
	...
	"commands.locate.poi.invalid": "Kiinnostavaa kohdetta \"%s\" ei ole olemassa",
	...
	"commands.locate.structure.not_found": "%s tyypin rakennusta ei löytynyt läheltä",
	...
	"commands.place.feature.success": "\"%s\" asetettiin sijaintiin %s, %s, %s",
	...
	"death.attack.arrow": "%[1]s ammuttiin kuoliaaksi %[2]s toimesta",
	"death.attack.arrow.item": "%[1]s ammuttiin kuoliaaksi %[2]s toimesta käyttämällä %[3]s",
	...
	"death.attack.onFire.item": "%[1]s paloi poroksi taistellessaan %[2]s vastaan, joka käytti asetta %[3]s",
	...
	"death.attack.sonic_boom.item": "%[1]s tuhoutui ääniaallon voimasta yrittäessään paeta olentoa %[2]s, joka käytti asetta %[3]s",
	"death.attack.sonic_boom.player": "%[1]s tuhoutui ääniaallon voimasta yrittäessään paeta olentoa %[2]s",
	...
	"death.attack.sting.item": "%[2]s pisteli pelaajan %[1]s kuoliaaksi käyttäessään asetta %[3]s",
	...
	"death.attack.witherSkull": "%[1]s ammuttiin kuoliaaksi kallolla %[2]s toimesta",
	"death.attack.witherSkull.item": "%[2]s ampui kallolla pelaajan %[1]s käyttäessään asetta %[3]s",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Joku puhuu lapsiin liittyvästä sopimattomasta käyttäytymisestä tai kannustaa siihen.",
	...
	"gui.abuseReport.reason.false_reporting": "Väärä ilmoittaminen",
	...
	"gui.abuseReport.reason.title": "Valitse ilmoituksen kategoria",
	"gui.abuseReport.send.error_message": "Ilmoituksesi lähettämisessä ilmeni virhe:\n'%s'",
	...
	"gui.abuseReport.send.json_error": "Ilmoituksesi lähettämisessä havaittiin virheellistä tietosisältöä.",
	...
	"gui.banned.description.reason": "Olemme vastaanottaneet ilmoituksen käyttäjätilisi huonosta käytöksestä. Moderaattorimme ovat nyt tarkastaneet tapauksesi ja todenneet sen kuuluvan kategoriaan %s, joka on Minecraftin yhteisöstandardien vastaista.",
	...
	"gui.banned.description.unknownreason": "Olemme vastaanottaneet ilmoituksen käyttäjätilisi huonosta käytöksestä. Moderaattorimme ovat nyt tarkastaneet tapauksesi ja todenneet sen olevan Minecraftin yhteisöstandardien vastaista.",
	"gui.banned.title.permanent": "Tili estetty pysyvästi",
	"gui.banned.title.temporary": "Tili jäädytetty väliaikaisesti",
	"gui.cancel": "Peruuta",
	"gui.chatReport.comments": "Kommenttien muokkauslaatikko",
	"gui.chatReport.describe": "Yksityiskohtien jakaminen voi auttaa meitä tekemään paras mahdollinen valinta.",
	...
	"gui.chatReport.discard.return": "Jatka muokkausta",
	...
	"gui.chatReport.selected_chat": "%s viesti(ä) valittu ilmoitettavaksi",
	"gui.chatReport.send": "Lähetä ilmoitus",
	"gui.chatReport.send.comments_too_long": "Lyhennä kommenttia",
	"gui.chatReport.send.no_reason": "Valitse ilmoituksen kategoria",
	...
	"gui.socialInteractions.report": "Ilmoita pelaaja",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Tästä pelaajasta ei voi ilmoittaa, koska hänen keskusteluviestejään ei ole todennettu tällä palvelimella",
	...
	"multiplayer.disconnect.invalid_public_key": "Profiilin julkisen avaimen jäsentäminen ei onnistunut.",
	...
	"multiplayer.disconnect.missing_public_key": "Profiilin julkinen avain puuttuu.\nTämä palvelin vaatii suojattuja profiileja.",
	...
	"options.chatPreview": "Keskustelun esikatselu",
	"options.chatPreview.confirm": "Lähettäessä",
	"options.chatPreview.live": "Kirjoittaessa",
	"options.chatPreview.tooltip.confirm": "Jos palvelin käyttää keskustelun esikatselua: Esikatselu luodaan vain, kun yritetään lähettää viestiä, jossa ei ole esikatselua tai joka odottaa esikatselua.\nViestin lähettäminen vaatii vahvistuksen.",
	"options.chatPreview.tooltip.live": "Jos palvelin käyttää keskustelun esikatselua: Palvelimen viesteihisi tekemät muutokset lähetetään esikatseltaviksi samalla, kun viestiä kirjoitetaan.",
	"options.chatPreview.tooltip.off": "Palvelimen viesteihisi tekemiä muutoksia ei esikatsella, ja niitä pidetään suojaamattomina.",
	...
	"options.prioritizeChunkUpdates.none.tooltip": "Läheiset lohkot ovat koottuna rinnakkaisiin ketjuihin. Tämä saattaa johtaa hetkellisiin näkyviin aukkoihin kuutioita rikottaessa.",
	...
	"subtitles.block.sculk_catalyst.bloom": "Sculk-katalysaattori kukkii",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Papukaija kuorsaa",
	...
	"title.32bit.deprecation": "32-bittinen järjestelmä havaittu: tämä voi estää sinua pelaamasta tulevaisuudessa, koska 64-bittinen vaaditaan!",
