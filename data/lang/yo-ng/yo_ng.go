...
var Map = map[string]string{
	...
	"advancements.husbandry.make_a_sign_glow.description": "Ṣe awọn ọrọ ti a Sign alábá",
	...
	"chat.disabled.profile": "Iwiregbe awọn eto iroyin. Tẹ '%s' lẹẹkansi fun alaye diẹ sii",
	...
	"chatPreview.warning.check": "Maṣe fi si mimọ lẹẹkansi fun olupin yii",
	"chatPreview.warning.title": "Oluṣe yii nlo awotẹlẹ iwiregbe",
	"chatPreview.warning.toast.title": "Awore iwiregbe ti ṣiṣẹ",
	...
	"commands.locate.biome.invalid": "Ko si biome pẹlu iru \"%s\"",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Awọn oogun tabi oti",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Ẹnikan n gba awọn ẹlomiran niyanju lati jẹ apakan ni awọn iṣẹ ti o ni arufin tabi iwuri lati mu mimu.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Ilokulo ọmọ tabi ilokulo",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Ẹnikan n sọrọ nipa tabi bibẹẹkọ ti n ṣe igbelaruge ihuwasi aitọ lọwọ awọn ọmọde.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Deframation, imputè, tabi alaye eke",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Ẹnikan ti ba awọn orukọ ẹgan ti elomiran ba ara laaye, bi ẹni pe o jẹ ẹnikan ti wọn ko, tabi pinpin alaye eke pẹlu ero lati lohun tabi ṣi lọna awọn miiran.",
	"gui.abuseReport.reason.description": "Apejuwe:",
	"gui.abuseReport.reason.false_reporting": "Ijabọ eke",
	"gui.abuseReport.reason.harassment_or_bullying": "Tipatipa tabi ipanilaya",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Ẹnikan ti n sá, ikọlu, tabi ipanilaya iwọ tabi ẹlomiran. Eyi pẹlu nigbati ẹnikan ba gbiyanju lati kan si ọ tabi ẹlomiran laisi aṣẹ tabi ifiweranṣẹ alaye ti ara ẹni nipa rẹ tabi ẹlomiran laisi aṣẹ (\"Duxing\").",
	"gui.abuseReport.reason.hate_speech": "Ọrọ ikorira",
	"gui.abuseReport.reason.hate_speech.description": "Ẹnikan ti kọlu iwọ tabi ẹrọ orin miiran ti o da lori awọn abuda ti idanimọ wọn, bii ẹsin, ere ije, tabi ibalopọ.",
	"gui.abuseReport.reason.imminent_harm": "Ipa ti o daju - irokeke ewu lati ṣe ipalara fun awọn miiran",
	"gui.abuseReport.reason.imminent_harm.description": "Ẹnikan n ṣe idẹruba lati ṣe ipalara fun ọ tabi ẹnikan miiran ninu igbesi aye gidi.",
	"gui.abuseReport.reason.narration": "%s: %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "A ko ni ede ti ko ni oye",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Ẹnikan n sọrọ nipa, pinpin, tabi bibẹẹkọ gbega ikọkọ ati awọn aworan ti komọmi.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Ipalara ti o daju - ipalara ara ẹni tabi igbẹmi ara ẹni",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Ẹnikan n ṣe idẹruba lati ṣe ipalara fun ara wọn ni igbesi aye gidi tabi sọrọ nipa ipalara ara wọn ni igbesi aye gidi.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Ipanilaya tabi ipanilara iwa-ipa",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Ẹnikan n sọrọ nipa, igbega, tabi idẹruba lati ṣe awọn iṣe ti ipanilaya tabi ẹsin iwa-ipa fun oselu, ti ẹsin, o le jẹ idi miiran.",
	"gui.abuseReport.reason.title": "Yan ẹka ijabọ",
	"gui.abuseReport.send.error_message": "A ti da aṣiṣe pada lakoko ti o firanṣẹ ijabọ rẹ: %s",
	"gui.abuseReport.send.generic_error": "Konge aṣiṣe airotẹlẹ lakoko fifi ijabọ rẹ ranṣẹ.",
	"gui.abuseReport.send.service_unavailable": "Ko lagbara lati de ọdọ iṣẹ ijabọ abuse. Jọwọ rii daju pe o ti sopọ si Intanẹẹti ki o gbiyanju lẹẹkansii.",
	"gui.abuseReport.sending.title": "Fifiranṣẹ ijabọ rẹ...",
	"gui.abuseReport.sent.title": "Ijabọ ti a firanṣẹ",
	"gui.advancements": "Awọn ilosiwaju",
	"gui.all": "Todas",
	"gui.back": "Pada",
	"gui.cancel": "Fagilee",
	"gui.chatReport.comments": "Apoti ṣiṣatunkọ apoti",
	"gui.chatReport.describe": "Awọn alaye pinpin yoo ṣe iranlọwọ fun wa lati ṣe ipinnu alaye daradara.",
	"gui.chatReport.discard.content": "Ti o ba lọ, o padanu ijabọ yii ati awọn asọye rẹ.\nṢe o da ọ loju pe o fẹ lati lọ kuro?",
	"gui.chatReport.discard.discard": "Fi silẹ ati ijabọ naa",
	"gui.chatReport.discard.return": "Tẹsiwaju ṣiṣatunkọ",
	"gui.chatReport.discard.title": "Jọrọ Jọrun ati Awọtiasọye?",
	"gui.chatReport.more_comments": "Jọwọ ṣe apejuwe ohun ti o ṣẹlẹ:",
	"gui.chatReport.observed_what": "Kini idi ti o ṣe ijabọ eyi?",
	"gui.chatReport.read_info": "Kọ ẹkọ nipa ijabọ",
	"gui.chatReport.report_sent_msg": "A ti ṣaṣeyọri gba ijabọ rẹ ni ifijišẹ. E dupe!\n\nẸgbẹ wa yoo ṣe ayẹwo ni kete bi o ti ṣee.",
	"gui.chatReport.select_chat": "Yan awọn ifiranṣẹ iwiregbe lati jabo",
	"gui.chatReport.select_reason": "Yan ẹka ijabọ",
	"gui.chatReport.selected_chat": "%s Ifiranṣẹ iwiregbe (s) ti a yan lati jabo",
	"gui.chatReport.send": "Firanṣẹ ijabọ",
	"gui.chatReport.send.comments_too_long": "Jọwọ kuru ọrọ naa",
	"gui.chatReport.send.no_reason": "Jọwọ yan Ẹya ijabọ kan",
	"gui.chatReport.send.no_reported_messages": "Jọwọ yan o kere ju ifiranṣẹ iwiregbe kan lati jabo",
	"gui.chatReport.send.too_many_messages": "Gbiyanju lati fi ọpọlọpọ awọn ifiranṣẹ pọ si ni ijabọ naa",
	"gui.chatReport.title": "Ijabọ player %s",
	"gui.chatSelection.heading": "%s %s",
	"gui.days": "%s ọjọ (awọn)",
	"gui.done": "Ti ṣee",
	"gui.down": "Si isalẹ",
	"gui.entity_tooltip.type": "A oriṣi:%s",
	"gui.hours": "%s wakati(s)",
	"gui.minutes": "%s iseju(s)",
	...
	"gui.socialInteractions.narration.report": "Ṣe ijabọ ẹrọ orin kan %s",
	"gui.socialInteractions.narration.show": "Ṣe afihan awọn ifiranṣẹ lati %s",
	"gui.socialInteractions.report": "Ijabọ",
	...
	"gui.socialInteractions.tooltip.report": "Ṣe ijabọ ẹrọ orin kan",
	"gui.socialInteractions.tooltip.show": "Fi awọn ifiranṣẹ han",
	...
	"instrument.minecraft.ponder_goat_horn": "Iwo",
	...
	"item.minecraft.disc_fragment_5.desc": "Orin Orin - 5",
	...
	"item.minecraft.music_disc_5": "Disiki Orin",
	"item.minecraft.music_disc_5.desc": "Samueli Åberg - 5",
	...
	"item.minecraft.recovery_compass": "Isimi imularada",
	...
	"multiplayer.disconnect.invalid_public_key": "Ko lagbara lati forse Profaili profaili profaili.",
	...
	"multiplayer.disconnect.missing_public_key": "Monomono alagbato Warden. ",
	...
	"options.chatPreview": "Awotẹlẹ iwiregbe",
	...
	"subtitles.entity.allay.death": "Allay O ku",
	"subtitles.entity.allay.hurt": "Allay o dun",
	"subtitles.entity.allay.item_given": "Alay chortles",
	"subtitles.entity.allay.item_taken": "Allay allys",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Awọn iṣapẹẹrẹ Parrot",
