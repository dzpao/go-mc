...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.title": "Schleichn 100",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Es vatalt si",
	...
	"advancements.adventure.spyglass_at_dragon.description": "Betrocht an Enderdroch duarch a Binoggl",
	...
	"advancements.adventure.spyglass_at_parrot.description": "Betrocht an Popagei duarch a Binoggl",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Geh auf Puifaschnee, ohne drin zu vasinkn",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Loss an Hüfsgeist an Kuachn ba an Notnblock oblegn",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Loss den Text von an Schüd leichtn",
	...
	"block.minecraft.mangrove_log": "Mangrovnhoiz",
	...
	"block.minecraft.ochre_froglight": "Ockanes Froschlicht",
	...
	"block.minecraft.pearlescent_froglight": "Perlmuttanes Froschlicht",
	...
	"block.minecraft.potted_mangrove_propagule": "Eingsetzter Mangrovn-Keimling",
	...
	"block.minecraft.sculk_vein": "Sculk-Ada",
	...
	"block.minecraft.stripped_mangrove_log": "Entrindets Mangrovnhoiz",
	...
	"block.minecraft.warped_slab": "Zerrstufn",
	...
	"chat.previewInput": "Drücke [%s] zur Vorschau",
	"chat.queue": "[+%s ausstehende Zeiln]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Diese Nachricht wurde vom Server gefiltert.",
	"chat.tag.modified": "Diese Nachricht wurde vom Server verändert.",
	"chat.tag.modified.original": "Ursprungstext: %s",
	"chat.tag.not_secure": "Diese Nachricht ist nicht sicher. Das heißt, sie könnte vom Server verändert worden sein.",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Für diesen Server nicht mehr benachrichtigen",
	"chatPreview.warning.content": "Die Chatvorschau ermöglicht es dem Server, deine Nachrichten zu sehen, bevor sie an andere Spieler gesendet werden. Dadurch kann der Server dir eine Vorschau deiner Chatnachrichten mit benutzerdefinierten Änderungen und Formatierungen anzeigen.\n\nDas Verhalten der Chatvorschau lässt sich in deinen Chateinstellungen ändern. Derzeitige Einstellung ist: [%s]",
	"chatPreview.warning.title": "Dieser Server verwendet die Chatvorschau",
	...
	"chatPreview.warning.toast.title": "Chatvorschau ist aktiviert",
	...
	"commands.locate.biome.invalid": "Es gib koa Biom des Typs „%s“",
	"commands.locate.biome.not_found": "Es kun koa Biom des Typs „%s“ in angmessener Entförnung gfundn werdn. ",
	"commands.locate.biome.success": "As naxte %s-Bauwerk is bei %s (%s Bleck entfernt)",
	"commands.locate.poi.invalid": "Es gib koa Zü vom Typ „%s“",
	"commands.locate.poi.not_found": "Es hod in passenda Entfernung koa Zü vom Typ „%s“ gfundn wean kina",
	"commands.locate.poi.success": "As naxte %s-Bauwerk is bei %s (%s Bleck entfernt)",
	...
	"commands.place.jigsaw.invalid": "Es gibt koa Vorlognpool vom Typ „%s“",
	...
	"commands.place.structure.invalid": "Es gib kane Struktur vom Typ \"%s\"",
	...
	"entity.minecraft.chest_boat": "Gütaboot",
	...
	"gui.abuseReport.reason.title": "Suach da a Kategorie zum Mödn aus",
	...
	"gui.cancel": "Obbrechn",
	"gui.chatReport.comments": "Kommentar-Eingobeföd",
	...
	"gui.chatReport.report_sent_msg": "Wir hom die Mödund erfolgreich angnumman. \n\nUnser Team wird sies so früh wie möglich onschaun.",
	...
	"gui.chatReport.send.no_reported_messages": "Bitte nim wenigsten a Nochricht zum Reporten",
	...
	"gui.chatSelection.fold": "%s nicht zugehörige Nachrichten versteckt",
	...
	"gui.socialInteractions.narration.show": "Zag Nochricht von %s",
	...
	"gui.socialInteractions.tooltip.hide": "Nochricht versteckn",
	...
	"gui.socialInteractions.tooltip.show": "Nochricht Onzagn",
	...
	"instrument.minecraft.ponder_goat_horn": "Üwalegn",
	"instrument.minecraft.seek_goat_horn": "Suachn",
	"instrument.minecraft.sing_goat_horn": "Singen",
	"instrument.minecraft.yearn_goat_horn": "Sehnan",
	...
	"item.minecraft.acacia_chest_boat": "Akazienhoiz-Gütaboot",
	...
	"item.minecraft.birch_chest_boat": "Birknhoiz-Gütaboot",
	...
	"item.minecraft.dark_oak_chest_boat": "Schworzoachnhoiz-Gütaboot",
	...
	"item.minecraft.jungle_chest_boat": "Tropnhoiz-Gütaboot",
	...
	"item.minecraft.mangrove_chest_boat": "Mangrovnhoiz-Gütaboot",
	...
	"item.minecraft.oak_chest_boat": "Oachnhoiz-Gütaboot",
	...
	"item.minecraft.spruce_chest_boat": "Fichtnhoiz-Gütaboot",
	...
	"multiplayer.disconnect.invalid_public_key": "Da öffentliche Schlissl vom Profü konn ned analysiert wean.",
	...
	"multiplayer.disconnect.missing_public_key": "Fehlenda öffentlicha Profüschlissl.\nDa Server erfoadat sichare Profül.",
	...
	"multiplayer.unsecureserver.toast": "Die auf diesem Server gesendeten Nachrichten könnten verändert werden und entsprechen möglicherweise nicht der ursprünglichen Nachricht.",
	...
	"options.chatPreview.confirm": "Beim Senden",
	"options.chatPreview.live": "Beim Schreiben",
	"options.chatPreview.tooltip.confirm": "Wenn ein Server Chatvorschau verwendet: Eine Chatvorschau wird nur generiert, wenn versucht wird, eine Nachricht zu senden, die keine Vorschau hat oder auf eine Vorschau wartet.\nDas Senden der Nachricht erfordert eine Bestätigung.",
	"options.chatPreview.tooltip.live": "Wenn ein Server Chatvorschau verwendet: Alle Änderungen, die von einem Server an deinen Chatnachrichten vorgenommen werden, werden dynamisch zur Vorschau gesendet, während die Chatnachricht eingegeben wird.",
	"options.chatPreview.tooltip.off": "Alle Änderungen, die von einem Server an deinen Chatnachrichten vorgenommen werden, werden nicht in der Vorschau angezeigt und als unsicher behandelt.",
	...
	"options.hideLightningFlashes.tooltip": "Verhindert Blitze den Himmel zu erhellen. The Blitze selba bleiben sichtbor.",
	...
	"options.prioritizeChunkUpdates.nearby": "Vollkommen blockiert",
	...
	"selectWorld.loading_list": "Wödlist wead glodn",
	...
	"subtitles.block.frogspawn.hatch": "Kaulquappn schliapft",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Popagei schnoabt",
	...
	"subtitles.entity.parrot.imitate.warden": "Popagei jommat",
	...
	"subtitles.entity.warden.ambient": "Wärta sempat",
	"subtitles.entity.warden.angry": "Wärta tobt",
	"subtitles.entity.warden.attack_impact": "Wärta lond an Treffa",
	...
	"subtitles.entity.warden.nearby_closer": "Wärta rückt fire",
	...
	"subtitles.entity.warden.sonic_charge": "Wärta lod auf",
	"subtitles.entity.warden.step": "Wärta lafft",
	"subtitles.entity.warden.tendril_clicks": "Wärtaranken klickn",
	...
	"subtitles.item.bundle.drop_contents": "Binkl ausglaat",
	"subtitles.item.bundle.insert": "Gegenstond eingepockt",
	"subtitles.item.bundle.remove_one": "Gegenstond ausgepockt",
	...
	"subtitles.item.goat_horn.play": "Goaßhorn spielt",
