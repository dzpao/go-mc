...
var Map = map[string]string{
	...
	"advancements.husbandry.froglights.description": "Possédez tous les types de lanterenouille dans votre inventaire",
	...
	"advancements.husbandry.silk_touch_nest.description": "Déplacez un nid d'abeilles avec 3 abeilles dedans en utilisant Toucher de soie",
	...
	"argument.enum.invalid": "Valeur \"%s\" invalide",
	...
	"biome.minecraft.deep_dark": "Profondeurs obscures",
	...
	"chat.disabled.profile": "Chat non autorisé selon les paramètres du compte.\nAppuyez de nouveau sur \"%s\" pour plus d'informations.",
	"chat.disabled.profile.moreInfo": "Chat non autorisé selon les paramètres du compte.\nImpossible d'envoyer ou de voir les messages.",
	...
	"chat.previewInput": "Appuyez sur [%s] pour un aperçu",
	...
	"chat.tag.modified.original": "Texte original : %s",
	"chat.tag.not_secure": "Ce message n'est pas sûr, ce qui veut dire qu'il a peut-être été modifié par le serveur",
	"chat.type.admin": "[%s : %s]",
	...
	"chatPreview.warning.content": "L'aperçu du chat permet au serveur de voir vos messages avant qu'ils ne soient envoyés aux autres joueurs ainsi que de vous envoyer un aperçu avec des modifications et du style personnalisés appliqués dessus.\n\nLe comportement de l'aperçu du chat peut être modifié dans les paramètres du chat. Actuellement, il est : [%s]",
	"chatPreview.warning.title": "Ce serveur utilise l'aperçu du chat",
	"chatPreview.warning.toast": "Ce serveur utilise l'aperçu du chat et peut voir vos messages avant qu'ils ne soient envoyés aux autres joueurs. Vous pouvez le désactiver dans les paramètres du chat.",
	"chatPreview.warning.toast.title": "L'aperçu du chat est activé",
	...
	"commands.locate.biome.invalid": "Il n'y a pas de biome \"%s\"",
	"commands.locate.biome.not_found": "Impossible de trouver un biome \"%s\" à une distance raisonnable",
	"commands.locate.biome.success": "Le biome \"%s\" le plus proche se situe aux coordonnées %s (%s blocs de distance)",
	"commands.locate.poi.invalid": "Il n'y a pas de point d'intérêt \"%s\"",
	"commands.locate.poi.not_found": "Impossible de trouver un point d'intérêt \"%s\" à une distance raisonnable",
	"commands.locate.poi.success": "Le point d'intérêt \"%s\" le plus proche se situe aux coordonnées %s (%s blocs de distance)",
	...
	"commands.locate.structure.success": "La structure \"%s\" la plus proche se situe aux coordonnées %s (%s blocs de distance)",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Quelqu'un vous encourage ou encourage d'autres personnes à participer à des activités illégales liées à la drogue, ou encourage des mineurs à consommer de l'alcool.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Diffamation, usurpation d'identité ou fausse information",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Quelqu'un porte atteinte à votre réputation ou à celle de quelqu'un d'autre, prétend passer pour quelqu'un qu'il n'est pas ou partage de fausses informations dans le but d'exploiter ou de tromper les autres.",
	...
	"gui.abuseReport.send.error_message": "Une erreur a été renvoyée lors de l'envoi de votre signalement :\n\"%s\"",
	...
	"gui.abuseReport.send.service_unavailable": "Impossible de rejoindre le service de signalement d'abus. Veuillez vous assurer d'être connecté(e) à Internet puis réessayez.",
	"gui.abuseReport.sending.title": "Envoi de votre signalement...",
	"gui.abuseReport.sent.title": "Signalement envoyé",
	"gui.acknowledge": "Assumer",
	"gui.advancements": "Progrès",
	"gui.all": "Toutes",
	"gui.back": "Retour",
	"gui.banned.description": "%s\n\n%s\n\nConsultez le lien suivant pour en savoir plus : %s",
	"gui.banned.description.permanent": "Votre compte est banni définitivement, ce qui veut dire que vous ne pouvez plus jouer en ligne ou rejoindre des Realms.",
	"gui.banned.description.reason": "Nous avons récemment reçu un signalement pour mauvaise conduite sur votre compte. Nos modérateurs ont examiné votre cas et l'a identifié comme étant un cas de \"%s\", ce qui va à l'encontre des normes communautaires de Minecraft.",
	"gui.banned.description.reason_id": "Code : %s",
	"gui.banned.description.reason_id_message": "Code : %s - %s",
	"gui.banned.description.temporary": "%s D'ici là, vous ne pouvez pas jouer en ligne ou rejoindre des Realms.",
	"gui.banned.description.temporary.duration": "Votre compte est temporairement suspendu et sera réactivé dans %s.",
	"gui.banned.description.unknownreason": "Nous avons récemment reçu un signalement pour mauvaise conduite sur votre compte. Nos modérateurs ont examiné votre cas et ont identifié qu'il va à l'encontre des normes communautaires de Minecraft.",
	...
	"gui.chatReport.send": "Envoyer un signalement",
	"gui.chatReport.send.comments_too_long": "Veuillez raccourcir vos commentaires",
	...
	"gui.chatSelection.fold": "%s message(s) sans rapport caché(s)",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Ce joueur ne peut pas être signalé parce que ses messages dans le chat ne peuvent pas être vérifiés sur ce serveur",
	...
	"multiplayer.disconnect.chat_validation_failed": "Échec de la validation de messages du chat",
	...
	"multiplayer.disconnect.invalid_public_key": "Impossible de faire l'analyse syntaxique de la clé publique du profil.",
	...
	"multiplayer.disconnect.unsigned_chat": "Paquet de chat reçu avec une signature manquante ou invalide.",
	...
	"multiplayer.unsecureserver.toast.title": "Les messages du chat ne peuvent pas être vérifiés",
	...
	"options.chatPreview": "Aperçu du chat",
	"options.chatPreview.confirm": "À l'envoi",
	"options.chatPreview.live": "À la saisie",
	"options.chatPreview.tooltip.confirm": "Si un serveur utilise l'aperçu du chat, un aperçu du chat est uniquement généré lors de la tentative d'envoi d'un message qui n'a pas d'aperçu ou qui est en attente d'un aperçu.\nL'envoi du message requiert une confirmation.",
	"options.chatPreview.tooltip.live": "Si un serveur utilise l'aperçu du chat, toute modification appliquée à vos messages par le serveur sera dynamiquement envoyée en tant qu'aperçu au fur et à mesure que vous les tapez.",
	"options.chatPreview.tooltip.off": "Toute modification appliquée à vos messages par un serveur n'aura pas d'aperçu et ceux-ci seront considérés comme non sécurisés.",
	"options.chunks": "%s c.",
	...
	"options.directionalAudio.on.tooltip": "Utilise l'audio directionnel basé sur la HRTF pour améliorer la simulation de la spatialisation sonore. Requiert du matériel audio compatible avec la HRTF. Utilisez un casque audio pour une expérience optimale.",
	...
	"options.onlyShowSecureChat.tooltip": "Affiche uniquement les messages des autres joueurs qui peuvent être vérifiés d'avoir bien été envoyés par ces joueurs et n'ont pas été modifiés.",
	...
	"subtitles.block.sculk.charge": "Bulles de sculk",
	...
	"title.multiplayer.disabled.banned.permanent": "Votre compte est suspendu définitivement du jeu en ligne",
