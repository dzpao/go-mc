...
var Map = map[string]string{
	...
	"chat.previewInput": "Tryck på [%s] för att förhandsgranska",
	"chat.queue": "[+%s väntande rader]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Detta meddelande har filtrerats av servern.",
	"chat.tag.modified": "Detta meddelande har modifierats av servern.",
	"chat.tag.modified.original": "Originaltext: %s",
	"chat.tag.not_secure": "Detta meddelande är inte säkert, vilket innebär att det kan ha modifierats av servern",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Visa inte igen för den här servern",
	"chatPreview.warning.content": "Förhandsgranskad chatt låter servern se dina meddelanden innan de skickas till andra spelare. Detta låter servern skicka en förhandsgranskning av dina chattmeddelanden till dig med anpassade modifikationer och tillämpad formatering.\n\nI chattinställningarna kan du ändra beteendet hos förhandsgranskad chatt. Nuvarande inställning: [%s]",
	"chatPreview.warning.title": "Den här servern använder förhandsgranskad chatt",
	"chatPreview.warning.toast": "Den här servern använder förhandsgranskad chatt och kan se dina meddelanden innan de skickas till andra spelare. Du kan inaktivera detta i chattinställningarna.",
	"chatPreview.warning.toast.title": "Förhandsgranskad chatt är aktiverad",
	...
	"commands.locate.biome.invalid": "Det finns ingen biom med typen \"%s\"",
	...
	"commands.locate.poi.invalid": "Det finns ingen intressepunkt med typen \"%s\"",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Förtal, identitetsstöld eller spridning av desinformation",
	...
	"gui.abuseReport.reason.imminent_harm": "Överhängande skada - Hot om att skada andra",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Överhängande skada - Självskadebeteende eller självmord",
	...
	"gui.cancel": "Avbryt",
	"gui.chatReport.comments": "Redigeringsfält för kommentarer",
	...
	"gui.chatReport.read_info": "Läs mer om hur anmälningar fungerar",
	...
	"gui.chatReport.selected_chat": "%s chattmeddelanden att anmäla har markerats",
	"gui.chatReport.send": "Skicka anmälan",
	"gui.chatReport.send.comments_too_long": "Var god korta ned kommentaren",
	...
	"gui.chatSelection.fold": "%s orelaterade meddelanden har dolts",
	...
	"multiplayer.disconnect.invalid_public_key": "Kunde inte tolka profilens offentliga nyckel.",
	...
	"multiplayer.disconnect.missing_public_key": "Profilens offentliga nyckel saknas.\nDen här servern kräver säkrade profiler.",
	...
	"options.chatPreview": "Förhandsgr. chatt",
	"options.chatPreview.confirm": "Bekräfta",
	"options.chatPreview.live": "I realtid",
	"options.chatPreview.tooltip.confirm": "Om förhandsgranskad chatt används på en server: En förhandsgranskning av chatten kommer endast genereras när ett meddelande som saknar eller väntar på en förhandsgranskning försöker skickas.\nEtt godkännande krävs för att meddelandet ska skickas.",
	"options.chatPreview.tooltip.live": "Om förhandsgranskad chatt används på en server: Alla modifikationer som servern tillämpar på dina chattmeddelanden kommer att skickas dynamiskt för att förhandsgranskas samtidigt som meddelandet skrivs.",
	"options.chatPreview.tooltip.off": "Alla modifikationer som en server tillämpar på dina chattmeddelanden kommer inte att förhandsgranskas och behandlas som osäkra.",
	...
	"selectWorld.backupWarning.downgrade": "Denna värld spelades senast i version %s och du använder version %s. Om en värld nedgraderas kan den bli korrupt - vi kan inte garantera att den kommer att ladda eller fungera. Skapa en säkerhetskopia om du fortfarande vill fortsätta!",
