...
var Map = map[string]string{
	...
	"advancements.husbandry.leash_all_frog_variants.title": "Από Πού Ξεπήδησε η Ομάδα;",
	...
	"argument.double.big": "Ο πραγματικός διπλής ακρίβειας δεν μπορεί να είναι πάνω από %s, βρέθηκε η τιμή %s",
	"argument.double.low": "Ο πραγματικός διπλής ακρίβειας δεν μπορεί να είναι κάτω από %s, βρέθηκε η τιμή %s",
	...
	"argument.float.big": "Ο πραγματικός απλής ακρίβειας δεν μπορεί να είναι πάνω από %s, βρέθηκε η τιμή %s",
	"argument.float.low": "Ο πραγματικός απλής ακρίβειας δεν μπορεί να είναι κάτω από %s, βρέθηκε η τιμή %s",
	...
	"block.minecraft.potted_azure_bluet": "Αζουρία σε Γλάστρα",
	...
	"chat.previewInput": "Πατήστε [%s] για προεπισκόπηση",
	"chat.queue": "[+%s εκκρεμείς γραμμές]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Αυτό το μήνυμα έχει φιλτραριστεί από τον διακομιστή.",
	"chat.tag.modified": "Αυτό το μήνυμα έχει τροποποιηθεί από τον διακομιστή.",
	"chat.tag.modified.original": "Αρχικό κείμενο: %s",
	"chat.tag.not_secure": "Αυτό το μήνυμα δεν είναι προστατευμένο, το οποίο σημαίνει ότι μπορεί να έχει τροποποιηθεί από τον διακομιστή",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Να μη γίνει ειδοποίηση ξανά για αυτόν τον διακομιστή",
	"chatPreview.warning.content": "Η Προεπισκόπηση Συνομιλίας επιτρέπει τον διακομιστή να δει τα μηνύματά σας πριν αυτά σταλθούν σε άλλους παίκτες. Αυτό επιτρέπει έναν διακομιστή να σας στείλει μια προεπισκόπηση των μηνυμάτων συνομιλίας σας με εφαρμοσμένες προσαρμοσμένες τροποποιήσεις και στιλ.\n\nΗ συμπεριφορά της Προεπισκόπησης Συνομιλίας μπορεί να αλλάξει στις Ρυθμίσεις Συνομιλίας σας. Η τρέχουσα ρύθμιση είναι: [%s]",
	"chatPreview.warning.title": "Αυτός ο διακομιστής χρησιμοποιεί Προεπισκόπηση Συνομιλίας",
	"chatPreview.warning.toast": "Αυτός ο διακομιστής χρησιμοποιεί Προεπισκόπηση Συνομιλίας και μπορεί να δει τα μηνύματά σας πριν αυτά σταλθούν σε άλλους παίκτες. Μπορείτε να το απενεργοποιήσετε αυτό στις Ρυθμίσεις Συνομιλίας.",
	"chatPreview.warning.toast.title": "Η Προεπισκόπηση Συνομιλίας είναι ενεργοποιημένη",
	...
	"commands.clear.success.multiple": "Καταργήθηκαν %s αντικείμενα από %s παίκτες",
	"commands.clear.success.single": "Καταργήθηκαν %s αντικείμενα από τον παίκτη %s",
	...
	"commands.locate.biome.invalid": "Δεν υπάρχει τοπίο με τύπο «%s»",
	"commands.locate.biome.not_found": "Δε βρέθηκε τοπίο τύπου «%s» σε λογική απόσταση",
	"commands.locate.biome.success": "Η κοντινότερη δομή %s είναι στη θέση %s (%s κύβοι μακριά)",
	"commands.locate.poi.invalid": "Δεν υπάρχει σημείο ενδιαφέροντος με τύπο «%s»",
	"commands.locate.poi.not_found": "Δε βρέθηκε σημείο ενδιαφέροντος τύπου «%s» σε λογική απόσταση",
	"commands.locate.poi.success": "Η κοντινότερη δομή %s είναι στη θέση %s (%s κύβοι μακριά)",
	...
	"commands.schedule.cleared.success": "Καταργήθηκαν %s προγραμματισμοί με αναγνωριστικό %s",
	...
	"death.attack.badRespawnPoint.message": "Ο παίκτης/το ον %[1]s σκοτώθηκε από τον %[2]s",
	...
	"death.attack.hotFloor.player": "Ο παίκτης/το ον %[1]s μπήκε σε επικίνδυνη ζώνη εξαιτίας του παίκτη/του όντος %[2]s",
	...
	"death.fell.assist": "Ο παίκτης/το ον %[1]s ήταν καταδικασμένος/η να πέσει από τον παίκτη/το ον %[2]s",
	"death.fell.assist.item": "Ο παίκτης/το ον %[1]s ήταν καταδικασμένος/η να πέσει από τον παίκτη/το ον %[2]s που χρησιμοποιούσε το αντικείμενο %[3]s",
	...
	"death.fell.killer": "Ο παίκτης/το ον %[1]s ήταν καταδικασμένος/η να πέσει",
	...
	"demo.day.1": "Αυτή η δοκιμή θα διαρκέσει πέντε ημέρες παιχνιδιού, κάντε ό,τι μπορείτε!",
	...
	"demo.demoExpired": "Τέλος χρόνου δοκιμής!",
	"demo.help.buy": "Αγορά Τώρα!",
	"demo.help.fullWrapped": "Αυτή η έκδοση δοκιμής θα διαρκέσει 5 ημέρες εντός παιχνιδιού (περίπου 1 ώρα και 40 λεπτά πραγματικού χρόνου). Δείτε τις εξελίξεις για καθοδήγηση! Καλή διασκέδαση!",
	...
	"demo.help.title": "Λειτουργία Δοκιμής Minecraft",
	"demo.remainingTime": "Χρόνος που απομένει: %s",
	"demo.reminder": "Ο χρόνος δοκιμής έχει λήξει. Αγοράστε το παιχνίδι για να συνεχίσετε ή ξεκινήστε έναν νέο κόσμο!",
	...
	"entity.minecraft.elder_guardian": "Πρεσβύτερος Φρουρός",
	...
	"entity.minecraft.guardian": "Φρουρός",
	...
	"flat_world_preset.minecraft.tunnelers_dream": "Όνειρο του Μεταλλωρύχου",
	...
	"gui.cancel": "Ακύρωση",
	"gui.chatReport.comments": "Πλαίσιο επεξεργασίας σχολίων",
	...
	"gui.chatReport.report_sent_msg": "Λάβαμε την αναφορά σας με επιτυχία. Ευχαριστούμε!\n\nΗ ομάδα μας θα την εξετάσει το συντομότερο δυνατόν.",
	...
	"gui.chatSelection.fold": "%s μη σχετικά μηνύματα αποκρύφτηκαν",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "Ο παίκτης %s είπε: %s στις %s",
	"gui.chatSelection.selected": "%s/%s μήνυμα/μηνύματα",
	...
	"instrument.minecraft.sing_goat_horn": "Άσμα",
	...
	"key.keyboard.unknown": "Μη δεσμευμ.",
	...
	"menu.playdemo": "Παιχνίδι Κόσμου Δοκιμής",
	...
	"menu.resetdemo": "Επαναφορά Κόσμου Δοκιμής",
	...
	"multiplayer.disconnect.banned.expiration": "\nΟ αποκλεισμός σας θα καταργηθεί στις %s",
	...
	"multiplayer.disconnect.invalid_public_key": "Δεν ήταν δυνατή η ανάλυση του δημοσίου κλειδιού προφίλ.",
	...
	"multiplayer.disconnect.missing_public_key": "Λείπει το δημόσιο κλειδί προφίλ.\nΑυτός ο διακομιστής απαιτεί προστατευμένα προφίλ.",
	...
	"options.chat.delay": "Καθυστ. Συνομιλίας: %s δευτ.",
	...
	"options.chatPreview": "Προεπισκόπηση",
	"options.chatPreview.confirm": "Σε Αποστολή",
	"options.chatPreview.live": "Ανά Πλήκτρο",
	"options.chatPreview.tooltip.confirm": "Αν ένας διακομιστής χρησιμοποιεί Προεπισκοπήσεις Συνομιλίας: Μια προεπισκόπηση συνομιλίας δημιουργείται μόνο όταν προσπαθήσετε να στείλετε ένα μήνυμα που δεν έχει μια προεπισκόπηση ή αναμένει μια προεπισκόπηση.\nΗ αποστολή του μηνύματος απαιτεί επιβεβαίωση.",
	"options.chatPreview.tooltip.live": "Αν ένας διακομιστής χρησιμοποιεί Προεπισκοπήσεις Συνομιλίας: Οποιαδήποτε τροποποίηση εφαρμοστεί στα μηνύματα συνομιλίας σας από έναν διακομιστή θα στέλνεται δυναμικά για προεπισκόπηση καθώς πληκτρολογείται το μήνυμα συνομιλίας.",
	"options.chatPreview.tooltip.off": "Οποιαδήποτε τροποποίηση εφαρμοστεί στα μηνύματα συνομιλίας σας από έναν διακομιστή δε θα προεπισκοπηθεί και θα αντιμετωπιστεί ως μη προστατευμένη.",
	...
	"options.darknessEffectScale.tooltip": "Ελέγχει πόσο η επίδραση Σκότους πάλλεται όταν ένας Φύλακας ή Κράχτης Σκαλκ την προκαλεί σε εσάς.",
	...
	"options.narrator.all": "Όλων",
	"options.narrator.chat": "Συνομιλίας",
	"options.narrator.notavailable": "Μη Διαθέσιμος",
	"options.narrator.off": "ΟΧΙ",
	"options.narrator.system": "Συστήματος",
	"options.off": "ΟΧΙ",
	...
	"options.onlyShowSecureChat": "Μόνο Προστατ. Συνομ.",
	...
	"selectWorld.createDemo": "Παιχνίδι Νέου Κόσμου Δοκιμής",
	...
	"subtitles.entity.elder_guardian.ambient": "Πρεσβύτερος Φρουρός βογκάει",
	"subtitles.entity.elder_guardian.ambient_land": "Πρεσβύτερος Φρουρός φτερουγίζει",
	"subtitles.entity.elder_guardian.curse": "Πρεσβύτερος Φρουρός καταριέται",
	"subtitles.entity.elder_guardian.death": "Πρεσβύτερος Φρουρός πεθαίνει",
	"subtitles.entity.elder_guardian.flop": "Πρεσβύτερος Φρουρός σπαρταράει",
	"subtitles.entity.elder_guardian.hurt": "Πρεσβύτερος Φρουρός τραυματίζεται",
	...
	"subtitles.entity.guardian.ambient": "Φρουρός βογκάει",
	"subtitles.entity.guardian.ambient_land": "Φρουρός φτερουγίζει",
	"subtitles.entity.guardian.attack": "Φρουρός στοχεύει",
	"subtitles.entity.guardian.death": "Φρουρός πεθαίνει",
	"subtitles.entity.guardian.flop": "Φρουρός σπαρταράει",
	"subtitles.entity.guardian.hurt": "Φρουρός τραυματίζεται",
