...
var Map = map[string]string{
	...
	"advancements.adventure.fall_from_world_height.description": "Rơi tự do từ đỉnh thế giới (giới hạn xây dựng) xuống đáy thế giới và sống sót",
	...
	"advancements.end.dragon_breath.description": "Thu thập hơi thở của rồng vào trong một chai thủy tinh",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Hãy để Allay thả một cái bánh kem lên cái khối nốt nhạc",
	...
	"advancements.husbandry.axolotl_in_a_bucket.description": "Bắt một con Axolotl vào trong một cái xô",
	...
	"advancements.story.mine_stone.description": "Đào đá với cây cúp mới của bạn",
	...
	"advancements.story.upgrade_tools.description": "Chế tạo một cái cúp tốt hơn",
	...
	"chat.previewInput": "Nhấn [%s] để xem trước",
	"chat.queue": "[+%s dòng đang chờ xử lí]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Tin nhắn này đã được lọc bởi máy chủ.",
	"chat.tag.modified": "Thông báo này đã được sửa đổi bởi máy chủ.",
	"chat.tag.modified.original": "Văn bản gốc: %s",
	"chat.tag.not_secure": "Tin nhắn này không bảo mật, điều này có nghĩa là nó có thể đã được thay đổi bởi máy chủ",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Không thông báo lại cho máy chủ này",
	"chatPreview.warning.content": "Xem trước trò chuyện cho phép máy chủ xem tin nhắn của bạn trước khi chúng được gửi đến những người chơi khác. Điều này cho phép máy chủ gửi cho bạn bản xem trước các tin nhắn trò chuyện của bạn với các sửa đổi và kiểu dáng tùy chỉnh được áp dụng.\n\nHành vi Xem trước trò chuyện có thể được thay đổi trong Cài đặt trò chuyện của bạn. Cài đặt hiện tại là: [%s]",
	"chatPreview.warning.title": "Máy chủ này sử dụng Xem trước Trò chuyện",
	"chatPreview.warning.toast": "Máy chủ này sử dụng Xem trước Trò chuyện và có thể xem tin nhắn của bạn khi bạn nhập chúng, ngay cả trước khi chúng được gửi đi. Bạn có thể tắt tính năng này trong Cài đặt Trò Chuyện.",
	"chatPreview.warning.toast.title": "Xem trước Trò chuyện đã được bật",
	...
	"commands.locate.biome.invalid": "Không có quần xã nào thuộc loại \"%s\"",
	...
	"commands.locate.poi.invalid": "Không có điểm quan tâm nào với loại \"%s\"",
	...
	"commands.place.jigsaw.failed": "Không thể đặt jigsaw",
	"commands.place.jigsaw.invalid": "Không có nhóm mẫu nào thuộc loại \"%s\"",
	"commands.place.jigsaw.success": "Đã tạo jigsaw tại %s, %s, %s",
	...
	"gui.abuseReport.reason.imminent_harm": "Nguy hại sắp xảy ra - Đe dọa làm hại những người khác",
	"gui.abuseReport.reason.imminent_harm.description": "Ai đó đang đe dọa làm hại bạn hoặc người khác ngoài đời thật.",
	...
	"gui.cancel": "Hủy bỏ",
	"gui.chatReport.comments": "Hộp chỉnh sửa nhận xét",
	...
	"gui.chatReport.discard.discard": "Rời đi và hủy bỏ báo cáo",
	...
	"gui.chatReport.send.comments_too_long": "Hãy rút ngắn bình luận",
	"gui.chatReport.send.no_reason": "Hãy chọn danh mục báo cáo",
	"gui.chatReport.send.no_reported_messages": "Vui lòng chọn ít nhất một tin nhắn trò chuyện để báo cáo",
	...
	"gui.chatSelection.fold": "Đã ẩn %s tin nhắn không liên quan",
	...
	"gui.socialInteractions.tooltip.report.disabled": "Dịch vụ tố cáo không có sẵn",
	"gui.socialInteractions.tooltip.report.no_messages": "Không có tin nhắn báo cáo được từ người chơi %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Người chơi này không thể bị báo cáo, vì tin nhắn của họ không thể xác nhận được trên máy chủ này",
	...
	"multiplayer.disconnect.invalid_public_key": "Không thể giải khóa công khai của tài khoản.",
	...
	"multiplayer.disconnect.missing_public_key": "Không tìm thấy mã khóa công khai.\nMáy chủ này yêu cầu các tài khoản bảo mật.",
	...
	"multiplayer.unsecureserver.toast.title": "Tin nhắn trò chuyện không thể được kiểm duyệt",
	...
	"options.chatPreview": "Xem trước trò chuyện",
	"options.chatPreview.confirm": "Khi gửi",
	"options.chatPreview.live": "Khi soạn tin",
	"options.chatPreview.tooltip.confirm": "Nếu máy chủ sử dụng Xem trước trò chuyện: Bản xem trước chỉ được hiển thị khi gửi một tin nhắn chưa được xem trước hoặc đang chờ để xem trước. Cần xác nhận để gửi tin nhắn.",
	"options.chatPreview.tooltip.live": "Nếu máy chủ sử dụng Xem trước trò chuyện: Mọi sửa đổi từ máy chủ áp dụng lên tin nhắn của bạn sẽ được gửi để xem trước một cách tự động khi nhắn tin.",
	"options.chatPreview.tooltip.off": "Mọi sửa đổi do máy chủ áp dụng lên đoạn trò chuyện của bạn sẽ không được xem trước và sẽ bị coi là không bảo mật.",
	...
	"options.onlyShowSecureChat": "Chỉ hiển thị tin nhắn an toàn",
	...
	"options.prioritizeChunkUpdates": "Trình tạo miếng đất",
	...
	"title.32bit.deprecation": "Đã phát hiện hệ thống 32 bit: điều này có thể ngăn bạn chơi trong tương lai vì hệ thống 64 bit sẽ được yêu cầu!",
