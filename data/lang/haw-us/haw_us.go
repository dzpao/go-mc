...
var Map = map[string]string{
	...
	"chatPreview.warning.check": "Mai hoʻolaha hou no kēia kikowaena",
	"chatPreview.warning.toast.title": "Hoʻohana ʻia ka Nāmua Kūkākūkā",
	...
	"commands.locate.biome.success": "Aia ka %s kokoke loa ma %s (%s palaka aku)",
	"commands.locate.poi.success": "Aia ka %s kokoke loa ma %s (%s palaka aku)",
	...
	"item.minecraft.music_disc_5": "Pā hoʻokani",
	...
	"options.chatPreview": "Namua kamaʻilio",
	...
	"selectWorld.backupQuestion.snapshot": "Anei oe maoli makemake i ke kiʻi i keia honua?",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Ke hohō nei ka Manu Aloha",
