...
var Map = map[string]string{
	...
	"advancements.husbandry.leash_all_frog_variants.title": "Når banden hopper i byen",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Brug et bål til at indsamle honning fra en bikube ved hjælp af en flaske uden at irritere bierne",
	...
	"chat.disabled.profile": "Chat er ikke tilladt i kontoindstillingerne. Tryk '%s' for at få mere information",
	"chat.disabled.profile.moreInfo": "Chat er ikke tilladt i kontoindstillingerne. Beskeder kan hverken ses eller sendes.",
	"chat.editBox": "chat",
	"chat.filtered_full": "Denne server har skjult din besked for nogle spillere.",
	...
	"chat.previewInput": "Tryk [%s] for forevisning",
	"chat.queue": "[+%s afventende linjer]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Denne besked er blevet filtreret af serveren.",
	"chat.tag.modified": "Denne besked er blevet ændret af serveren.",
	"chat.tag.modified.original": "Oprindelig tekst: %s",
	"chat.tag.not_secure": "Denne besked er ikke sikret, hvilket betyder at den kan have været ændret af serveren",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Giv ikke besked igen for denne server",
	"chatPreview.warning.content": "Chat-forhåndsvisninger giver serveren mulighed for at se dine beskeder, før de sendes til andre spillere. Dette giver en server mulighed for at sende dig en forhåndsvisning af dine chatbeskeder med tilpassede ændringer og stil anvendt.\n\nChat Preview-adfærden kan ændres i dine chat-indstillinger. Nuværende indstilling er: [%s]",
	"chatPreview.warning.title": "Denne server bruger Chat-forhåndsvisning",
	"chatPreview.warning.toast": "Denne server anvender Chat-forhåndsvisning og kan se dine beskeder før de bliver sendt til andre spillere. Du kan slå dette fra i Chatindstillinger.",
	"chatPreview.warning.toast.title": "Chat-forhåndsvisning er slået til",
	...
	"commands.locate.biome.invalid": "Der er intet biom med type \"%s\"",
	...
	"commands.locate.poi.invalid": "Der er intet interessepunkt med typen \"%s\"",
	...
	"disconnect.loginFailedInfo.userBanned": "Du er udelukket fra at spille online",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Nogen skader en andens omdømme, lader som om de er en person de ikke er, eller deler falsk information med mål om at udnytte eller vildlede andre.",
	...
	"gui.abuseReport.reason.harassment_or_bullying.description": "Nogen skænder, angriber, eller mobber dig eller en anden. Dette omfatter også når nogen gentageligt prøver at kontakte dig eller en anden uden samtykke eller opslår privat personlig information om dig eller en anden uden samtykke (\"doxing\").",
	...
	"gui.abuseReport.reason.imminent_harm": "Kommende skade – Trussel om at skade andre",
	...
	"gui.abuseReport.send.error_message": "En fejl blev returneret under leveringen af din anmeldelse: \n'%s'",
	...
	"gui.abuseReport.send.json_error": "Stødte på misdannet data under sendingen af din rapport.",
	"gui.abuseReport.send.service_unavailable": "Kunne ikke sende misbrugsrapporter service. Venligst være sikker på du har forbindelse til internet og prøv igen.",
	...
	"gui.all": "Alle",
	"gui.back": "Tilbage",
	"gui.banned.description": "%s\n\n%s\n\nLær mere via det følgende link: %s",
	"gui.banned.description.permanent": "Din konto er spærret permanent, hvilket betyder at du ikke kan spille online eller hoppe på Realms mere.",
	"gui.banned.description.reason": "Vi har for nyligt modtaget en anmeldelse angående upassende opførsel af din konto. Vores moderatorer har nu gennemgået din sag og identificeret den som %s, hvilket er mod Minecraft-fællesskabsstandarderne.",
	"gui.banned.description.reason_id": "Kode: %s",
	"gui.banned.description.reason_id_message": "Kode: %s - %s",
	"gui.banned.description.temporary": "%s Indtil da så kan du ikke spille online eller hoppe på Realms.",
	"gui.banned.description.temporary.duration": "Din konto er spærret midlertidigt og vil blive genaktiveret om %s.",
	...
	"gui.banned.title.permanent": "Konto er permanent udelukket",
	"gui.banned.title.temporary": "Konto er midlertidigt spærret",
	"gui.cancel": "Annuller",
	...
	"gui.chatReport.report_sent_msg": "Vi har modtaget din anmeldelse. Tak!\n\nVores team vil gennemgå den så snart som muligt.",
	...
	"gui.chatReport.send.no_reported_messages": "Venligst vælg mindst én chatbesked at rapportere",
	"gui.chatReport.send.too_many_messages": "Prøver at inkludere for mange beskeder i anmeldelsen",
	"gui.chatReport.title": "Anmeld spiller",
	"gui.chatSelection.context": "Beskederne omkring dette valg bliver inkluderet for at give ekstra kontekst",
	"gui.chatSelection.fold": "%s ikke relaterede beskeder skjult",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Denne spiller kan ikke anmeldes, da deres chatbeskeder ikke kan bekræftes på denne server",
	...
	"multiplayer.disconnect.invalid_public_key": "Kan ikke fortolke offentlig profilnøgle.",
	...
	"multiplayer.disconnect.missing_public_key": "Offentlig profilnøgle mangler.\nDenne server kræver sikre profiler.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Den modtagne chat-pakke virker ikke. Har din systemtid ændret sig?",
	...
	"multiplayer.disconnect.too_many_pending_chats": "For mange ikke-erkendte chatbeskeder",
	...
	"multiplayer.unsecureserver.toast.title": "Chatbeskeder kan ikke godkendes",
	...
	"options.chatPreview": "Chat-forhåndsvisning",
	"options.chatPreview.confirm": "Når det bliver sendt",
	"options.chatPreview.live": "Imens der bliver tastet",
	"options.chatPreview.tooltip.confirm": "Hvis en server bruger Chat-forhåndsvisninger: En chat-forhåndsvisning genereres kun, når du forsøger at sende en besked, der ikke har en forhåndsvisning eller venter på en forhåndsvisning.\nAfsendelse af beskeden kræver bekræftelse.",
	"options.chatPreview.tooltip.live": "Hvis en server anvender chat-forevisninger: Enhver ændring påført dine chatbeskeder vil blive sendt, dynamisk, til forevisning mens chatbeskeden bliver tastet ind.",
	"options.chatPreview.tooltip.off": "Enhver ændring af en server på dine chatbeskeder bliver ikke forvist og bliver anset som usikre.",
