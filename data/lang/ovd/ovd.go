...
var Map = map[string]string{
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Wavel ą̊ ien sniųdett... auto te sikk nið",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Bruk jäldn fer te sambel in onundjin frą̊ bikupun og bruk ien putell autǫ te froð upp bią",
	...
	"chat.disabled.profile": "Instellningger i tjattem djär du dug it bruk tjattn ny. Tryttj '%s' et nyes fer te fą̊ informasiuon",
	...
	"chat.previewInput": "Tryttj ą̊ [%s] fer te sjå i förand",
	"chat.queue": "[+%s räðir so baiðer]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Detta meddelande har filtrerats av servern.",
	"chat.tag.modified": "Ittað-jär mieðdielend ir endrað ov servern.",
	"chat.tag.modified.original": "Origanltekst: %s",
	"chat.tag.not_secure": "Ittað-jär mieðdielend ir it säkert, og eð bityðer eð kan wårå endrað åv servern",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Wais int ittað fer servern noð mier",
	...
	"chatPreview.warning.title": "Issn-jär servern kuoger ą̊ tjattą i förweg",
	...
	"chatPreview.warning.toast.title": "Chat Preview ir aktivirað",
	...
	"commands.locate.biome.invalid": "Eð ir it nog miljö ov typn \"%s\"",
	"commands.locate.biome.not_found": "Dug it finn ien miljö ov typn \"%s\" i nerietn",
	"commands.locate.biome.success": "Nemmest %s ir nest %s (%s blokk laingger brott)",
	...
	"commands.locate.poi.success": "Nemmest %s ir nest %s (%s blokk laingger brott)",
	...
	"commands.place.structure.invalid": "Eð ir int indjin struktur sos \"%s\"",
	...
	"gui.chatReport.comments": "Redisjiringslåð fer kommentarer",
	...
	"gui.chatSelection.fold": "%s mieðdield so int ärer juot iro gemder",
	...
	"item.minecraft.music_disc_5": "Musikstjiv",
	...
	"multiplayer.disconnect.invalid_public_key": "Dugd it tolk proofilemes offentlig nytjyl.",
	...
	"multiplayer.disconnect.missing_public_key": "Issn-jär profilemes offentlig nytjyl fätäs. Issnjär servern fą̊r luv åvå ien säker profil.",
	...
	"options.chatPreview": "Förandskuoge ą̊ tjatt",
	"options.chatPreview.confirm": "Mes du sender",
	"options.chatPreview.live": "Męs du skriever",
	...
	"options.chatPreview.tooltip.off": "Oll enndringger sos ien server djär ą̊ tjattmieðdielander daina\n werd inte kontrolliraðer og får luv saias wårå ųosäkrer.",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Papigåj fnåiser",
