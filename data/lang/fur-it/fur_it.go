...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Nol esist un biome di gjenar \"%s\"",
	"commands.locate.biome.not_found": "Impussibil cjatâ il biome di gjenar \"%s\" dentri di une distance resonevule",
	"commands.locate.biome.success": "La struture di gjenar %s plui dongje e je in %s (%s tocs di distance)",
	"commands.locate.poi.success": "La struture di gjenar %s plui dongje e je in %s (%s tocs di distance)",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Pampagal al sbrufe come piglin",
