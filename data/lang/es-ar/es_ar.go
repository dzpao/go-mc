...
var Map = map[string]string{
	...
	"advancements.adventure.shoot_arrow.description": "Dispará a algo con una flecha",
	...
	"advancements.adventure.spyglass_at_dragon.description": "Observa con un catalejo al Enderdragón",
	...
	"advancements.adventure.spyglass_at_parrot.description": "Observa a un loro con un catalejo",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Caminá arriba de nieve en polvo... sin hundirte",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Hacé que un allay lance una torta a un bloque musical",
	...
	"argument.enum.invalid": "Valor «%s» inválido",
	...
	"chat.disabled.profile": "El chat está desactivado por los ajustes de tu cuenta. Apretá «%s» de nuevo para ver más información",
	...
	"chat.previewInput": "Apretá [%s] para previsualizar",
	"chat.queue": "[+%s mensajes en espera]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Este mensaje ha sido filtrado por el servidor.",
	"chat.tag.modified": "Este mensaje ha sido modificado por el servidor.",
	"chat.tag.modified.original": "Texto original: %s",
	"chat.tag.not_secure": "Este mensaje no es seguro, lo que significa que puede haber sido modificado por el servidor",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "No volver a notificar en este servidor",
	"chatPreview.warning.content": "La vista previa del chat le permite al servidor ver tus mensajes antes de que sean enviados a otros jugadores. Esto le permite al servidor mostrarte cómo quedará tu mensaje al aplicarle modificaciones de estilo.\n\nLa vista previa del chat puede ser ajustada en los ajustes del chat. La configuración actual es: [%s]",
	"chatPreview.warning.title": "Este servidor usa la vista previa del chat",
	...
	"chatPreview.warning.toast.title": "La vista previa del chat está activada",
	...
	"commands.advancement.advancementNotFound": "No se encontró ningún progreso llamado «%[1]s»",
	...
	"commands.locate.biome.invalid": "No existe el bioma «%s»",
	...
	"commands.locate.poi.invalid": "No hay ningún punto de interés de tipo «%s»",
	...
	"death.attack.sonic_boom.item": "%[1]s Fue acabado por un grito cargado sónicamente tratando de escapar de %[2]s usando %[3]s",
	...
	"disconnect.loginFailedInfo.invalidSession": "La sesión no es válida (reiniciá el juego y el lanzador)",
	...
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Alguien está amenazando a lastimar a sí mismo o hablando sobre hacerlo en la vida real.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorismo o extremismo violento",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Alguien está hablando, obligando o amenazando cometer malos actos o de extrema violencia por motivos políticos, religiosos, ideológicos o cualquier otra índole.",
	...
	"multiplayer.disconnect.invalid_public_key": "No es posible leer la clave pública del perfil.",
	...
	"multiplayer.disconnect.missing_public_key": "No se pudo encontrar la clave pública del perfil.\nEste servidor requiere un perfil seguro.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Demasiados mensajes desconocidos en el chat",
	...
	"options.chatPreview": "Vista previa del chat",
	"options.chatPreview.confirm": "Al enviar",
	"options.chatPreview.live": "Al escribir",
	"options.chatPreview.tooltip.confirm": "Si un servidor utiliza la vista previa del chat, la misma solo se mostrará al intentar enviar un mensaje que no tiene o está esperando una vista previa.\nEnviar el mensaje requiere una confirmación.",
	"options.chatPreview.tooltip.live": "Si un servidor utiliza la vista previa del chat, cualquier modificación aplicada a tus mensajes será enviada dinámicamente para que puedas ver el mensaje mientras lo escribís.",
	"options.chatPreview.tooltip.off": "Cualquier modificación que el servidor le aplique a tus mensajes de chat no será previsualizada y se la tratará como insegura.",
