...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "Промъкнете се близо до Скълк сензор или Надзирателя за да не ви открият",
	...
	"chat.editBox": "чат",
	"chat.filtered_full": "Сървърът скри твойто съобщение за някой играчи.",
	...
	"chat.previewInput": "Натиснете [%s] за предварителен преглед",
	"chat.queue": "[+%s чакащи редове]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "Това съобщение е променено на сървъра.",
	"chat.tag.modified.original": "Оригинален текст: %s",
	"chat.tag.not_secure": "Това съобщение не е безопасно, което означава, че може да е било променено от сървъра",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Без повече предупреждения за този сървър",
	"chatPreview.warning.content": "Предварителният изглед на чата позволява на сървъра да види вашите съобщения преди те да бъдат изпратени до други играчи. Това позволява на даден сървър да ви изпраща предварителен изглед на вашите чат съобщения с персонализирани промени и приложено оформление.\n\nРежимът на работа на предварителния изглед на чата може да бъде променен във вашите Чат Настройки. Текущата настройка е: [%s]",
	"chatPreview.warning.title": "Този сървър използва Предварителен преглед на съобщенията",
	"chatPreview.warning.toast": "Този сървър ползва Предварителен преглед на съобщенията и може да получава съдържанието на съобщенията ви преди да бъдат изпратени. Можете да изключите това в настройките за чат.",
	"chatPreview.warning.toast.title": "Предварителният преглед на съобщенията е включен",
	...
	"commands.locate.biome.invalid": "Няма терен с тип \"%s\"",
	...
	"commands.locate.poi.invalid": "Няма обект на интерес от тип \"%s\" в разумна дистанция",
	...
	"gui.abuseReport.reason.description": "Описване:",
	...
	"gui.abuseReport.reason.hate_speech": "Реч на омразата",
	...
	"gui.banned.title.temporary": "Профилът е едновременно спрян",
	"gui.cancel": "Отказ",
	"gui.chatReport.comments": "Поле за коментари",
	"gui.chatReport.describe": "Добавянето на детайли ще ни помогне да вземем по точни решения.",
	"gui.chatReport.discard.content": "Ако затвориш страницата ще загубиш този доклад и твоите коментари. Сигурен ли си че искаш да затвориш?",
	...
	"gui.chatReport.more_comments": "Моля обяснете какво се е случило:",
	"gui.chatReport.observed_what": "Защо докладвате това?",
	"gui.chatReport.read_info": "Научете повече за докладване",
	"gui.chatReport.report_sent_msg": "Успешно получихме вашето докладване. Благодарим!\n\nЕкипът ни ще го разгледа възможно по-скоро.",
	"gui.chatReport.select_chat": "Изберете съобщението за доклад",
	"gui.chatReport.select_reason": "Изберете категория за доклад",
	"gui.chatReport.selected_chat": "%s Съобщение(я) Избрани за Доклада",
	"gui.chatReport.send": "Изпрати доклад",
	...
	"gui.chatSelection.fold": "%s несвързани съобщения скрити",
	...
	"gui.socialInteractions.report": "Подаване на сигнал",
	...
	"multiplayer.disconnect.invalid_public_key": "Разчитането на публичния криптографски ключ на профила бе неуспешно.",
	...
	"multiplayer.disconnect.missing_public_key": "Липсващ публичен криптографски ключ на профила.\nТози сървър изисква подсигурени профили.",
	...
	"multiplayer.disconnect.unsigned_chat": "Получен апкет за чат с пропуснат или инвалиден потпис.",
	...
	"options.chatPreview": "Предварителен преглед на съобщенията",
	"options.chatPreview.confirm": "При изпращане",
	"options.chatPreview.live": "При въвеждане на текст",
	"options.chatPreview.tooltip.confirm": "Ако сървърът използва визуализация на чата: визуализацията на чата се създава само когато се опитате да изпратите съобщение, което няма визуализация или чака визуализация.\nЗа изпращане на съобщението е необходимо потвърждение.",
	"options.chatPreview.tooltip.live": "Ако сървърът използва визуализация на чата: всички промени, направени от сървъра във вашите чат съобщения, ще бъдат динамично изпратени за предварителен преглед, докато пишете съобщението в чата.",
	"options.chatPreview.tooltip.off": "Всякакви промени, приложени върху вашите чат съобщения от даден сървър, няма да бъдат преглеждани и ще бъдат третирани като небезопасни.",
	...
	"options.darknessEffectScale.tooltip": "Контролира силата на пулсиране от ефекта на зтъмняване, когато е получен от Надзирател или Скълк ларинкс.",
	...
	"selectWorld.conversion.tooltip": "Този свят трябва да бъде отворен с по-стара версия (например 1.6.4), за да бъде безопасно преместен",
	...
	"subtitles.entity.parrot.imitate.warden": "Папагала хленчи",
	...
	"subtitles.entity.warden.agitated": "Надзирател пъшка гневно",
	"subtitles.entity.warden.ambient": "Надзирател хленчи",
	"subtitles.entity.warden.angry": "Надзирател се ядосва",
	"subtitles.entity.warden.attack_impact": "Надзирателя прави удар",
	...
	"subtitles.entity.warden.sonic_charge": "Надзирател се появява",
	...
	"title.multiplayer.disabled.banned.permanent": "Вашият акаунт е временно спрян от онлайн игра",
