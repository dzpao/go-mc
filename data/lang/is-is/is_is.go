...
var Map = map[string]string{
	...
	"advancements.adventure.trade_at_world_height.description": "Verslaðu við þorpsbúa við eftir mörk heims",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Ganga á púðursnjó... án þess að sökkva í hann",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Láta hjálpara skilja eftir köku við nótnablokk",
	...
	"advancements.husbandry.complete_catalogue.description": "Temdu öll kattar afbrigði!",
	...
	"advancements.story.iron_tools.description": "Upfærðu Hakan þinn",
	...
	"block.minecraft.mangrove_button": "Fenjaviðarhnappur",
	"block.minecraft.mangrove_door": "Leiruviðarhurð",
	"block.minecraft.mangrove_fence": "Fenjaviðargirðing",
	"block.minecraft.mangrove_fence_gate": "Fenjaviðarhlið",
	...
	"block.minecraft.mangrove_pressure_plate": "Þrýstihella úr fenjaviði",
	"block.minecraft.mangrove_propagule": "Leiruviðaræxlikorn",
	"block.minecraft.mangrove_roots": "Leiruviðarrætur",
	"block.minecraft.mangrove_sign": "Fenjaviðarskilti",
	"block.minecraft.mangrove_slab": "Fenjaviðarhella",
	"block.minecraft.mangrove_stairs": "Fenjaviðartröppur",
	"block.minecraft.mangrove_trapdoor": "Fenjaviðarhleri",
	"block.minecraft.mangrove_wall_sign": "Fenjaviðarskilti á vegg",
	...
	"block.minecraft.mud_brick_slab": "Leirsteins hella",
	...
	"block.minecraft.muddy_mangrove_roots": "Moldugar leiruviðarrætur",
	...
	"chat.previewInput": "Ýttu á [%s] til þess að forskoða",
	"chat.queue": "[+%s línur í bið]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Þessi skilaboð hafa verið síuð á netþjóninum.",
	"chat.tag.modified": "Þessum skilaboðum hefur verið breytt á netþjóninum.",
	"chat.tag.modified.original": "Upphaflegur texti: %s",
	"chat.tag.not_secure": "Þessi skilaboð eru ekki örugg, sem þýðir að þeim gæti hafa verið breytt á netþjóninum",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Ekki tilkynna aftur fyrir þennan netþjón",
	"chatPreview.warning.content": "Spjallforskoðun gerir netþjóni kleift að sjá skilaboðin þín áður en þau eru send til annarra leikmanna. Þetta gerir netþjóninum kleift að senda þér sýnishorn af spjallskilaboðunum þínum með sérsniðnum breytingum og stíl\n\nHægt er að breyta hegðun spjallforskoðunar í spjallstillingunum þínum. Núverandi stilling er: [%s]",
	"chatPreview.warning.title": "Þessi netþjónn notar Forskoðun spjalls",
	"chatPreview.warning.toast": "Þessi netþjónn notar Forskoðun spjalls og getur séð skilaboð þín áður en þau eru send til annarra spilara. Þú getur slökkt á þessu í Stillingum spjalls.",
	"chatPreview.warning.toast.title": "Forskoðun spjalls er virk",
	...
	"commands.locate.biome.invalid": "Það er ekkert vistkerfi af gerðinni \"%s\"",
	...
	"commands.locate.poi.invalid": "Það finnst ekkert áhugavert af gerð \"%s\"",
	...
	"generator.minecraft.normal": "Upprunaleg landslagsmyndun",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Fíkniefni eða áfengi",
	...
	"gui.chatReport.comments": "Reitur fyrir athugasemdir",
	"gui.chatReport.describe": "Nánar upplýsingar sem þú deilir hjálpar okkur að taka upplýsta ákvörðun.",
	...
	"gui.chatReport.more_comments": "Vinsamlegast lýstu því hvað gerðist:",
	...
	"gui.chatSelection.fold": "%s ótengd skilaboð falin",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s sagði: %s á %s",
	"gui.chatSelection.selected": "%s/%s skilaboð valið(in)",
	"gui.chatSelection.title": "Veldu Spjallskilaboð til þess að tilkynna",
	...
	"gui.socialInteractions.report": "Tilkynning",
	...
	"gui.socialInteractions.tooltip.report.no_messages": "Engin skilaboð sem þarf að tilkynna frá spilara %s",
	...
	"gui.up": "Upp",
	"gui.yes": "Já",
	"instrument.minecraft.admire_goat_horn": "Dá",
	...
	"item.minecraft.disc_fragment_5": "Brot af diski",
	...
	"item.minecraft.mangrove_boat": "Fenjaviðarbátur",
	...
	"item.minecraft.music_disc_5": "Vínýll",
	...
	"menu.playerReporting": "Spilara tilkynning",
	...
	"multiplayer.disconnect.invalid_public_key": "Get ekki þáttað dreifilykil prófíls.",
	...
	"multiplayer.disconnect.missing_public_key": "Dreifilykill prófíls vantar. Öruggir prófílar eru nauðsynlegir á þessum netþjóni.",
	...
	"options.chatPreview": "Forskoðun spjalls",
	"options.chatPreview.confirm": "Þegar þú sendir",
	"options.chatPreview.live": "Meðan á vélritun stendur",
	"options.chatPreview.tooltip.confirm": "Ef netþjónn notar spjallforskoðun: Spjallforskoðun er aðeins búin til þegar reynt er að senda skilaboð sem eru ekki með forskoðun eða bíða eftir forskoðun.\nTil að senda skilaboðin þarf staðfestingu.",
	"options.chatPreview.tooltip.live": "Ef netþjónn notar spjallforskoðun: Muna allar breytingar sem netþjónn beitir á spjallskilaboðin þín verða send á virkan hátt til forskoðunar þegar spjallskilaboðin eru slegin inn.",
	"options.chatPreview.tooltip.off": "Allar breytingar sem netþjónn beitir á spjallskilaboðin þín verða ekki forskoðuð og meðhöndluð sem óörugg.",
	...
	"options.difficulty.online": "Villa hjá netþjóni",
	...
	"subtitles.block.sculk.charge": "Skálkur bullar",
	"subtitles.block.sculk.spread": "Skálkur dreifist",
