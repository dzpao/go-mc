...
var Map = map[string]string{
	...
	"chat.previewInput": "Druk op [%s] om voorvertoning te zien",
	"chat.queue": "[+%s regels in d'n wachtrij]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Dit bericht is geblokkeerd door de server.",
	"chat.tag.modified": "Dit bericht is aangepast door de server.",
	"chat.tag.modified.original": "Originele tekst: %s",
	"chat.tag.not_secure": "Dit bericht is niet beveiligd, wat betekent dat de server deze misschien heeft aangepast",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Niet opnieuw weergeven voor deze server",
	"chatPreview.warning.content": "Met chatvoorvertoning kan de server jouw berichten zien voordat ze worden verzonden naar anderen. Zo kan de server je een voorvertoning laten zien van je chatberichten met toegepaste wijzigingen en opmaak.\n\nHet gedrag van chatvoorvertoning kan worden aangepast in je chatinstellingen. De huidige instelling is: [%s]",
	"chatPreview.warning.title": "Deze server gebruikt chatvoorvertoning",
	"chatPreview.warning.toast": "Deze server gebruikt chatvoorvertoning. Hierdoor kan het jouw berichten zien voordat ze naar andere spelers gestuurd worden. Dit kun je uitschakelen in de chatinstellingen.",
	"chatPreview.warning.toast.title": "Chatvoorvertoning is ingeschakeld",
	...
	"commands.locate.biome.invalid": "Der ies ginne klimaat meej ut type \"%s\"",
	...
	"commands.locate.poi.invalid": "Herkenningspunt '%s' bestaat niet",
	...
	"death.attack.onFire.item": "%[1]s werd levend verbrand tijdens het vechten tegen %[2]s hanterende %[3]s",
	...
	"gui.abuseReport.send.error_message": "Fout teruggestuurd bij het verzenden van je melding:\n'%s'",
	...
	"gui.chatReport.comments": "Opmerkingenbewerkvak",
	...
	"gui.chatSelection.fold": "%s ongerelateerde berichten verborgen",
	...
	"gui.socialInteractions.tooltip.report.no_messages": "%s heeft geen berichten die kunnen worden gemeld",
	"gui.socialInteractions.tooltip.report.not_reportable": "Deze speler kan niet worden gemeld omdat deze geen verifieerbare chatberichten heeft verzonden op deze server",
	...
	"item.minecraft.music_disc_5": "Meziekplôat",
	...
	"multiplayer.disconnect.invalid_public_key": "Lezen van openbare profielsleutel mislukt.",
	...
	"multiplayer.disconnect.missing_public_key": "Openbare profielsleutel ontbreekt.\nDeze server vereist beveiligde profielen.",
	...
	"options.chatPreview": "Chatvoorvertoning",
	"options.chatPreview.confirm": "bij verzenden",
	"options.chatPreview.live": "tijdens typen",
	"options.chatPreview.tooltip.confirm": "Indien een server chatvoorvertoningen gebruikt: de voorvertoning wordt pas gegenereerd wanneer je een bericht verzendt waar nog geen voorvertoning voor klaar staat.\nHet verzenden van berichten vereist een bevestiging.",
	"options.chatPreview.tooltip.live": "Indien een server chatvoorvertoningen gebruikt: er wordt dynamisch een voorvertoning gegenereerd terwijl het bericht wordt getypt als de server wijzigingen op je chatberichten toepast.",
	"options.chatPreview.tooltip.off": "Eventuele wijzigingen die de server op je chatberichten toepast, worden niet meegenomen in de voorvertoning en worden als onveilig beschouwd.",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Pappegoi snèùft",
