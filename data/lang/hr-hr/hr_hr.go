...
var Map = map[string]string{
	...
	"advancements.husbandry.make_a_sign_glow.description": "Osvijetli tekst na znaku",
	"advancements.husbandry.make_a_sign_glow.title": "Čak i svijetli u mraku!",
	"advancements.husbandry.netherite_hoe.description": "Upotrijebi netheritsku polugu da nadogradiš motiku, a onda preispitaj svoje životne odluke",
	...
	"advancements.husbandry.silk_touch_nest.description": "Premjesti pčelinje gnijezdo s tri pčele unutra rabeći dodir svile",
	...
	"advancements.story.form_obsidian.description": "Prikupi blok opsidijana",
	...
	"block.minecraft.packed_mud": "Črvsto blato",
	...
	"chat.previewInput": "Pritisni [%s] za pretpregled",
	"chat.queue": "[+%s redaka na čekanju]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Ovu poruku filtrirao je poslužitelj.",
	"chat.tag.modified": "Ovu poruku izmijenio je poslužitelj.",
	"chat.tag.modified.original": "Izvorni tekst: %s",
	"chat.tag.not_secure": "Ova poruka nije sigurna, možda ju je izmijenio poslužitelj",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Nemoj me više obavještavati za ovaj poslužitelj",
	"chatPreview.warning.content": "Pretpregled razgovora omogućava poslužitelju da vidi tvoje poruke dok ih tipkaš. Ovo poslužitelju omogućava da ti pošalje pretpregled tvojih stilski izmijenjenih poruka.\n\nPonašanje pretpregleda razgovora može se promijeniti u postavkama razgovora. Trenutačna postavka: [%s]",
	"chatPreview.warning.title": "Ovaj poslužitelj upotrebljava pretpregled razgovora",
	"chatPreview.warning.toast": "Ovaj poslužitelj upotrebljava pretpregled razgovora i može vidjeti tvoje poruke prije nego što ih pošalješ. Ovo se može isključiti u postavkama razgovora.",
	"chatPreview.warning.toast.title": "Pretpregled razgovora omogućen",
	...
	"commands.locate.biome.invalid": "\"%s\" biom ne postoji",
	...
	"commands.locate.poi.invalid": "Točka interesa \"%s\" ne postoji",
	...
	"death.attack.onFire.item": "%[1]s je završio reš-pečen boreći se s %[2]s koji je držao %[3]s",
	...
	"death.attack.sonic_boom": "%[1]s je umro od posljedica soničkog vriska",
	"death.attack.sonic_boom.item": "%[1]s je umro od posljedica soničkog vriska dok ga je lovio %[2]s koji je držao %[3]s",
	"death.attack.sonic_boom.player": "%[1]s je umro od posljedica soničkog vriska dok ga je lovio %[2]s",
	...
	"death.attack.witherSkull.item": "%[2]s je lubanjom pogodio %[1]s koristeći %[3]s",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Blaćenje, oponašanje ili lažne informacije",
	...
	"gui.abuseReport.reason.imminent_harm": "Neposredna šteta – prijetnje o ozljeđivanju drugih",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Neposredna šteta – samoozljeđivanje ili samoubojstvo",
	...
	"gui.banned.description.permanent": "Vaš je račun trajno zabranjen, što znači da nećete moći sudjelovati u mrežnoj igri ili upotrebljavati Realms.",
	"gui.banned.description.reason": "Nedavno smo dobili prijavu o lošem ponašanju vašeg računa. Naši moderatori pregledali su vaš slučaj i odredili da je %s, što ne poštuje Minecraftove Standarde zajednice.",
	"gui.banned.description.reason_id": "Kod: %s",
	"gui.banned.description.reason_id_message": "Kod: %s – %s",
	"gui.banned.description.temporary": "%s Dotad nećete moći sudjelovati u mrežnoj igri ili upotrebljavati Realms.",
	...
	"gui.cancel": "Odustani",
	"gui.chatReport.comments": "Okvir za uređivanje komentara",
	...
	"gui.chatReport.send.comments_too_long": "Molimo skrati komentar",
	...
	"gui.chatSelection.title": "Odaberite poruke koje biste prijavili",
	"gui.days": "%s dan(a)",
	"gui.done": "Gotovo",
	"gui.down": "Dolje",
	...
	"gui.socialInteractions.narration.show": "Prikazuj poruke igrača %s",
	...
	"gui.socialInteractions.tooltip.report.disabled": "Ova usluga prijavljivanja nije dostupna",
	"gui.socialInteractions.tooltip.report.no_messages": "Nijedna poruka igrača %s ne može se prijaviti",
	"gui.socialInteractions.tooltip.report.not_reportable": "Ovoga igrača ne može se prijaviti, njegove poruke ne mogu se potvrditi na ovom poslužitelju",
	"gui.socialInteractions.tooltip.show": "Prikazuj poruke",
	...
	"multiplayer.disconnect.invalid_public_key": "Nije moguće raščlaniti javni ključ profila.",
	"multiplayer.disconnect.invalid_public_key_signature": "Nevažeći potpis za ključ javnog profila.\nPokušaj ponovno pokrenuti igru.",
	...
	"multiplayer.disconnect.missing_public_key": "Javni ključ profila nedostaje.\nOvaj poslužitelj zahtijeva sigurne profile.",
	...
	"options.chatPreview": "Pretpregled razgovora",
	"options.chatPreview.confirm": "Pri slanju",
	"options.chatPreview.live": "Pri tipkanju",
	"options.chatPreview.tooltip.confirm": "Ako poslužitelj upotrebljava pretpregled razgovora: Pretpregled razgovora generira se samo kada se pokušava poslati poruka koja nema pretpregled ili čeka pretpregled.\nSlanje poruke zahtijeva potvrdu.",
	"options.chatPreview.tooltip.live": "Ako poslužitelj upotrebljava pretpregled razgovora: Sve izmjene koje poslužitelj primijeni na poruke bit će dinamički poslane na pretpregled dok se poruka upisuje.",
	"options.chatPreview.tooltip.off": "Sve izmjene koje poslužitelj primijeni na vaše poruke neće se pregledavati i smatrat će se nesigurnima.",
