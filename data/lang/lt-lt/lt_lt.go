...
var Map = map[string]string{
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Nužudyk padarą prie skulko katalizatoriaus",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Pavaikščiokite ant pūraus sniego... jame neskęstant",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Padarykite ženklo tekstą šviečiantį",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Pasinaudokite laužu buteliuke surinkdami medų iš avilio, nesupykdydami bičių",
	...
	"block.minecraft.sculk": "Skulkas",
	"block.minecraft.sculk_catalyst": "Skulko katalizatorius",
	"block.minecraft.sculk_sensor": "Skulko sensorius",
	"block.minecraft.sculk_shrieker": "Skulko rėksnys",
	"block.minecraft.sculk_vein": "Skulko gysla",
	...
	"chat.disabled.profile": "Pokalbiai neleistini pagal paskyros nustatymus. Paspauskite %s vėl, norint gauti daugiau informacijos",
	...
	"chat.previewInput": "Norėdami peržiūrėti spauskite [%s]",
	"chat.queue": "[+%s laukiančios eilutės]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "Ši žinutė buvo modifikuota serverio.",
	"chat.tag.modified.original": "Originalus tekstas: %s",
	"chat.tag.not_secure": "Ši žinutė nėra saugi. Tai reiškia, kad ji galėjo būti pakeista serverio",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Daugiau nebeperspėti dėl šio serverio",
	"chatPreview.warning.content": "Pokalbių peržiūra leidžia serveriui matyti jūsų pranešimus prieš siunčiant juos kitiems žaidėjams. Tai leidžia serveriui atsiųsti jums pokalbių pranešimų peržiūrą su pritaikytais pasirinktiniais pakeitimais ir stiliumi.\n\n Pokalbių peržiūros elgseną galima pakeisti pokalbių nustatymuose. Dabartinis nustatymas yra:[%s]",
	"chatPreview.warning.title": "Šis serveris naudoja pokalbių peržiūrą",
	"chatPreview.warning.toast.title": "Pokalbio peržiūra įjungta",
	...
	"commands.locate.biome.invalid": "Nėra jokio %s tipo biomo",
	...
	"commands.locate.poi.invalid": "Nėra taško su tipu \"%s\"",
	...
	"commands.place.jigsaw.failed": "Nepavyko sugeneruoti detalės",
	...
	"commands.place.template.invalid": "Nėra šablono su id \"%s\"",
	...
	"death.attack.witherSkull.item": "%[1]s buvo nušauti su kaukole iš %[2]s naudojant %[3]s",
	...
	"disconnect.loginFailedInfo.userBanned": "Jums yra draudžiama žaisti tinkle",
	...
	"flat_world_preset.minecraft.classic_flat": "Klasikinis plokščias",
	"flat_world_preset.minecraft.desert": "Dykuma",
	"flat_world_preset.minecraft.overworld": "Paviršiaus pasaulis",
	"flat_world_preset.minecraft.redstone_ready": "Paruošta redstounui",
	...
	"generator.minecraft.flat": "lyguma",
	"generator.minecraft.large_biomes": "dideli biomai",
	"generator.minecraft.normal": "įprastas",
	...
	"gui.abuseReport.error.title": "Problema išsiunčiant pranešimą",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Narkotikai arba alkoholis",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Kažkas ragina kitus dalyvauti nelegaliose veiklose susijusiose su narkotikais arba ragina girtavimą nepilnamečiams.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Seksualinis vaikų išnaudojimas ar prievarta",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Kažkas kalba ar kitaip skatina nedorą elgesį su vaikais.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Šmeižtas, apsimetimas, arba klaidinga informacija",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Kažkas kenkia kažkieno kito reputacijai, apsimeta tuo, kuo jie nėra, arba dalinasi klaidinga informacija su tikslu išnaudoti arba suklaidinti kitus.",
	"gui.abuseReport.reason.description": "Aprašymas:",
	"gui.abuseReport.reason.false_reporting": "Melagingas pranešimas",
	"gui.abuseReport.reason.harassment_or_bullying": "Priekabiavimas arba patyčios",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Kas nors gėdija, puola arba kabinasi prie jūsų, ar ko nors kito. Į tai įeina ir pakartotiniai bandymai susisiekti su jumis ar kuo nors kitu be sutikimo, privačios asmeninės informacijos viešinimas apie jus ar ką nors kitą be sutikimo (\"doxina\").",
	"gui.abuseReport.reason.hate_speech": "Neapykantos kalba",
	"gui.abuseReport.reason.hate_speech.description": "Kažkas jus puola arba kitą žaidėją dėl tapatybės savybių, pvz., religijos, rasės, arba seksualumo.",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Intymūs paveikslai be pritarimo",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Kažkas kalba apie, dalinasi, arba kitaip reklamuoja privačius arba intymius paveikslus.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Neišvengiama žala - Savižala arba savižudybė",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Kažkas grasina, kad nori pakenkti sau realiame gyvenime, arba kalba apie tai kad padarys sau žalą realiame gyvenime.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terorizmas arba smurtinis ekstremizmas",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Kažkas kalba apie, skatina ar grasina vykdyti teroristinius ar smurtinio ekstremizmo aktus dėl politinių, religinių, ideologinių ar kitų paskatų.",
	"gui.abuseReport.reason.title": "Pasirinkite pranešimo kategoriją",
	"gui.abuseReport.send.error_message": "Aptikta klaida bandant išsiųsti pranešimą:\n'%s'",
	"gui.abuseReport.send.generic_error": "Aptikta netikėtą klaida siunčiant jūsų pranešimą.",
	"gui.abuseReport.send.http_error": "Netikėta HTTP klaida įvyko siunčiant jūsų pranešimą.",
	"gui.abuseReport.send.json_error": "Aptikta netinkamai suformuota apkrova siunčiant jusų pranešimą.",
	...
	"gui.abuseReport.sending.title": "Siunčiamas pranešimas...",
	"gui.abuseReport.sent.title": "Pranešimas išsiųstas",
	"gui.acknowledge": "Pripažinti",
	...
	"gui.banned.description.reason": "Mes neseniai gavome pranešimą apie nedorą elgesį iš jūsų paskyros. Mūsų moderatoriai dabar patikrino jūsų bylą ir nusprendė kad ji yra %s, tai nesilaiko Minecraft Bendruomenės Standartų.",
	...
	"gui.banned.description.temporary.duration": "Jūsų paskyra buvo laikinai uždrausta ir bus aktyvuota iš naujo %s.",
	"gui.banned.description.unknownreason": "Mes neseniai gavome pranešimą apie nedorą elgesį iš jūsų paskyros. Mūsų moderatoriai dabar patikrino jūsų bylą ir nusprendė kad ji nesilaiko Minecraft Bendruomenės Standartų.",
	"gui.banned.title.permanent": "Paskyra uždrausta visam laikui",
	"gui.banned.title.temporary": "Paskyra laikinai uždrausta",
	"gui.cancel": "Atšaukti",
	"gui.chatReport.comments": "Komentarų redagavimo dėžė",
	"gui.chatReport.describe": "Dalindamiesi informacija padėsite mums priimti gerai pagrįstą sprendimą.",
	"gui.chatReport.discard.content": "Jei išeisite, jūs prarasite šį pranešimą ir jūsų komentarus.\nAr jūs tikra(as) norite išeiti?",
	"gui.chatReport.discard.discard": "Išeiti ir atšaukti apie pranešimą",
	"gui.chatReport.discard.return": "Tęsti redagavimą",
	"gui.chatReport.discard.title": "Atšaukti pranešimą ir komentarus?",
	"gui.chatReport.more_comments": "Prašome aprašyti kas įvyko:",
	"gui.chatReport.observed_what": "Kodėl jūs pranešate tai?",
	"gui.chatReport.read_info": "Sužinoti apie pranešimus",
	"gui.chatReport.report_sent_msg": "Mes sėkmingai gavome jūsų pranešimą. Ačiū!\n\nMūsų komanda jį peržiūrės kaip galima greičiau.",
	"gui.chatReport.select_chat": "Pasirinkite kelias žinutes, norint pranešti",
	...
	"gui.chatReport.send.comments_too_long": "Patrumpinkite komentarą",
	...
	"gui.chatSelection.fold": "%s nesusijosios žinutės paslėptos",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s pasakė: %s %s",
	"gui.chatSelection.selected": "%s/%s žinutė(s) parinktos",
	"gui.chatSelection.title": "Pasirinkite pokalbo žinutes pranešimui",
	"gui.days": "%s diena(os)",
	"gui.done": "Atlikta",
	"gui.down": "Žemyn",
	...
	"gui.socialInteractions.narration.report": "Pranešti apie žaidėją %s",
	...
	"item.minecraft.disc_fragment_5": "Disko lūžena",
	...
	"menu.playerReporting": "Žaidėjas praneša",
	...
	"multiplayer.disconnect.invalid_public_key": "Nepavyko nuskaityti profilio viešojo rakto.",
	"multiplayer.disconnect.invalid_public_key_signature": "Netinkamas profilio viešo rakto parašas.\nPabandykite perkrauti savo žaidimą.",
	...
	"multiplayer.disconnect.missing_public_key": "Trūksta profilio viešojo rakto.\nŠis serveris reikalauja saugių profilių.",
	...
	"multiplayer.unsecureserver.toast": "Žinutės, išsiųstos šiame serveryje, gali būti pakeistos ir neatspindėti originalios žinutės",
	...
	"options.chatPreview": "Pokalbio peržiūra",
	"options.chatPreview.confirm": "Siunčiant",
	"options.chatPreview.live": "Rašant",
	"options.chatPreview.tooltip.confirm": "Jei serveris naudoja pokalbio peržiūrą: pokalbio peržiūra sukuriama tik bandant išsiųsti žinutę kuri neturi peržiūros arba laukia peržiūros.\nŽinutės išsiuntimas reikalauja patvirtinimo.",
	"options.chatPreview.tooltip.live": "Jei serveris naudoja pokalbio peržiūrą: visi jūsų žinutės pakeitimai atlikti serverio bus dinamiškai atsiunčiami jums berašant žinutę.",
	"options.chatPreview.tooltip.off": "Visi serverio jūsų žinutei pritaikyti pakeitimai nebus peržiūrimi ir bus laikomi nesaugiais.",
	...
	"options.darknessEffectScale.tooltip": "Valdo, kiek tamsumos efektas pulsuoja, kai jums jį suteikia komendantas ar skulko rėksnys.",
	...
	"options.fovEffectScale.tooltip": "Valdo tai, kiek regos laukas gali pakeisti žaidimo efektus.",
	...
	"subtitles.block.sculk.charge": "Skulkas burbuliuoja",
	"subtitles.block.sculk.spread": "Skulkas plečiasi",
	"subtitles.block.sculk_catalyst.bloom": "Skulko katalizatorius žydi",
	...
	"subtitles.block.sculk_shrieker.shriek": "Skulko rėksnys rėkia",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Krenkšteli papūga",
	...
	"title.multiplayer.disabled.banned.temporary": "Jūsų paskyra buvo uždrausta laikinai nuo žaidimo tinkle",
