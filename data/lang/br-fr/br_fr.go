...
var Map = map[string]string{
	...
	"commands.locate.biome.success": "Ar savadur \"%s\" tostañ a zo e %s (%s a vloc'had pellder)",
	"commands.locate.poi.success": "Ar savadur \"%s\" tostañ a zo e %s (%s a vloc'had pellder)",
