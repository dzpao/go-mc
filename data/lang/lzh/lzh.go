...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "暗度幽匿測振儀抑監守旁以免見聞",
	...
	"argument.block.tag.disallowed": "此地不可用簽，但諸實塊耳",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "蠹蝕鏨磚",
	...
	"chat.previewInput": "擊[%s]以演",
	"chat.queue": "[餘%s待發之訊]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "此議言已爲伺服器所篩。",
	"chat.tag.modified": "此議言已爲伺服器所改。",
	"chat.tag.modified.original": "原文：%s",
	"chat.tag.not_secure": "此論議有險，或是已爲伺服器所更也",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "勿再使本伺服器告",
	"chatPreview.warning.content": "演議者，伺服器可以見爾書於送前。由是則伺服器可寄戲者以既自定論議之演。\n\n演議之爲可改諸議設。今之設爲[%s]",
	"chatPreview.warning.title": "本伺服器用演議也",
	"chatPreview.warning.toast": "本伺服器用演議而可睹爾書於其未送時。子可閉之於議設。",
	"chatPreview.warning.toast.title": "演議既用",
	...
	"commands.locate.biome.invalid": "無所謂生態域「%s」",
	"commands.locate.biome.not_found": "尋生態域類「%s」於合理之距未果",
	"commands.locate.biome.success": "最邇之%s在於%s（去君%s方遠）",
	"commands.locate.poi.invalid": "無所謂所好類名「%s」者",
	"commands.locate.poi.not_found": "尋所好類「%s」於合理之距未果",
	"commands.locate.poi.success": "最邇之%s在於%s（去君%s方遠）",
	...
	"commands.place.feature.invalid": "無所謂地物類為「%s」",
	...
	"commands.place.structure.invalid": "無所謂構曰「%s」",
	...
	"datapackFailure.title": "數據囊有謬，是以阻礙天地之載入。\n或可載以原版數據囊一試「無虞之法」，或返首頁躬繕之。",
	...
	"death.attack.sonic_boom.item": "%[1]s於去持%[3]s之%[2]s之時為厲嘯所夷",
	"death.attack.sonic_boom.player": "去%[2]s之時%[1]s為厲嘯所夷",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "藥與酒",
	...
	"gui.socialInteractions.tooltip.report.disabled": "檢舉服務不可用",
	"gui.socialInteractions.tooltip.report.no_messages": "%s 無可舉奏者",
	"gui.socialInteractions.tooltip.report.not_reportable": "因伺服器弗能證其論議，檢舉戲者未成",
	...
	"multiplayer.disconnect.invalid_public_key": "不可辯其公鑰。",
	...
	"multiplayer.disconnect.missing_public_key": "公鑰有闕。\n伺服器需無虞之狀。",
	...
	"multiplayerWarning.message": "誡：衆戲者，外黨之侍者所供也，而非魔贊所有，微軟所司。 衆戲中或會不司之訊，其用者之所造亦或不宜衆。",
	...
	"options.chatPreview": "演議",
	"options.chatPreview.confirm": "方送之時",
	"options.chatPreview.live": "方鍵之時",
	"options.chatPreview.tooltip.confirm": "伺服之用演議也，演議但爲未演或欲演之議生耳。\n當復認之以送是議。",
	"options.chatPreview.tooltip.live": "伺服器之用演議也，方鍵入時即可傳伺服器所改以覧之。",
	"options.chatPreview.tooltip.off": "伺服器所改不可覧之，記爲有險也。",
	"options.chunks": "%s區塊",
	...
	"options.directionalAudio": "周回聲訊",
	"options.directionalAudio.off.tooltip": "雅衆竅和聲",
	"options.directionalAudio.on.tooltip": "用周回聲訊之本於首之屬易函數者，可補益於擬三維聲。須兼容首之屬易函數之聲訊剛器。必待耳機而後圓備。",
	...
	"subtitles.entity.puffer_fish.hurt": "河豚鯸傷",
	...
	"title.32bit.deprecation.realms": "不日，礦藝將需六十四爻系統，是將阻子嬉遊並領域之用於當設備。一切領域常書，請自除却。",
	...
	"title.multiplayer.realms": "偕戲（領域）",
