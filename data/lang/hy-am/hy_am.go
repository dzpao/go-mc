...
var Map = map[string]string{
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Սա ողջ է",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Ցուցանակի գրված տեքստը սարքեք փայլուն",
	...
	"block.minecraft.mangrove_slab": "Մանգրային սալ",
	...
	"block.minecraft.reinforced_deepslate": "Ամրապնդված խորը թերթաքար",
	...
	"chat.disabled.profile": "Հաշվի կարգավորումներով զրույցն արգելված է: Լրացուցիչ տեղեկությունների համար կրկին սեղմեք «%s»",
	...
	"chat.previewInput": "Նախադիտելու համար սեղմեք [%s]",
	"chat.queue": "[+%s տող հերթի մեջ է]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Այս հաղորդագրությունը փոփոխվել է սերվերի կողմից:",
	"chat.tag.modified": "Այս հաղորդագրությունը փոփոխվել է սերվերի կողմից։",
	"chat.tag.modified.original": "Սկզբնական տեքստ՝ %s",
	"chat.tag.not_secure": "Այս հաղորդագրությունը ապահովված չէ, ինչը նշանակում է, որ հնարավոր է, որ այն փոփոխվել է սերվերի կողմից",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Այլևս չտեղեկացնել այս սերվերի համար։",
	"chatPreview.warning.content": "Զրուցարանի նախադիտումը թույլ է տալիս սերվերին տեսնել Ձեր հաղորդագրությունները, նախքան դրանք ուղարկվեն այլ խաղացողների: Սա թույլ է տալիս սերվերին Ձեզ ուղարկել Ձեր հաղորդագրությունների նախադիտում զրուցարանում կիրառվող օգտատերի փոփոխություններին և ոճին.\n\nԶրուցարանի նախադիտման վարքագիծը կարելի է փոխել Զրուցարանի կարգավորումներում: Ընթացիկ կարգավորում: [%s]",
	"chatPreview.warning.title": "Այս սերվերն օգտագործում է զրույցի նախադիտում:",
	"chatPreview.warning.toast.title": "Զրույցի նախադիտումը միացված է։",
	...
	"commands.locate.biome.invalid": "%s տեսակով բիոմ չկա",
	...
	"commands.locate.poi.invalid": "Չկա \"%s\" տեսակի հետաքրքրության կետ",
	...
	"death.attack.message_too_long": "Ի դեպ, ուղերձը չափազանց երկար է մատուցել այն ամբողջությամբ. Ներեցեք! Ահա կտրված վարկածը՝ %s",
	...
	"debug.pause.help": "F3 + Esc = Դադար առանց դադարի ցանկը (եթե հնարավոր է դադար)",
	...
	"gui.abuseReport.error.title": "Ձեր հաշվետվությունն ուղարկելու խնդիրը",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Թմրանյութեր կամ ալկոհոլ",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Ինչ – որ մեկը խրախուսում է ուրիշներին օգտվել թմրանյութերի հետ կապված անօրինական գործողություններից կամ խրախուսել անչափահասներին խմել ։.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Ինչ –որ մեկը վնասում է ուրիշի հեղինակությունը՝ ձեւացնելով, թե նա այն անձնավորությունն է, ում չեն խաբում կամ կեղծ տեղեկություններ է հայտնում ուրիշներին շահագործելու կամ մոլորեցնելու նպատակով։.",
	"gui.abuseReport.reason.description": "Նկարագրություն.",
	"gui.abuseReport.reason.false_reporting": "Կեղծ Զեկույցներ",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Ինչ-որ մեկը խոսում է անձնական եւ ինտիմ պատկերների, տարածում է դրանք կամ այլ կերպ նպաստում է նրանց.",
	...
	"gui.abuseReport.reason.title": "Ընտրել զեկուցման կարգը",
	"gui.abuseReport.send.error_message": "Ձեր զեկույցը ուղարկելիս տեղի է ունեցել սխալ՝ «%s»",
	"gui.abuseReport.send.generic_error": "Ձեր զեկույցը ուղարկելիս հայտնաբերվել է անկանխատեսելի սխալ:",
	...
	"gui.abuseReport.sent.title": "Բողոքը ուղարկված է",
	"gui.acknowledge": "Հասկանալի է",
	"gui.advancements": "Առաջընթացներ",
	"gui.all": "Բոլոր",
	"gui.back": "Հետ",
	"gui.banned.description": "%s\n\n%s\n\nԻմացեք ավելին հետեւյալ հղումով: %s",
	...
	"gui.banned.description.reason": "Վերջերս ձեր հաշվետվությամբ մենք ստացանք հաշվետվություն վատ վարքի համար: Մեր moderatorors-ը այժմ վերանայել է ձեր գործը եւ նշել, որ այն %s է, որը դեմ է Minecraft համայնք չափանիշները-ին.",
	"gui.banned.description.reason_id": "Կոդ՝ %s",
	"gui.banned.description.reason_id_message": "Կոդ՝ %s - %s",
	"gui.banned.description.temporary": "%s Մինչև այդ դուք չեք կարող խաղալ առցանց կամ Realms-ում։",
	"gui.banned.description.temporary.duration": "Ձեր հաշիվը ժամանակավորապես կասեցվել է եւ %sից կվերականգնվի։",
	...
	"gui.cancel": "Չեղարկել",
	"gui.chatReport.comments": "Մեկնաբանությունների խմբագրման դաշտ",
	"gui.chatReport.describe": "Մանրամասների կիսումը կօգնի մեզ տեղեկացված որոշում կայացնել։",
	"gui.chatReport.discard.content": "Եթե դուք դուրս գաք, դուք կկորցնեք այս զեկույցը և մեկնաբանությունները։ Դուք վստահ եք, որ ուզում եք դուրս գալ?",
	"gui.chatReport.discard.discard": "Դուրս գալ և դեն նետել զեկույցը",
	"gui.chatReport.discard.return": "Շարունակել Խմբագրել",
	...
	"gui.chatReport.read_info": "Կարդալ Բողոքի Մասին",
	"gui.chatReport.report_sent_msg": "Մենք ստացել ենք ձեր զեկույցը։ Շնորհակալություն։\n\nՄեր թիմը այն հնարավորինս շուտ կնայի։",
	"gui.chatReport.select_chat": "Ընտիր զրույցի հաղորդագրությունները զեկուցելու համար",
	...
	"gui.chatReport.send.too_many_messages": "Փորձ զեկույցում ներառել չափազանց շատ գրառումներ",
	...
	"gui.chatSelection.fold": "թաքնվել է %s կապ չունեցող նամակ",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%s ասաց. %s %s-ի մեջ",
	"gui.chatSelection.selected": "%s-ից %s նամակ ընտրված է",
	"gui.chatSelection.title": "Ընտիր զրույցի հաղորդագրությունները զեկուցելու համար",
	"gui.days": "%s օր",
	"gui.done": "Արված",
	"gui.down": "Ներքեւ",
	...
	"gui.socialInteractions.narration.hide": "%s հաղորդագրությունները թաքցնել",
	"gui.socialInteractions.narration.report": "Զեկուցել %s խաղացողից",
	"gui.socialInteractions.narration.show": "%s հաղորդագրությունները ցուցադրել",
	...
	"gui.socialInteractions.tooltip.hide": "Թաքցնել հաղորդագրությունները",
	"gui.socialInteractions.tooltip.report": "Զեկուցել խաղացողից",
	...
	"gui.socialInteractions.tooltip.show": "Ցույց տալ հաղորդագրությունները",
	...
	"item.minecraft.spruce_chest_boat": "Բեռնատար նավակ եղևնիից",
	...
	"item.minecraft.tadpole_bucket": "Շերեփուկով դույլ",
	...
	"key.back": "Ետ քայլել",
	"key.categories.creative": "Ստեղծագործական ռեժիմ",
	...
	"multiplayer.disconnect.invalid_public_key": "Չհաջողվեց վերլուծել պրոֆիլի հանրային բանալին:",
	...
	"multiplayer.disconnect.missing_public_key": "Չի գտնվել պրոֆիլի հասարակական բանալին։\nԱյս սերվերը պահանջում է պաշտպանված պրոֆիլներ։",
	...
	"options.chatPreview": "Զրույցի նախադիտում",
	"options.chatPreview.confirm": "Ուղարկելիս",
	"options.chatPreview.live": "Մուտքագրելիս",
	"options.chatPreview.tooltip.off": "Ցանկացած փոփոխություն, որը կատարվում է սերվերի կողմից ձեր զրույցի հաղորդագրություններում, չի դիտվի և կդիտարկվի որպես վտանգավոր:",
	...
	"options.darknessEffectScale.tooltip": "Կառավումարում է, թե ինչքան շատ է Մթության էֆֆեկտի բաբախումը, որը տալիս է Պահապանին կամ Սկալկ Ճչիչը։",
	...
	"selectWorld.import_worldgen_settings.deprecated.title": "Զգուշացում: Այս կայանքները օգտագործում են արժեզրկված հատկություններ",
	...
	"subtitles.item.bucket.fill_tadpole": "Շերեփուկը բռնվել է",
	...
	"title.multiplayer.disabled.banned.permanent": "Ձեր հաշիվը ընդմիշտ դադարեցվել է օնլայն խաղից",
	"title.multiplayer.disabled.banned.temporary": "Ձեր հաշիվը ժամանակավորապես դադարեցվել է օնլայն խաղից",
