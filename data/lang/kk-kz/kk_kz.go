...
var Map = map[string]string{
	...
	"advancements.end.find_end_city.description": "Энд қаласына кіріңіз, ештеңе етпес қой?",
	...
	"advancements.husbandry.silk_touch_nest.description": "Жібек тиюін қолданып, үш аралы ұяны жылжытыңыз",
	...
	"argument.enum.invalid": "\"%s\" мәні қате",
	...
	"arguments.item.overstacked": "%s тек %s заттан тұратын стак құрай алады",
	...
	"block.minecraft.verdant_froglight": "Көк бақажарық",
	...
	"chat.disabled.profile.moreInfo": "Чат тіркелгі баптауында өшірілген. Хат көрінбейді және жіберілмейді.",
	"chat.editBox": "чат",
	...
	"chat.previewInput": "Алдын ала көру үшін [%s] басыңыз",
	"chat.queue": "[Кезекте +%s жол]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "Сервер бұл хатты өзгерткен.",
	"chat.tag.modified.original": "Түпнұсқа мәтін: %s",
	"chat.tag.not_secure": "Бұл хат қауіпсіз емес, яғни оны сервер өзгерткен болуы мүмкін",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Бұл сервер үшін қайта ескертпеу",
	"chatPreview.warning.content": "Чатты алдын ала көру серверге хатыңыз жіберілмей тұрып, оны көруге мүмкіндік береді. Бұл серверге сіздің хатыңыздың барлық өзгеріс пен стилизациясы бар алдын ала көрінісін жіберіп отыруға мүмкіндік береді.\n\nЧатты алдын ала көру чат баптауында бапталады. Қазіргі баптау: [%s]",
	"chatPreview.warning.title": "Бұл сервер чатты алдын ала көруді қолданады",
	"chatPreview.warning.toast.title": "Чатты алдын ала көру қосулы",
	...
	"commands.data.get.invalid": "%s алынбады; сан тәгі ғана рұқсат етілген",
	...
	"commands.enchant.failed.incompatible": "%s бұл сиқырлауды қолдай алмайды",
	...
	"commands.locate.biome.invalid": "\"%s\" деген биом жоқ",
	"commands.locate.biome.not_found": "Жақын маңда \"%s\" деген биом табылмады",
	"commands.locate.biome.success": "Ең жақын %s %s нүктесінде (осыдан %s блок алыс)",
	"commands.locate.poi.invalid": "\"%s\" деген қызығу нүктесі жоқ",
	"commands.locate.poi.not_found": "Жақын маңда \"%s\" деген қызығу нүктесі табылмады",
	"commands.locate.poi.success": "Ең жақын %s %s нүктесінде (осыдан %s блок алыс)",
	...
	"commands.locate.structure.success": "Ең жақын %s %s нүктесінде (осыдан %s блок алыс)",
	...
	"commands.place.template.success": "%[2]s, %[3]s, %[4]s позициясында \"%[1]s\" үлгісі құрылды",
	...
	"demo.reminder": "Демо ойын бітті. Ойынды жалғастыру үшін оны сатып алыңыз немесе жаңа әлем құрып алыңыз!",
	...
	"disconnect.loginFailedInfo.userBanned": "Сіз онлайн ойнаудан бұғатталдыңыз",
	...
	"flat_world_preset.minecraft.overworld": "Жай әлем",
	...
	"gamerule.commandBlockOutput": "Пәрмен блогінің хаты",
	...
	"gamerule.doLimitedCrafting.description": "Қосулы болса, ойыншы тек ашылған рецептімен зат жасай алады",
	...
	"gamerule.forgiveDeadPlayers.description": "Ашуландырған ойыншы өлгенде, ашулы бейтарап мобтың ашуы басылады.",
	...
	"generator.minecraft.flat": "Асқынжазық",
	"generator.minecraft.large_biomes": "Үлкен биом",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Біреу есірткіге байланысты заңсыз әрекет жасауға тартады немесе кәмелетке толмағандардың алкоголь тұтынуды насихаттайды.",
	...
	"gui.abuseReport.reason.hate_speech.description": "Біреу сізді немесе басқа ойыншыны дін, нәсіл немесе жыныс сияқты белгілерге байланысты қорлайды.",
	"gui.abuseReport.reason.imminent_harm": "Тікелей зиян - басқаларға зиян келтіру қатері",
	"gui.abuseReport.reason.imminent_harm.description": "Біреу сізге немесе басқа біреуге шын өмірде зиян келтірумен қорқытады.",
	"gui.abuseReport.reason.narration": "%s: %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Келісімсіз интимдік суреттер",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Біреу жеке және интимдік суреттер туралы сөйлейді, бөліседі немесе басқаша насихаттайды.",
	...
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Біреу саяси, діни, идеологиялық немесе басқа себеппен терроризм немесе зорлық экстремизм актісін орындаймын деп қорқытады, ол туралы сөйлейді немесе басқаша насихаттайды.",
	...
	"gui.abuseReport.send.service_unavailable": "Теріс пайдаланушылық шағым сервисіне қол жеткізілмеді. Интернетке қосылғаныңызды тексеріп қайталап көріңіз.",
	...
	"gui.banned.description.reason": "Біз жақында сіздің тіркелгіңізде жасалған бұрыс қылық туралы шағым қабылдадық. Біздің модераторлар жағдайыңызды тексеріп, оны Minecraft Қауымдастығының Стандарттарына қайшы келетін %s деп анықтады.",
	...
	"gui.banned.description.unknownreason": "Біз жақында сіздің тіркелгіңізде жасалған бұрыс қылық туралы шағым қабылдадық. Біздің модераторлар жағдайыңызды тексеріп, оның Minecraft Қауымдастығының Стандарттарын қайшы келетінін анықтады.",
	...
	"gui.chatReport.comments": "Пікір өңдеу өрісі",
	"gui.chatReport.describe": "Ақпарат бөліскеніңіз бізге оңды шешім шығаруға көмектеседі.",
	"gui.chatReport.discard.content": "Шықсаңыз, бұл шағым мен пікірлеріңізді жоғалтасыз.\nШынымен шыққыңыз келе ме?",
	"gui.chatReport.discard.discard": "Шығып, шағымды жою",
	"gui.chatReport.discard.return": "Өңдеуді жалғастыру",
	"gui.chatReport.discard.title": "Шағым мен пікірді жойғыңыз келе ме?",
	"gui.chatReport.more_comments": "Не болғанын сипаттап беруді өтінеміз:",
	...
	"gui.chatReport.select_chat": "Шағымдану үшін чаттан хат таңдаңыз",
	"gui.chatReport.select_reason": "Шағым санатын таңдаңыз",
	"gui.chatReport.selected_chat": "Шағымдануға %s хат таңдалды",
	...
	"gui.chatReport.send.no_reported_messages": "Шағымдану үшін чаттан кем дегенде бір хат таңдаңыз",
	"gui.chatReport.send.too_many_messages": "Шағымда тым көп хат",
	"gui.chatReport.title": "Ойыншыға шағымдану",
	"gui.chatSelection.context": "Таңдалғанның қасындағы хаттар контекст ретінде қосылады",
	"gui.chatSelection.fold": "%s қатысы жоқ хабарлама жасырылды",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.message.narrate": "%[1]s %[3]s деді (сағат %[2]s)",
	"gui.chatSelection.selected": "%s/%s хат таңдалды",
	"gui.chatSelection.title": "Шағымдану үшін чаттан хат таңдаңыз",
	"gui.days": "%s күн",
	"gui.done": "Дайын",
	"gui.down": "Төмен",
	...
	"gui.recipebook.toggleRecipes.craftable": "Жасау үстелі рецепті",
	...
	"gui.socialInteractions.narration.hide": "%s хатын жасыру",
	"gui.socialInteractions.narration.report": "%s дегенге шағымдану",
	"gui.socialInteractions.narration.show": "%s хатын көрсету",
	...
	"gui.socialInteractions.tooltip.hide": "Хат жасыру",
	"gui.socialInteractions.tooltip.report": "Ойыншыға шағымдану",
	"gui.socialInteractions.tooltip.show": "Хат көрсету",
	"gui.stats": "Санақ",
	...
	"multiplayer.disconnect.chat_validation_failed": "Чат хатын растау қатесі",
	...
	"multiplayer.disconnect.invalid_public_key": "Бейіннің жария кілті талданбады.",
	"multiplayer.disconnect.invalid_public_key_signature": "Бейіннің жария кілтінің қате қолтаңбасы.\nОйынды қайта қосып көріңіз.",
	...
	"multiplayer.disconnect.missing_public_key": "Бейіннің жария кілті жоқ.\nБұл серверге қорғалған бейін керек.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Тым көп расталмаған хат",
	"multiplayer.disconnect.unexpected_query_response": "Клиенттен күтпеген баптаулы дерек алынды",
	"multiplayer.disconnect.unsigned_chat": "Қолжазбасы жоқ немесе қолжазбасы қате чат пакеті алынды.",
	...
	"multiplayer.requiredTexturePrompt.line1": "Сервер арнайы ресурс жинағын қолдануды талап етеді.",
	...
	"multiplayer.texturePrompt.failure.line2": "Қолданушы ресурсын қолданатын кез келген функционал ойдағыдай жұмыс істемеуі мүмкін",
	...
	"multiplayer.unsecureserver.toast": "Бұл серверде жіберілген хаттар өзгертілген және түпнұсқа сай емес болуы мүмкін",
	"multiplayer.unsecureserver.toast.title": "Чат хаттары расталмайды",
	...
	"narrator.screen.usage": "Элемент таңдау үшін тінтуір курсоры немесе Tab батырмасын қолданыңыз",
	...
	"options.chatPreview": "Чатты алдын ала көру",
	"options.chatPreview.confirm": "Жібергенде",
	"options.chatPreview.live": "Тергенде",
	"options.chatPreview.tooltip.confirm": "Сервер чатты алдын ала көруді қолданса: алдын ала көруді қажет еткен хат бар болғанда ғана, алдын ала көру ашылады.\nХатты жіберу үшін растау керек.",
	"options.chatPreview.tooltip.live": "Сервер чатты алдын ала көруді қолсанса: хат терілген кезде, сервер сіздің хатқа енгізген өзгерістер динамикалы түрде алдын ала көрсетіліп тұрады.",
	"options.chatPreview.tooltip.off": "Хатыңызға сервер тарапынан енгізілген өзгерістерге алдын ала көру жасалмайды және олар қауіпті болып қарастырылады.",
	"options.chunks": "%s ч.",
	...
	"options.directionalAudio.on.tooltip": "3D дыбысын симуляциялауды жақсарту үшін HRTF-негізді бағытты аудио қолданады. HRTF-пен үйлесімді аудио жабдығын қажет етеді және құлаққап кигенде жақсырақ естіледі.",
	...
	"options.fovEffectScale.tooltip": "Ойын әсерінің көру аясына қаншалықты қатты әсер ететініне жауап береді.",
	...
	"options.onlyShowSecureChat": "Қорғалған чат қана",
	"options.onlyShowSecureChat.tooltip": "Авторлығы тексерілген және мазмұны өзгертілмеген ойыншы хатын ғана көрсету.",
	...
	"realms.missing.snapshot.error.text": "Снапшоттар Realms-ты қолдамайды",
	...
	"selectWorld.recreate.customized.text": "Бұл Minecraft нұсқасында әлем бапталмайды. Тұқымы мен қасиетін бұрынғыдай қылып, оны қайта құруға болады, алайда жаңадан құрылған аймақ баптаусыз болады. Ыңғайсыздық үшін кешірім сұраймыз!",
	...
	"structure_block.custom_data": "Баптаулы дерек тәгінің атауы",
	...
	"structure_block.mode_info.data": "Дерек режімі - ойын логикасының маркері",
	"structure_block.mode_info.load": "Жүктеу режімі - файлдан жүктеу",
	"structure_block.mode_info.save": "Сақтау режімі - файлға жазу",
	...
	"subtitles.entity.parrot.imitate.warden": "Тоты қаңсылдайды",
	...
	"subtitles.entity.warden.ambient": "Сақшы қаңсылайды",
	...
	"subtitles.entity.warden.tendril_clicks": "Сақшы мұрты тықырлайды",
	...
	"title.32bit.deprecation.realms": "Minecraft жақында 64 биттік жүйе қажет еткендіктен, бұл құрылғыда ойнай алмайтын және Realms-ті қолдана алмайтын боласыз. Realms жазылымыңыз бар болса, одан өзіңіз бас тартуыңыз керек.",
