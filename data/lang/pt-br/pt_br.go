...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "Caminhe furtivamente perto de um sensor de sculk ou defensor para evitar a detecção",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Faça um allay soltar um bolo sobre um bloco musical",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Parabéns para você",
	...
	"advancements.husbandry.silk_touch_nest.description": "Mova uma colmeia com 3 abelhas dentro usando o Toque suave",
	...
	"argument.entity.toomany": "Apenas uma entidade é permitida, mas o seletor usado permite mais de uma",
	...
	"argument.player.entities": "Este comando afeta apenas jogadores, mas o seletor usado inclui entidades",
	"argument.player.toomany": "Apenas um jogador é permitido, mas o seletor usado permite mais de um",
	...
	"argument.pos.mixed": "Não é possível usar uma combinação de coordenadas globais e locais (todas devem usar ^ ou não)",
	...
	"build.tooHigh": "A altura limite para construção é %s",
	...
	"chat.disabled.profile": "Não é possível enviar ou ler mensagens. Pressione \"%s\" novamente para saber mais",
	"chat.disabled.profile.moreInfo": "Não é possível enviar ou ler mensagens. O chat foi desativado nas configurações da conta Microsoft.",
	"chat.editBox": "chat",
	"chat.filtered_full": "O servidor ocultou a sua mensagem para alguns jogadores.",
	"chat.link.confirm": "Deseja mesmo abrir essa página?",
	...
	"chat.previewInput": "Pressione [%s] para pré-visualizar",
	"chat.queue": "[+%s linhas pendentes]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Esta mensagem foi filtrada pelo servidor.",
	"chat.tag.modified": "Esta mensagem foi modificada pelo servidor.",
	"chat.tag.modified.original": "Texto original: %s",
	"chat.tag.not_secure": "Esta mensagem não é segura e pode ter sido modificada pelo servidor",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Não mostrar novamente para este servidor",
	"chatPreview.warning.content": "A pré-visualização do chat permite que o servidor mostre as mensagens antes de enviá-las a outros jogadores, ao exibir uma pré-visualização do texto com o estilo e modificação aplicados.\n\nA pré-visualização pode ser alterada nas configurações. A atual é: [%s]",
	"chatPreview.warning.title": "Este servidor usa a pré-visualização do chat",
	"chatPreview.warning.toast": "Este servidor usa a pré-visualização do chat e permite ver as mensagens antes do envio a outros jogadores. Esta opção pode ser desativada nas configurações.",
	"chatPreview.warning.toast.title": "A pré-visualização do chat está ativada",
	...
	"command.failed": "Houve um erro inesperado ao tentar executar esse comando",
	...
	"commands.advancement.revoke.many.to.many.success": "%s progressos foram retirados de %s jogadores",
	...
	"commands.advancement.revoke.one.to.many.success": "O progresso %s foi retirado de %s jogadores",
	...
	"commands.kill.success.multiple": "%s entidades foram mortas",
	"commands.kill.success.single": "%s morreu",
	"commands.list.nameAndId": "%s (%s)",
	"commands.list.players": "Há %s de %s jogadores online: %s",
	"commands.locate.biome.invalid": "O bioma \"%s\" não existe",
	"commands.locate.biome.not_found": "Não foi possível localizar o bioma \"%s\" a uma distância razoável",
	"commands.locate.biome.success": "A estrutura do tipo %s mais próxima está em %s (a %s blocos de distância)",
	"commands.locate.poi.invalid": "O ponto de interesse \"%s\" não existe",
	"commands.locate.poi.not_found": "Não foi possível localizar um ponto de interesse do tipo \"%s\" a uma distância razoável",
	"commands.locate.poi.success": "A estrutura do tipo %s mais próxima está em %s (a %s blocos de distância)",
	...
	"commands.place.jigsaw.failed": "Não foi possível gerar o bloco-quebra-cabeça",
	"commands.place.jigsaw.invalid": "O conjunto modelo do tipo \"%s\" não existe",
	"commands.place.jigsaw.success": "Um bloco-quebra-cabeça foi gerado em %s, %s, %s",
	...
	"commands.schedule.cleared.failure": "Nenhuma função programada com o ID %s",
	...
	"commands.spectate.self": "Não é possível se assistir",
	...
	"commands.team.option.seeFriendlyInvisibles.alreadyDisabled": "Nada mudou, os membros da equipe já não podem ver os colegas invisíveis",
	"commands.team.option.seeFriendlyInvisibles.alreadyEnabled": "Nada mudou, os membros da equipe já podem ver os colegas invisíveis",
	"commands.team.option.seeFriendlyInvisibles.disabled": "Os membros da equipe %s não podem mais ver os colegas invisíveis",
	"commands.team.option.seeFriendlyInvisibles.enabled": "Os membros da equipe %s podem ver os colegas invisíveis",
	...
	"createWorld.customize.custom.confirm1": "Isso sobrescreverá as suas configurações",
	...
	"dataPack.validation.failed": "Houve um erro ao validar os pacotes de dados!",
	...
	"death.attack.sting.item": "%[2]s picou %[1]s até a morte com %[3]s",
	...
	"disconnect.loginFailedInfo.userBanned": "Sua conta está banida de jogar online",
	...
	"gamerule.maxCommandChainLength.description": "Aplica-se em cadeias de blocos de comando e funções.",
	...
	"gamerule.randomTickSpeed": "Frequência de ciclos aleatórios",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Alguém está incentivando a participação de outrem no consumo de drogas ilícitas ou bebidas alcoólicas para menores.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Abuso ou exploração sexual de menores",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Alguém está mencionando ou incentivando comportamentos indecentes envolvendo menores.",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Alguém está prejudicando a reputação de outra pessoa, fingindo ser alguém que não é, ou compartilhando informações falsas com o intuito de obter vantagens ou enganar outros.",
	...
	"gui.abuseReport.reason.harassment_or_bullying.description": "Alguém está assediando, atacando ou intimidando você ou outra pessoa. Isso inclui tentativas insistentes de contato ou envio de informações pessoais suas ou de alguém sem consentimento (\"doxing\").",
	...
	"gui.abuseReport.reason.imminent_harm": "Dano iminente — ameaça de ferir outras pessoas",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Alguém está mencionando, compartilhando ou incentivando a divulgação de imagens íntimas pessoais.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Dano iminente — automutilação ou suicídio",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Alguém está ameaçando automutilar-se, ou falando sobre automutilação na vida real.",
	...
	"gui.abuseReport.reason.title": "Selecione uma categoria",
	"gui.abuseReport.send.error_message": "Houve um erro ao enviar a denúncia:\n\"%s\"",
	"gui.abuseReport.send.generic_error": "Houve um erro ao enviar a denúncia.",
	"gui.abuseReport.send.http_error": "Houve um erro ao enviar a denúncia.",
	"gui.abuseReport.send.json_error": "Conteúdo inválido encontrado ao enviar a denúncia.",
	...
	"gui.all": "Todas",
	"gui.back": "Voltar",
	"gui.banned.description": "%s\n\n%s\n\nSaiba mais no link: %s",
	"gui.banned.description.permanent": "Sua conta está banida permanentemente. Você não pode jogar online ou entrar no Realms.",
	"gui.banned.description.reason": "Recebemos uma denúncia de comportamento indevido em sua conta. A moderação analisou o caso e identificou-o como \"%s\", o que viola os Padrões da Comunidade do Minecraft.",
	...
	"gui.banned.description.temporary.duration": "Sua conta está suspensa temporariamente e será liberada em %s.",
	"gui.banned.description.unknownreason": "Recebemos uma denúncia de comportamento indevido em sua conta. A moderação analisou o caso e identificou que viola os Padrões da Comunidade do Minecraft.",
	"gui.banned.title.permanent": "A conta foi banida permanentemente",
	"gui.banned.title.temporary": "A conta foi suspensa temporariamente",
	"gui.cancel": "Cancelar",
	"gui.chatReport.comments": "Caixa de edição de comentários",
	"gui.chatReport.describe": "Informar os detalhes nos ajudará a tomar a melhor decisão.",
	"gui.chatReport.discard.content": "Se você sair, perderá a denúncia e os comentários.\nDeseja mesmo sair?",
	...
	"gui.chatReport.read_info": "Saiba mais sobre as denúncias",
	"gui.chatReport.report_sent_msg": "Recebemos e agradecemos o envio da sua denúncia!\n\nA equipe analisará o caso assim que possível.",
	...
	"gui.chatReport.send.comments_too_long": "Reduza o comentário",
	...
	"gui.chatReport.send.too_many_messages": "Há muitas mensagens incluídas na denúncia",
	...
	"gui.chatSelection.fold": "Mensagens ocultas não relacionadas: %s",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Não é possível denunciar esse jogador porque as suas mensagens não podem ser verificadas no servidor",
	...
	"multiplayer.disconnect.incompatible": "O cliente é incompatível! Use a versão %s",
	...
	"multiplayer.disconnect.invalid_public_key": "Não foi possível analisar a chave pública de perfil.",
	"multiplayer.disconnect.invalid_public_key_signature": "A assinatura para a chave pública de perfil é inválida.\nTente reiniciar o jogo.",
	...
	"multiplayer.disconnect.missing_public_key": "A chave pública de perfil não foi encontrada.\nEste servidor requer perfis seguros.",
	...
	"multiplayer.disconnect.outdated_client": "O cliente é incompatível! Use a versão %s",
	"multiplayer.disconnect.outdated_server": "O cliente é incompatível! Use a versão %s",
	...
	"narration.cycle_button.usage.focused": "Pressione Enter para mudar para %s",
	"narration.cycle_button.usage.hovered": "Clique com o botão esquerdo para mudar para %s",
	...
	"optimizeWorld.confirm.description": "Isso tentará otimizar o mundo para que todos os dados sejam armazenados no formato de jogo mais recente, o que pode demorar algum tempo, dependendo do tamanho. Uma vez otimizado, o mundo poderá carregar mais rapidamente, mas já não será compatível com as versões anteriores do jogo. Deseja mesmo continuar?",
	...
	"options.chatPreview": "Pré-visualizar chat",
	"options.chatPreview.confirm": "Ao enviar",
	"options.chatPreview.live": "Ao escrever",
	"options.chatPreview.tooltip.confirm": "Se um servidor usar a pré-visualização do chat, só será gerada ao tentar enviar uma mensagem sem pré-visualização ou no aguardo de uma.\nO envio de uma mensagem requer confirmação.",
	"options.chatPreview.tooltip.live": "Se um servidor usar a pré-visualização do chat, qualquer modificação aplicada à mensagem será mostrada enquanto é escrita.",
	"options.chatPreview.tooltip.off": "Qualquer modificação aplicada às mensagens, pelo servidor, não será pré-visualizada e será considerada insegura.",
	...
	"options.fovEffectScale.tooltip": "Define a intensidade da mudança do campo visual causada pelas ações e efeitos do jogo.",
	"options.framerate": "%s",
	...
	"options.graphics.warning.message": "O dispositivo gráfico é incompatível com a opção \"%s\".\n\nVocê pode ignorar esse aviso e continuar. No entanto, o suporte não será oferecido ao dispositivo caso prefira usar os gráficos %s.",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Algumas ações dentro de um chunk recompilarão a área de imediato. Isso inclui colocar e destruir blocos.",
	...
	"outOfMemory.message": "O Minecraft está sem espaço de memória.\n\nIsto pode ser causado por um erro no jogo ou por não haver espaço suficiente alocado para a Java Virtual Machine.\n\nPara evitar a corrupção do mundo, a partida atual foi fechada. Tentamos abrir espaço suficiente na memória para você voltar a jogar, mas isso pode não ter funcionado.\n\nReinicie o jogo se esta mensagem aparecer novamente.",
	...
	"permissions.requires.entity": "É necessária uma entidade para executar esse comando aqui",
	...
	"selectWorld.backupQuestion.experimental": "Os mundos com definições experimentais são incompatíveis",
	"selectWorld.backupQuestion.snapshot": "Deseja mesmo carregar esse mundo?",
	"selectWorld.backupWarning.customized": "Infelizmente, os mundos personalizados são incompatíveis nessa versão do Minecraft. Ainda é possível carregar esse mundo e manter tudo como estava, mas qualquer terreno gerado posteriormente não será personalizado. Lamentamos!",
	"selectWorld.backupWarning.downgrade": "Este mundo foi jogado pela última vez na versão %s e você está usando a %s. Carregá-lo numa versão anterior pode corrompê-lo. Não garantimos o carregamento ou funcionamento. Se deseja continuar, faça uma cópia!",
	"selectWorld.backupWarning.experimental": "Este mundo usa definições experimentais que podem deixar de funcionar a qualquer momento. Não garantimos o funcionamento ou carregamento. É por sua conta e risco!",
	...
	"selectWorld.futureworld.error.text": "Houve um erro ao tentar carregar um mundo de uma versão mais recente. Essa era uma operação arriscada, lamentamos por não ter funcionado.",
	"selectWorld.futureworld.error.title": "Houve um erro!",
	...
	"selectWorld.import_worldgen_settings.deprecated.question": "Algumas funcionalidades usadas foram descontinuadas e deixarão de funcionar futuramente. Deseja continuar?",
	"selectWorld.import_worldgen_settings.deprecated.title": "Atenção! Essas definições usam funcionalidades descontinuadas",
	...
	"selectWorld.import_worldgen_settings.experimental.title": "Atenção! Essas definições usam funcionalidades experimentais",
	...
	"selectWorld.recreate.error.text": "Houve um erro ao tentar recriar um mundo.",
	"selectWorld.recreate.error.title": "Houve um erro!",
	...
	"selectWorld.tooltip.snapshot2": "antes de carregá-lo nessa snapshot.",
	...
	"subtitles.entity.allay.item_thrown": "Allay solta",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Papagaio imita um piglin",
	...
	"subtitles.entity.turtle.egg_break": "Ovo de tartaruga eclode",
	...
	"title.32bit.deprecation": "Foi detectado um sistema de 32 bits. Você poderá precisar de um sistema de 64 bits para jogar futuramente!",
	"title.32bit.deprecation.realms": "Em breve, o Minecraft exigirá um sistema de 64 bits, impedindo que você jogue ou use o Realms nesse dispositivo. Você terá de cancelar manualmente qualquer assinatura do Realms.",
	...
	"title.multiplayer.disabled.banned.permanent": "Sua conta está suspensa permanentemente do modo online",
