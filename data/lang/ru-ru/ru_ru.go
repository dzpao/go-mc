...
var Map = map[string]string{
	...
	"chat.previewInput": "Нажмите [%s] для предпросмотра",
	"chat.queue": "[+%s строк в очереди]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Сообщение отфильтровано сервером.",
	"chat.tag.modified": "Это сообщение было модифицировано сервером.",
	"chat.tag.modified.original": "Оригинальный текст: %s",
	"chat.tag.not_secure": "Сообщение не подписано. Это значит, что оно могло быть изменено сервером",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "Не показывать снова для этого сервера",
	"chatPreview.warning.content": "Предпросмотр чата разрешает серверу просматривать сообщения, прежде чем отправить их другим игрокам. Благодаря этому сервер сможет продемонстрировать вам сообщение с применёнными стилями и изменениями.\n\nПоведение предпросмотра можно настроить в настройках чата. Текущее значение: [%s]",
	"chatPreview.warning.title": "Сервер использует предпросмотр чата",
	...
	"chatPreview.warning.toast.title": "Предпросмотр чата включён",
	...
	"commands.locate.biome.invalid": "Не существует биома «%s»",
	"commands.locate.biome.not_found": "Не удалось найти биом «%s» поблизости",
	"commands.locate.biome.success": "Ближайшее строение типа %s находится по координатам %s (в %s блоках отсюда)",
	"commands.locate.poi.invalid": "Не существует точки интереса «%s»",
	"commands.locate.poi.not_found": "Не удалось найти точку интереса «%s» поблизости",
	"commands.locate.poi.success": "Ближайшее строение типа %s находится по координатам %s (в %s блоках отсюда)",
	...
	"commands.place.structure.invalid": "Не существует строения «%s»",
	...
	"gui.cancel": "Отмена",
	"gui.chatReport.comments": "Поле редактирования комментариев",
	...
	"gui.chatSelection.fold": "Скрыто %s несвязанных сообщений",
	...
	"multiplayer.disconnect.invalid_public_key": "Не удалось определить открытый ключ профиля.",
	...
	"multiplayer.disconnect.missing_public_key": "Открытый ключ профиля отсутствует.\nДля этого сервера требуются защищённые профили.",
	...
	"multiplayer.unsecureserver.toast.title": "Сообщения в чате не могут быть проверены",
	...
	"options.chatPreview": "Предпросмотр",
	"options.chatPreview.confirm": "При отправке",
	"options.chatPreview.live": "При вводе",
	"options.chatPreview.tooltip.confirm": "Если сервер использует предпросмотр: перед тем как отправить сообщение, оно будет передано серверу для создания предварительного просмотра.\nОтправку сообщения нужно будет подтвердить дополнительно.",
	"options.chatPreview.tooltip.live": "Если сервер использует предпросмотр: любые изменения в сообщении будут сразу передаваться серверу, и можно будет сразу увидеть, как сообщение будет выглядеть в чате.",
	"options.chatPreview.tooltip.off": "Любые изменения вашего сообщения со стороны сервера не будут предпросмотрены и будут рассматриваться как небезопасные.",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Попугай фыркает как пиглин",
