...
var Map = map[string]string{
	...
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "火事を起こすことなく望ましくないショックから村人を守る",
	...
	"advancements.adventure.play_jukebox_in_meadows.description": "ジュークボックスの音楽で草地を生き生きとさせる",
	...
	"advancements.story.form_obsidian.description": "黒曜石を入手する",
	...
	"advancements.story.lava_bucket.description": "溶岩でバケツを満たす",
	...
	"chat.editBox": "チャット",
	"chat.filtered_full": "サーバーは一部のプレイヤーに対して、あなたのメッセージを非表示にしています。",
	...
	"chat.previewInput": "[%s]を押してプレビューする",
	"chat.queue": "［%s行のチャットを保留中］",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "このメッセージはサーバーによってフィルタリングされています。",
	"chat.tag.modified": "このメッセージはサーバーによって変更されています",
	"chat.tag.modified.original": "元のテキスト：%s",
	"chat.tag.not_secure": "このメッセージは安全ではありません。サーバーによって変更された可能性があります。",
	"chat.type.admin": "［%s：%s］",
	...
	"chatPreview.warning.check": "このサーバーではこの通知を二度と表示しない",
	"chatPreview.warning.content": "チャットのプレビューを有効にすると、機能の実装のため、他のプレイヤーにそのメッセージを送信する前でもサーバーにメッセージが送信されます。\n\nチャットのプレビューの動作は、チャット設定にて変更できます。現在の設定は[%s]です。",
	"chatPreview.warning.title": "このサーバーではチャットのプレビューが使用されています",
	"chatPreview.warning.toast": "このサーバーはチャットのプレビューを使用しているため、他のプレイヤーに送信される前にあなたのメッセージを見ることができます。この設定はチャット設定から無効にできます。",
	"chatPreview.warning.toast.title": "チャットのプレビューが有効です",
	...
	"commands.attribute.base_value.get.success": "エンティティ%[2]sの属性%[1]sの基本値は%[3]sです",
	"commands.attribute.base_value.set.success": "エンティティ%[2]sの属性%[1]sの基本値を%[3]sに設定しました",
	"commands.attribute.failed.entity": "%sは有効なエンティティではありません",
	"commands.attribute.failed.modifier_already_present": "修飾子%[1]sはエンティティ%[3]sの属性%[2]sに既に含まれています",
	...
	"commands.locate.biome.invalid": "「%s」という名前のバイオームは存在しません",
	...
	"commands.locate.poi.invalid": "「%s」という種類の関心地点は存在しません",
	"commands.locate.poi.not_found": "所定の距離内に「%s」という名前の関心地点が見つかりませんでした",
	"commands.locate.poi.success": "最寄りの%sは%s（直線距離で%sブロック）にあります",
	"commands.locate.structure.invalid": "「%s」という名前の構造物は存在しません",
	"commands.locate.structure.not_found": "近くに「%s」という名前の構造物は見つかりませんでした",
	...
	"commands.pardon.success": "%sからのアクセス禁止を解除しました",
	...
	"death.attack.dragonBreath": "%[1]sはドラゴンの息で炙り焼きにされた",
	"death.attack.dragonBreath.player": "%[1]sは%[2]sのドラゴンの息で炙り焼きにされた",
	...
	"death.attack.onFire.item": "%[1]sは%[3]sを振り回す%[2]sと戦いながらカリカリに焼けた",
	...
	"debug.crash.warning": "あと %s 秒でクラッシュします・・・",
	...
	"gui.abuseReport.sent.title": "通報の送信が完了しました",
	"gui.acknowledge": "了解",
	"gui.advancements": "進捗",
	"gui.all": "すべて",
	"gui.back": "戻る",
	...
	"gui.banned.description.reason": "この頃、あなたのアカウントによる悪質な行為の報告が寄せられていました。当該報告についてモデレーターが確認しましたところ、Minecraftコミュニティ規定に反する%sであることが判明しました。",
	...
	"gui.banned.description.unknownreason": "この頃、あなたのアカウントによる悪質な行為の報告が寄せられていました。当該報告についてモデレーターが確認したところ、Minecraftコミュニティ規定に反している行為であることが判明しました。",
	"gui.banned.title.permanent": "このアカウントは永久停止処分を受けています",
	"gui.banned.title.temporary": "このアカウントは一時的な使用停止処分を受けています",
	"gui.cancel": "キャンセル",
	"gui.chatReport.comments": "コメント入力欄",
	...
	"gui.chatReport.discard.title": "通報の内容とコメントを破棄しますか？",
	"gui.chatReport.more_comments": "その時の状況を以下に入力してください",
	"gui.chatReport.observed_what": "通報する理由を教えてください。",
	...
	"gui.chatReport.send.comments_too_long": "コメントをもう少し短縮してください",
	...
	"gui.socialInteractions.narration.hide": "%sからのメッセージを非表示にします",
	"gui.socialInteractions.narration.report": "プレイヤー%sを通報します",
	"gui.socialInteractions.narration.show": "%sからのメッセージを表示します",
	...
	"gui.socialInteractions.tooltip.report.no_messages": "プレイヤー%sには通報できるメッセージがありませんでした",
	...
	"item.minecraft.music_disc_5.desc": "サミュエル・オーベリ - 5",
	...
	"multiplayer.disconnect.invalid_public_key": "プロフィール公開鍵を解析できません。",
	...
	"multiplayer.disconnect.missing_public_key": "プロフィール公開鍵がありません。\nこのサーバーでは安全なプロフィールが必要です。",
	...
	"options.chatPreview": "チャットのプレビュー",
	"options.chatPreview.confirm": "送信時",
	"options.chatPreview.live": "入力時",
	"options.chatPreview.tooltip.confirm": "サーバーのチャットのプレビューが有効の場合：プレビューが無い、あるいはプレビュー待ちのメッセージを送信しようとしたときのみ、チャットのプレビューが生成されます。\nメッセージの送信には確認が必要です。",
	"options.chatPreview.tooltip.live": "サーバーのチャットのプレビューが有効の場合、サーバーがメッセージに施す装飾は、チャットメッセージの入力に伴って同時に送信されます。",
	"options.chatPreview.tooltip.off": "チャットメッセージに適用されるサーバーによる修正は、プレビューされず、安全でないものとして扱われます。",
	...
	"options.online": "オンライン…",
	"options.online.title": "オンライン設定",
	"options.onlyShowSecureChat": "保護されたチャットのみ表示",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "オウムがピグリンの鼻を鳴らす音を真似る",
	...
	"subtitles.item.goat_horn.play": "ヤギの角笛が奏でられる",
	...
	"title.multiplayer.disabled.banned.permanent": "あなたのアカウントはオンラインプレイへの参加を永久に停止されました",
	"title.multiplayer.disabled.banned.temporary": "あなたのアカウントはオンラインプレイへの参加を一時的に停止されています",
