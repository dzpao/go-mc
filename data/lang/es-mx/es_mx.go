...
var Map = map[string]string{
	...
	"chat.link.confirm": "¿Seguro/a que quieres abrir esta página web?",
	...
	"chat.previewInput": "Presiona [%s] para previsualizar",
	"chat.queue": "[+%s mensajes pendientes]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Este mensaje fue filtrado por el servidor.",
	"chat.tag.modified": "Este mensaje fue modificado por el servidor.",
	"chat.tag.modified.original": "Texto original: %s",
	"chat.tag.not_secure": "Este mensaje no es seguro, lo que significa que pudo haber sido modificado por el servidor",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "No notificarme en este servidor de nuevo",
	"chatPreview.warning.content": "La previsualización de chat permite al servidor ver tus mensajes antes de ser enviados a otros jugadores. Esto permite al servidor enviarte una vista previa de tu mensaje del chat con modificaciones y estilos aplicados.\n\nLa previsualizacion de chat puede ser cambiada en los ajustes de chat. Ajuste actual: [%s]",
	"chatPreview.warning.title": "Este servidor usa la previsualización de chat",
	"chatPreview.warning.toast": "Este servidor usa la previsualización de chat y puede ver los mensajes antes de ser enviados a otros jugadores. Puedes desactivar esto en las opciones de chat.",
	"chatPreview.warning.toast.title": "Previsualización de chat activada",
	...
	"commands.banip.info": "Bloquear esa IP afecta a %s jugador(es): %s",
	...
	"commands.locate.biome.invalid": "El bioma \"%s\" no existe",
	"commands.locate.biome.not_found": "No se pudo encontrar el bioma \"%s\" a una distancia razonable",
	"commands.locate.biome.success": "La estructura \"%s\" más cercana está en %s. (A %s bloque(s) de distancia)",
	"commands.locate.poi.invalid": "El punto de interés \"%s\" no existe",
	...
	"commands.place.structure.invalid": "La estructura \"%s\" no existe",
	...
	"commands.schedule.created.tag": "Etiqueta \"%s\" programada en %s ticks (hora de juego: %s)",
	...
	"commands.spreadplayers.success.entities": "%s jugadores esparcidos alrededor de %s, %s con una distancia de %s bloque(s) entre ellos",
	"commands.spreadplayers.success.teams": "%s equipos esparcidos alrededor de %s, %s con una distancia promedio de %s bloque(s) entre ellos",
	...
	"commands.worldborder.warning.distance.success": "Distancia para avisar del borde del mundo establecida a %s bloque(s)",
	...
	"deathScreen.quit.confirm": "¿Seguro/a que quieres salir?",
	...
	"gui.chatSelection.fold": "%s mensaje(s) no relacionado(s) oculto(s)",
	...
	"multiplayer.disconnect.missing_public_key": "Falta la clave pública del perfil.\nEste servidor requiere un perfil seguro.",
	...
	"options.chatPreview": "Prev. de chat",
	"options.chatPreview.confirm": "Al enviar",
	"options.chatPreview.live": "Al escribir",
	"options.chatPreview.tooltip.confirm": "Si un servidor usa la previsualización de chat, la vista previa de chat solo será mostrarda al intentar enviar un mensaje que no tiene o está esperando una.\nSe requiere confirmación para enviar el mensaje.",
	"options.chatPreview.tooltip.live": "Si un servidor usa la previsualización de chat, cualquier modificación que el servidor haga a tus mensajes será enviada dinámicamente para que previsualizes el mensaje mientras lo escribes.",
	"options.chatPreview.tooltip.off": "Cualquier modificación que el servidor haga a tus mensajes no será previsualizada y será tratada como insegura.",
	...
	"options.darknessEffectScale.tooltip": "Modifica el pulso del efecto de oscuridad cuando un warden o chillador de sculk te lo da.",
	...
	"options.fovEffectScale.tooltip": "Modifica qué tanto cambia el FOV (campo de visión) al tener efectos.",
	"options.framerate": "%s",
	...
	"pack.incompatible.confirm.title": "¿Seguro/a que quieres cargar este paquete?",
	...
	"selectServer.deleteQuestion": "¿Seguro/a que quieres borrar este servidor?",
	...
	"selectWorld.backupQuestion.snapshot": "¿Seguro/a que quieres cargar este mundo?",
	...
	"selectWorld.deleteQuestion": "¿Seguro/a que quieres borrar este mundo?",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Loro imitando a un piglin",
	...
	"subtitles.entity.warden.nearby_close": "Warden avecinándose",
	"subtitles.entity.warden.nearby_closer": "Warden aproximándose",
	"subtitles.entity.warden.nearby_closest": "Warden acercándose",
