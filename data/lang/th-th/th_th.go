...
var Map = map[string]string{
	...
	"advancements.husbandry.safely_harvest_honey.description": "ใช้แคมป์ไฟช่วยไม่ให้ผึ้งโกรธเมื่อคุณเก็บน้ำผึ้งด้วยขวดจากรังผึ้ง",
	...
	"chat.previewInput": "กด [%s] เพื่อดูตัวอย่าง",
	"chat.queue": "[+%s บรรทัดที่รอดำเนินการ]",
	"chat.square_brackets": "[%s]",
	"chat.tag.modified": "ข้อความนี้ได้รับการดัดแปรจากเซิร์ฟเวอร์",
	"chat.tag.modified.original": "ข้อความต้นฉบับ: %s",
	"chat.tag.not_secure": "ข้อความนี้ไม่ปลอดภัย ซึ่งหมายความว่าข้อความนี้อาจได้รับการดัดแปรจากเซิร์ฟเวอร์",
	"chat.type.admin": "[%s: %s]",
	...
	"chatPreview.warning.check": "ไม่ต้องแจ้งเตือนอีกสำหรับเซิร์ฟเวอร์นี้",
	"chatPreview.warning.content": "ฟีเจอร์ดูตัวอย่างแชตจะทำให้เซิร์ฟเวอร์สามารถเห็นข้อความของคุณก่อนที่จะส่งไปหาผู้เล่นคนอื่นได้ ซึ่งจะทำให้เซิร์ฟเวอร์สามารถแสดงตัวอย่างข้อความแชตของคุณที่มีการดัดแปรที่กำหนดเองและการใส่รูปแบบสีสันต่าง ๆ\n\nฟีเจอร์ดูตัวอย่างแชตสามารถปรับเปลี่ยนได้ในการตั้งค่าแชต โดยการตั้งค่าปัจจุบันคือ: [%s]",
	"chatPreview.warning.title": "เซิร์ฟเวอร์นี้ใช้ฟีเจอร์ดูตัวอย่างแชต",
	"chatPreview.warning.toast.title": "ดูตัวอย่างแชตเปิดใช้งาน",
	...
	"commands.locate.biome.invalid": "ไม่มีไบโอมประเภท \"%s\"",
	...
	"commands.locate.poi.invalid": "ไม่มีจุดสนใจประเภท \"%s\"",
	...
	"disconnect.loginFailedInfo.userBanned": "คุณถูกแบบจากการเล่นแบบออนไลน์",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "สารเสพติด หรือ แอลกอฮอล์",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "การหมิ่นประมาท การแอบอ้าง หรือข้อมูลเท็จ",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "ใครบางคนกำลังทำลายชื่อเสียงของอีกฝ่าย หลอกว่าเป็นใครบางคนทั้ง ๆ ที่ไม่ใช่คนนั้นจริง ๆ หรือส่งต่อข้อมูลอันเป็นเท็จด้วยจุดมุ่งหมายเพื่อหาประโยชน์หรือทำให้คนอื่นเข้าใจผิด",
	...
	"gui.abuseReport.reason.hate_speech.description": "ใครบางคนกำลังโจมตีคุณหรือผู้เล่นคนอื่นด้วยอัตลักษณ์ ความชอบ ศาสนา เชื่อชาติ หรือเพศของคนนั้น",
	"gui.abuseReport.reason.imminent_harm": "มีอันตรายที่จะเกิดขึ้น - เป็นภัยต่อผู้อื่น",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "ใครบางคนกำลังพูดถึง ส่งต่อ หรือสนับสนุนการบรรยายภาพให้เห็นถึงเรื่องส่วนตัว",
	"gui.abuseReport.reason.self_harm_or_suicide": "มีอันตรายที่จะเกิดขึ้น - ทำร้ายตัวเองหรือฆ่าตัวตาย",
	...
	"gui.abuseReport.send.error_message": "เกิดข้อผิดพลาดระหว่างการส่งรายงานของคุณ: '%s'",
	...
	"gui.abuseReport.send.service_unavailable": "ไม่สามารถเข้าถึงบริการของระบบการรายงานสิ่งไม่เหมาะสม โปรดตรวจสอบให้แน่ใจว่าคุณเชื่อมต่ออินเทอร์เน็ตอยู่และลองอีกครั้ง",
	"gui.abuseReport.sending.title": "กำลังส่งรายงานของคุณ...",
	"gui.abuseReport.sent.title": "ส่งรายงานแล้ว",
	"gui.acknowledge": "ยอมรับ",
	"gui.advancements": "ความก้าวหน้า",
	"gui.all": "ทั้งหมด",
	"gui.back": "กลับ",
	"gui.banned.description": "%s\n\n%s\n\nเรียนรู้เพิ่มเติมที่ลิงก์ต่อไปนี้: %s",
	"gui.banned.description.permanent": "บัญชีของคุณถูกระงับถาวร ซึ่งหมายความว่าคุณสามารถเล่นแบบออนไลน์หรือเข้าร่วม Realms ได้",
	...
	"gui.cancel": "ยกเลิก",
	"gui.chatReport.comments": "ช่องแก้ไขคอมเมนต์",
	"gui.chatReport.describe": "การแบ่งปันรายละเอียดจะสามารถช่วยให้เราตัดสินใจได้ดีขึ้น",
	...
	"gui.chatReport.select_chat": "เลือกข้อความที่จะรายงาน",
	...
	"gui.up": "ขึ้น",
	"gui.yes": "ใช่",
	"instrument.minecraft.admire_goat_horn": "ยกย่องสรรเสริญ",
	"instrument.minecraft.call_goat_horn": "เรียก",
	"instrument.minecraft.dream_goat_horn": "หลับฝัน",
	"instrument.minecraft.feel_goat_horn": "ความรู้สึก",
	"instrument.minecraft.ponder_goat_horn": "นึกคิด",
	"instrument.minecraft.seek_goat_horn": "หา",
	"instrument.minecraft.sing_goat_horn": "ร้อง",
	...
	"multiplayer.disconnect.invalid_public_key": "ไม่สามารถแยกวิเคราะห์คีย์สาธารณะของโปรไฟล์ได้",
	...
	"multiplayer.disconnect.missing_public_key": "คีย์สาธารณะของโปรไฟล์หายไป\nเซิร์ฟเวอร์นี้จำเป็นต้องใช้โปรไฟล์ที่มีความปลอดภัย",
	...
	"multiplayer.disconnect.out_of_order_chat": "แพ็กเก็ตแชตได้รับความเสียหาย คุณได้เปลี่ยนระบบเวลาของคุณหรือไม้?",
	...
	"multiplayer.disconnect.unsigned_chat": "ได้รับแพ็กเก็ตแชตที่ลายเซ็นหายไปหรือไม่ถูกต้อง",
	...
	"options.chatPreview": "ดูตัวอย่างแชต",
	"options.chatPreview.confirm": "ขณะกำลังส่ง",
	"options.chatPreview.live": "ขณะกำลังพิมพ์",
	"options.chatPreview.tooltip.confirm": "หากเซิร์ฟเวอร์ใช้ฟีเจอร์ดูตัวอย่างแชต การดูตัวอย่างแชตจะแสดงผลขึ้นมาเมื่อมีความพยายามในการส่งข้อความที่ยังไม่มีการแสดงตัวอย่างหรือกำลังรอที่จะแสดงตัวอย่างเท่านั้น\nการส่งข้อความนั้นจำเป็นต้องได้รับการยืนยันก่อน",
	"options.chatPreview.tooltip.live": "หากเซิร์ฟเวอร์ใช้ฟีเจอร์ดูตัวอย่างแชต การดัดแปรใด ๆ ที่กระทำต่อข้อความแชตของคุณโดยเซิร์ฟเวอร์จะแสดงตัวอย่างข้อความนั้นขึ้นมาอย่างต่อเนื่องในขณะที่กำลังพิมพ์ข้อความ",
	"options.chatPreview.tooltip.off": "การดัดแปรใด ๆ ที่กระทำต่อข้อความแชตของคุณโดยเซิร์ฟเวอร์จะไม่สามารถดูตัวอย่างได้และจะถือว่าการดัดแปรนั้นไม่ปลอดภัย",
	...
	"subtitles.entity.allay.ambient_without_item": "อัลเลย์ปรารถนา",
	"subtitles.entity.allay.death": "อัลเลย์ตาย",
	"subtitles.entity.allay.hurt": "อัลเลย์เจ็บ",
	"subtitles.entity.allay.item_given": "อัลเลย์เสสรวล",
	"subtitles.entity.allay.item_taken": "อัลเลย์คลายกังวล",
	"subtitles.entity.allay.item_thrown": "อัลเลย์ให้ของ",
	...
	"subtitles.entity.parrot.imitate.warden": "นกแก้วร้อง",
	...
	"subtitles.entity.warden.agitated": "วอร์เดนคำรามอย่างคลั่ง",
	...
	"subtitles.entity.warden.listening": "วอร์เดนรับรู้ถึงเสียง",
