...
var Map = map[string]string{
	...
	"commands.locate.biome.invalid": "Da is keen Biom met \"%s\"",
	"commands.locate.biome.not_found": "'S konnde in ongmessna Endfernung keen Biom des Typs %s gfundn werdn",
	"commands.locate.biome.success": "%s is am nächstn bei %s (%s Blögge endfeand)",
	"commands.locate.poi.success": "%s is am nächstn bei %s (%s Blögge endfeand)",
	...
	"commands.place.structure.invalid": "Dord g´bst kene Strugdur vom Dyb %s",
	...
	"gui.back": "Zurügg",
	"gui.cancel": "Obreche",
	"gui.chatReport.comments": "Gommenda-Oinchabefeld",
