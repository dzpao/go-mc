...
var Map = map[string]string{
	...
	"chat.previewInput": "Prime [%s] para pré-visualizar",
	...
	"chatPreview.warning.content": "A pré-visualização do chat permite que o servidor mostre as mensagens antes de as enviar aos outros jogadores, pré-visualizando o texto com os estilos e as modificações aplicadas.\n\nA pré-visualização pode ser alterada nas definições. A atual é: [%s]",
	"chatPreview.warning.title": "Este servidor usa a pré-visualização do chat",
	"chatPreview.warning.toast": "Este servidor utiliza previsão de chat e pode ver as tuas mensagens antes de serem enviadas a outros jogadores. Podes desativá-lo nas definições de chat.",
	...
	"commands.tag.list.multiple.success": "As %s entidades têm um total de %s tags: %s",
	"commands.tag.list.single.empty": "%s não tem tags",
	"commands.tag.list.single.success": "%s tem %s tags: %s",
	...
	"disconnect.loginFailedInfo.userBanned": "A tua conta está banida. Não podes jogar online",
	...
	"gamerule.commandBlockOutput": "Avisos do uso de blocos de comando",
	...
	"gui.abuseReport.reason.title": "Seleciona uma categoria",
	...
	"gui.banned.description.temporary.duration": "A tua conta foi temporariamente suspensa e será reativada em %s.",
	...
	"gui.chatReport.discard.content": "Se saíres, a denúncia e os comentários serão eliminados.\nTens a certeza que queres sair?",
	"gui.chatReport.discard.discard": "Eliminar e sair",
	"gui.chatReport.discard.return": "Continuar a editar",
	"gui.chatReport.discard.title": "Eliminar denúncia e comentários?",
	...
	"gui.socialInteractions.tooltip.report.not_reportable": "Não é possível denunciar este jogador. As mensagens não podem ser verificadas pelo servidor",
	...
	"multiplayer.disconnect.invalid_public_key": "Não foi possível analisar a chave pública do perfil.",
	...
	"multiplayer.disconnect.missing_public_key": "A chave pública do perfil não foi encontrada.\nEste servidor requer perfis seguros.",
	...
	"options.chatPreview.tooltip.confirm": "Se um servidor utilizar a pré-visualização do chat, só será gerada ao tentar enviar uma mensagem sem pré-visualização ou a aguardar por uma.\nÉ necessária uma confirmação para enviar a mensagem.",
	"options.chatPreview.tooltip.live": "Se um servidor utilizar a pré-visualização do chat, as modificações aplicadas à mensagem serão mostradas enquanto é escrita.",
	"options.chatPreview.tooltip.off": "Qualquer modificação aplicada às mensagens, por um servidor, não será pré-visualizada e será considerada como insegura.",
	...
	"title.multiplayer.disabled.banned.permanent": "A tua conta está permanentemente suspensa. Não podes jogar online",
	"title.multiplayer.disabled.banned.temporary": "A tua conta está temporariamente suspensa. Não podes jogar online",
