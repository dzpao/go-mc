...
var Map = map[string]string{
	...
	"advancements.adventure.avoid_vibration.description": "Faufilez-vous près d'un capteur sculk ou d'un Warden pour l'empêcher de vous détecter.",
	...
	"block.minecraft.mud_brick_slab": "Dalle en briques de terre crue",
	"block.minecraft.mud_brick_stairs": "Escalier en briques de terre crue",
	"block.minecraft.mud_brick_wall": "Muret en briques de terre crue",
	...
	"chat.filtered_full": "Ce serveur a masqué vous messages pour certains joueurs.",
	...
	"chat.previewInput": "Appuyez sur [%s] pour prévisualiser",
	"chat.queue": "[+%s messages en attente]",
	"chat.square_brackets": "[%s]",
	"chat.tag.filtered": "Ce message a été filtré par le serveur.",
	"chat.tag.modified": "Ce message a été modifié par le serveur.",
	"chat.tag.modified.original": "Texte d'origine : %s",
	"chat.tag.not_secure": "Ce message n'est pas sécurisé, ce qui signifie qu'il a peut-être été modifié par le serveur",
	"chat.type.admin": "[%s : %s]",
	...
	"chatPreview.warning.check": "Ne plus m'avertir pour ce serveur",
	"chatPreview.warning.content": "L'aperçu du tchat permet au serveur de voir vos messages avant qu'ils ne soient envoyés aux autres joueurs. Cela permet au serveur de vous envoyer un aperçu de vos messages de chat avec des modifications et un style personnalisés.\n\nLe comportement de l'aperçu du tchat peut être modifié dans les paramètres du tchat. Le réglage actuel est le suivant : [%s]",
	"chatPreview.warning.title": "Ce serveur utilise l'aperçu du tchat",
	"chatPreview.warning.toast": "Ce serveur utilise l'aperçu du tchat et peut voir vos messages avant qu'ils soient envoyés à d'autres joueurs. Vous pouvez désactiver cela dans les options de discussion.",
	"chatPreview.warning.toast.title": "L'aperçu du tchat est activé",
	...
	"commands.locate.biome.invalid": "Le biome \"%s\" n'existe pas",
	...
	"commands.locate.poi.invalid": "Le point d'intérêt \"%s\" n'existe pas",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Quelqu'un encourage les autres à prendre part à des activités illégales liées à la drogue ou encourage la consommation d'alcool par des mineurs.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Exploitation ou abus sexuel d'enfants",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Quelqu'un est en train de parler ou de promouvoir un comportement indécent impliquant des enfants.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Diffamation, usurpation d'identité ou fausses informations",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Quelqu'un porte atteinte à la réputation de quelqu'un d'autre, se fait passer pour quelqu'un qu'il n'est pas ou partage de fausses informations dans le but d'exploiter ou de tromper les autres.",
	...
	"gui.abuseReport.reason.harassment_or_bullying.description": "Quelqu'un fait honte, attaque ou harcèle, vous ou une autre personne. Cela inclut les tentatives répétées de vous contacter ou de contacter quelqu'un d'autre sans votre consentement ou la publication d'informations personnelles privées sur vous ou quelqu'un d'autre sans votre consentement (\"doxing\").",
	"gui.abuseReport.reason.hate_speech": "Propos haineux",
	"gui.abuseReport.reason.hate_speech.description": "Quelqu'un vous attaque, vous ou un autre joueur, sur la base de caractéristiques d'identité, comme la religion, la race ou la sexualité.",
	"gui.abuseReport.reason.imminent_harm": "Danger imminent - Menace de nuire à autrui",
	"gui.abuseReport.reason.imminent_harm.description": "Quelqu'un menace de vous faire du mal à vous ou à quelqu'un d'autre dans la vie réelle.",
	"gui.abuseReport.reason.narration": "%s : %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Images intimes non consenties",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Quelqu'un parle de, partage ou autre comme des images privées et intimes ou en fait la promotion.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Danger imminent - Automutilation ou suicide",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Quelqu'un menace ou évoque de se faire du mal dans la vie réelle.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorisme ou extrémisme violent",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Quelqu'un parle, promeut, ou menace des actes terroristes ou des violences extrêmes pour des raisons politiques, religieuses, idéologiques ou autres.",
	...
	"gui.banned.description.permanent": "Votre compte est banni définitivement, ce qui signifie que vous ne pouvez pas jouer en ligne ou rejoindre des Realms.",
	"gui.banned.description.reason": "Nous avons récemment reçu un signalement concernant votre mauvais comportement sur votre compte. Nos modérateurs ont maintenant examiné votre cas et l'ont identifié comme %s, ce qui va à l'encontre des normes de la communauté Minecraft.",
	"gui.banned.description.reason_id": "Code : %s",
	"gui.banned.description.reason_id_message": "Code : %s - %s",
	"gui.banned.description.temporary": "%s Pour l'instant , vous ne pouvez pas jouer en ligne ou rejoindre des Realms.",
	"gui.banned.description.temporary.duration": "Votre compte est temporairement suspendu et sera réactivé dans %s.",
	"gui.banned.description.unknownreason": "Nous avons récemment reçu un signalement pour mauvais comportement de votre compte. Nos modérateurs ont maintenant examiné votre cas et ont identifié qu'il va à l'encontre des normes de la communauté Minecraft.",
	"gui.banned.title.permanent": "Compte banni définitivement",
	"gui.banned.title.temporary": "Compte temporairement suspendu",
	"gui.cancel": "Annuler",
	"gui.chatReport.comments": "Champ de saisie des commentaires",
	...
	"gui.chatReport.discard.return": "Continuer la modification",
	...
	"gui.chatReport.send": "Envoyer le signalement",
	"gui.chatReport.send.comments_too_long": "Merci de raccourcir votre commentaire",
	...
	"gui.chatReport.send.too_many_messages": "Vous essayez d'inclure trop de messages dans ce signalement",
	"gui.chatReport.title": "Signaler le joueur",
	"gui.chatSelection.context": "Les messages entourant cette sélection seront inclus pour fournir un contexte supplémentaire",
	"gui.chatSelection.fold": "%s message(s) sans liens masqué(s)",
	...
	"gui.socialInteractions.tooltip.report.disabled": "Le service de signalements est indisponible",
	"gui.socialInteractions.tooltip.report.no_messages": "Aucun message à signaler du joueur %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Ce joueur ne peut pas être signalé, car ses messages ne peuvent pas être vérifiés sur ce serveur",
	...
	"menu.loadingForcedChunks": "Chargement des chunks forcés pour la dimension %s :",
	...
	"multiplayer.disconnect.invalid_public_key": "Impossible d'analyser la clé publique du profil.",
	...
	"multiplayer.disconnect.missing_public_key": "La clé publique du profil est manquante.\nCe serveur exige des profils sécurisés.",
	...
	"multiplayer.disconnect.too_many_pending_chats": "Trop de messages du tchat sont en attentes",
	...
	"multiplayer.unsecureserver.toast": "Les messages envoyés sur ce serveur peuvent être modifiés et ne pas refléter le message d'origine",
	"multiplayer.unsecureserver.toast.title": "Les messages du tchat ne peuvent pas être vérifiés",
	...
	"options.chatPreview": "Aperçu du tchat",
	"options.chatPreview.confirm": "Lors de l'envoi",
	"options.chatPreview.live": "Lors de la saisie",
	"options.chatPreview.tooltip.confirm": "Si un serveur utilise les aperçus du tchat : Un aperçu du tchat n'est généré que lors de la tentative d'envoi d'un message qui n'a pas d'aperçu ou qui est en attente d'un aperçu.\nL'envoi du message nécessite une confirmation.",
	"options.chatPreview.tooltip.live": "Si un serveur utilise les aperçus du tchat : Toutes les modifications appliquées à vos messages du tchat par un serveur seront envoyées de manière dynamique pour être prévisualisées au fur et à mesure de la saisie du message de chat.",
	"options.chatPreview.tooltip.off": "Toute modification appliquée à vos messages du tchat par un serveur ne seront pas prévisualisés et sera considérée comme non sécurisée.",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Perroquet qui imite le Piglin",
	...
	"title.multiplayer.disabled.banned.permanent": "Votre compte est définitivement suspendu de jouer en ligne",
